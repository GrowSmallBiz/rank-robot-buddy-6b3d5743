...
export const routes: RouteRecord[] = [
  {
    ...
    children: [
      ...
      { path: "google-ads-for-local-businesses", lazy: lazy(() => import("./pages/services/GoogleAds")) },
      { path: "google-local-services-ads-management", lazy: lazy(() => import("./pages/services/LSA")) },
      { path: "facebook-ads-management-services", lazy: lazy(() => import("./pages/services/FacebookAds")) },
