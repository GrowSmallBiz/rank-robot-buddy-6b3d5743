...
export const routes: RouteRecord[] = [
  {
    ...
    children: [
      ...
      { path: "industries/digital-marketing-for-realtors", lazy: lazy(() => import("./pages/industries/Realtors")) },
      { path: "industries/digital-marketing-for-photographers", lazy: lazy(() => import("./pages/industries/Photographers")) },
      { path: "industries/digital-marketing-for-home-service-contractors", lazy: lazy(() => import("./pages/industries/HomeServices")) },
