...
export const routes: RouteRecord[] = [
  {
    ...
    children: [
      ...
      { path: "services/local-seo-services", lazy: lazy(() => import("./pages/services/ManagedAISEO")) },
      { path: "services/local-seo-services/aeo", lazy: lazy(() => import("./pages/services/AEO")) },
      { path: "services/local-seo-services/geo", lazy: lazy(() => import("./pages/services/GEO")) },
      { path: "services/local-seo-services/local-seo", lazy: lazy(() => import("./pages/services/LocalSEO")) },
      { path: "services/local-seo-services/authority-building", lazy: lazy(() => import("./pages/services/AuthorityBuilding")) },
      { path: "services/local-seo-services/link-building", lazy: lazy(() => import("./pages/services/LinkBuilding")) },
      { path: "services/local-seo-services/technical-seo", lazy: lazy(() => import("./pages/services/TechnicalSEO")) },
      { path: "services/local-seo-services/on-page-seo", lazy: lazy(() => import("./pages/services/OnPageSEO")) },
