/**
 * Related Questions FAQ data for Homepage.
 *
 * Source: Search Atlas OTTO export (V2). Text preserved verbatim.
 * Rendered as a closed-by-default Accordion via
 * <RelatedQuestionsSection> and merged into a single FAQPage
 * JSON-LD via <FaqJsonLd> (visible FAQs + relatedFaqs).
 */
import type { FaqItem } from "@/components/seo/FaqJsonLd";

export const relatedFaqs: FaqItem[] = [
  {
    category: "Google Ads Costs & Pricing Models",
  ...
  {
    category: "Budgeting & Managing Ad Spend",
  ...
  {
    category: "Agency Services, Fees & Value",
  ...
  {
    category: "Hiring & Evaluating a Google Ads Partner",
  ...
  {
    category: "Performance, Metrics & Risks",
