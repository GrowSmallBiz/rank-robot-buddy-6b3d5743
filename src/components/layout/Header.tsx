              ...
              >
                ...
                >
                  ...
                  >
                    ...
                    <Link to="/services/paid-advertising-services/google-ads" className="block px-4 py-2.5 rounded-lg text-sm text-muted-foreground hover:text-foreground hover:bg-secondary transition-colors">
                      Google PPC Ads
                    </Link>
                    <Link to="/services/paid-advertising-services/google-local-services-ads" className="block px-4 py-2.5 rounded-lg text-sm text-muted-foreground hover:text-foreground hover:bg-secondary transition-colors">
                      Google Local Service Ads
                    </Link>
                    <Link to="/services/paid-advertising-services/facebook-ads" className="block px-4 py-2.5 rounded-lg text-sm text-muted-foreground hover:text-foreground hover:bg-secondary transition-colors">
                      Meta & Facebook Ads
                    </Link>
                  </div>
                </div>
              ...
              <div className="pl-4 space-y-2">
                ...
                <div>
                  ...
                  <div className={`overflow-hidden transition-all duration-200 ${mobileAdsSubOpen ? "max-h-96 opacity-100" : "max-h-0 opacity-0"}`}>
                    ...
                    <Link to="/services/paid-advertising-services/google-ads" onClick={() => setIsOpen(false)} className="block py-2 pl-4 text-sm text-muted-foreground hover:text-primary">
                      Google PPC Ads
                    </Link>
                    <Link to="/services/paid-advertising-services/google-local-services-ads" onClick={() => setIsOpen(false)} className="block py-2 pl-4 text-sm text-muted-foreground hover:text-primary">
                      Google Local Service Ads
                    </Link>
                    <Link to="/services/paid-advertising-services/facebook-ads" onClick={() => setIsOpen(false)} className="block py-2 pl-4 text-sm text-muted-foreground hover:text-primary">
                      Meta & Facebook Ads
                    </Link>
                  </div>
                </div>
