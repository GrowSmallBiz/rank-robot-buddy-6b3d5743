            ...
            <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
              <div className="relative flex justify-center">
                <div className="relative w-full max-w-lg">
                  <img src={aiGrowthSystemFunnel} alt="Marketing funnel stages" className="w-full rounded-2xl shadow-2xl shadow-primary/20" />
        ...
        <div className="mb-16 mt-16">
          ...
          <div className="grid lg:grid-cols-2 gap-8 items-center mb-10">
            <div className="relative">
              ...
              <img src={emailSmsWorkflowDiagram} alt="Email and SMS automation workflow diagram" className="relative rounded-2xl border border-border/50 shadow-2xl w-full" />
