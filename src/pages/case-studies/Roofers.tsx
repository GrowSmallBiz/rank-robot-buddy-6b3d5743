...
import { roofingSeoCaseStudyFaqItems } from "@/data/faq/roofing-seo-case-study";
import { createContactCTA } from "@/config/contactCTA";
import heroBg from "@/assets/case-studies-roofers-hero-bg.webp";
...
const Roofers = () => {
  ...
  return (
    <>
      ...
      />
      <FaqJsonLd
        items={roofingSeoCaseStudyFaqItems}
      ...
      <main id="main-content">
        ...
        <FAQSection
          ...
          faqs={roofingSeoCaseStudyFaqItems}
          disableSchema
