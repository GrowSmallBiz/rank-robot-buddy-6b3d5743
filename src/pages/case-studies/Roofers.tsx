    ...
    <>
      ...
      <main>
        ...
        <FAQSection
          ...
          faqs={[
            { question: "Are these results from GrowSmallBiz clients?", answer: "These campaigns were executed in a white-label fulfillment capacity prior to the launch of GrowSmallBiz. They are included here to show the type of Local SEO and PPC performance outcomes that can be achieved through disciplined strategy, execution, and optimization." },
