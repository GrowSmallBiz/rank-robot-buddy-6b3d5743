...
import { relatedFaqs as hvacSeoRelatedFaqs } from "@/data/faq/hvac-seo-case-study-related";
  ...
  return (
    <>
      <Head>
        ...
        <meta name="keywords" content="local SEO, HVAC marketing, plumbing SEO, electrical contractor SEO, digital marketing for contractors, lead generation strategies, case study, GrowSmallBiz" />
      ...
      <main id="main-content">
        ...
        <RelatedQuestionsSection title="Additional FAQs" items={hvacSeoRelatedFaqs} />

        <FaqJsonLd
          items={[...hvacSeoVisibleFaqs, ...hvacSeoRelatedFaqs]}
