    ...
    <>
      ...
      <main>
        ...
        <FAQSection
          ...
          faqs={[
            { question: "Are these results from GrowSmallBiz clients?", answer: "These campaigns were executed in a white-label fulfillment capacity prior to the launch of GrowSmallBiz. They are included to show the types of outcomes and execution quality behind the strategies we now bring to local service businesses." },
