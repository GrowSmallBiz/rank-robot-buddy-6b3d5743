...
import { relatedFaqs as hvacAdsRelatedFaqs } from "@/data/faq/hvac-google-ads-case-study-related";
  ...
  return (
    <>
      ...
      <main id="main-content">
        ...
        <RelatedQuestionsSection title="Additional FAQs" items={hvacAdsRelatedFaqs} />

        <FaqJsonLd
          items={[...hvacAdsVisibleFaqs, ...hvacAdsRelatedFaqs]}
