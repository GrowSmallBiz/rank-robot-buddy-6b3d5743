...
const PAGE_DESC =
  "Mother’s Day Appreciation Offer through May 31 for 5 mom-owned local service businesses: complimentary Starter Website ($2,500 value) plus reduced Client Growth System setup.";
...
const MothersDayCohort = () => {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      ...
      {/* STICKY MOBILE CTA */}
      <div className={`md:hidden fixed bottom-0 inset-x-0 z-40 px-3 pt-3 pb-[max(0.75rem,env(safe-area-inset-bottom))] bg-background/95 backdrop-blur border-t border-border transition-opacity duration-200 ${formInView ? "opacity-0 pointer-events-none" : "opacity-100"}`}>
        <a
          href="#apply-form"
