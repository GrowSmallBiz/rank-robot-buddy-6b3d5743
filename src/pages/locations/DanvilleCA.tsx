      ...
      <div className="bg-background">
        <div className="container mx-auto px-4 py-16 max-w-4xl">
          <div className="prose prose-lg prose-invert max-w-none space-y-12">
            ...
            <h2 className="text-3xl font-display font-bold text-foreground mt-16">Why Danville Is a Market Worth Winning</h2>
            ...
            <h2 className="text-3xl font-display font-bold text-foreground mt-16">Why Danville Businesses Need More Than Disconnected Marketing Tactics</h2>
            ...
            <h2 className="text-3xl font-display font-bold text-foreground mt-16">Digital Marketing Services in Danville, CA for Small Businesses That Want Better Results</h2>

            <p>GrowSmallBiz provides four core Danville marketing services that are designed to work together, not compete with one another. Reputation management also supports that system by strengthening trust and conversion after your business gets found.</p>

            <h3 className="text-2xl font-display font-bold text-foreground mt-12">Website Design For Small Businesses</h3>

            <p>A business website should not just look polished. It should help prospects trust your company, understand what you do, and take the next step without friction. Our <Link to="/services/website-design/" className="text-primary hover:underline">website design for small businesses</Link> is built around credibility, mobile responsiveness, clear calls to action, and lead capture so your website supports growth instead of acting like a static brochure.</p>

            <h3 className="text-2xl font-display font-bold text-foreground mt-12">SEO and Local SEO With Agentic AI Playbooks</h3>

            <p>Our <Link to="/services/seo-agency/" className="text-primary hover:underline">SEO and local SEO services</Link> help Danville businesses improve search visibility where local buyers actually make decisions. That includes local intent searches, service-page visibility, search engine optimization fundamentals, trusted content, technical strength, and the local signals that influence who gets the click or call. Google says its AI search features still rely on the same foundational SEO best practices, and pages must be indexed and eligible for Search to appear as supporting links in AI Overviews or AI Mode.</p>

            <h3 className="text-2xl font-display font-bold text-foreground mt-12">Paid Ads With Google PPC, Google LSA, and Meta Ads</h3>

            <p>Our <Link to="/services/paid-advertising/" className="text-primary hover:underline">paid ads management</Link> uses Google PPC, Google Local Services Ads, and Meta Ads to support faster visibility and more controlled lead generation. Paid campaigns are most effective when they are connected to the right landing pages, tracking, follow-up, and offer structure. That is how businesses improve lead quality instead of just buying traffic.</p>

            <h3 className="text-2xl font-display font-bold text-foreground mt-12">Marketing Automation for Speed to Lead and Better Conversion</h3>

            <p><Link to="/services/marketing-automation-for-small-business/" className="text-primary hover:underline">Marketing automation</Link> helps Danville businesses respond faster and convert more of the demand they already create. That includes AI Receptionist support, Conversational AI, CRM workflows, email and SMS follow-up, and capture-to-nurture systems that keep leads moving. When response time improves and follow-up becomes consistent, more opportunities turn into revenue.</p>
            ...
            <h2 className="text-3xl font-display font-bold text-foreground mt-16">AI Search Visibility for Local Service Businesses Now Matters</h2>
            ...
            <h3 className="text-2xl font-display font-bold text-foreground mt-12">Restaurants</h3>

            <p>Restaurants need more than awareness. They need a reliable system for bringing guests back.</p>

            <h4 className="text-xl font-display font-bold text-foreground mt-8">Repeat Visits, Promotions, and VIP Club Membership Marketing</h4>

            <p>Restaurant marketing works differently from many service categories because repeat visits matter so much. A restaurant can benefit from local visibility and promotions, but long-term growth often comes from retention. Email offers, SMS promotions, special event reminders, seasonal campaigns, and reactivation messages can help increase repeat traffic from customers who already know the brand.</p>

            <p>VIP club membership marketing can make this even more effective. When restaurants create a simple system for collecting contact information and staying in touch, they gain a direct channel for promotions and loyalty-based outreach. That gives them a stronger way to drive repeat visits without depending entirely on third-party platforms or one-time foot traffic.</p>

            <h2 className="text-3xl font-display font-bold text-foreground mt-16">What Makes GrowSmallBiz Different From a Typical Marketing Agency in Danville, CA</h2>
            ...
            <h2 className="text-3xl font-display font-bold text-foreground mt-16">Trusted by Local Service Businesses Across Danville and the Tri-Valley</h2>

            <p className="text-muted-foreground">Not every client wants to be publicly named on a marketing page. These quotes are written as safe placeholder copy in the same style as the visual proof cards, and can later be replaced with actual client testimonials inside your CMS.</p>
            ...
            <h2 className="text-3xl font-display font-bold text-foreground mt-16">Why Local Visibility Still Matters for Danville, CA Businesses</h2>
            ...
            <h2 className="text-3xl font-display font-bold text-foreground mt-16">Danville Business Resources</h2>
