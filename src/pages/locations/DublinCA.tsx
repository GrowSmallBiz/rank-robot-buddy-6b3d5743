...
const DublinCA = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <FAQSection
        title={<>Frequently Asked Questions About <span className="text-transparent bg-clip-text bg-gradient-primary italic">Marketing in Dublin, CA</span></>}
        faqs={[
          { question: "What types of businesses does GrowSmallBiz work with in Dublin, CA?", answer: "GrowSmallBiz primarily works with local service businesses and repeat-visit local businesses, including home services, dentists, med spas, chiropractors, real estate professionals, restaurants, and other businesses that rely on local visibility, qualified inquiries, and consistent follow-up." },
          ...
          { question: "Do you offer Google Ads and Local Services Ads for Dublin businesses?", answer: "Yes. GrowSmallBiz can support paid lead generation through Google Ads and Local Services Ads as part of a broader system that also includes landing pages, tracking, and lead follow-up." },
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center animate-fade-up">
            ...
            <h2 className="section-title">
              ...
              <span className="text-transparent bg-clip-text bg-gradient-primary italic">Dublin Business</span>?
            </h2>
            <p className="section-description mt-4 mb-8">
              GrowSmallBiz helps Dublin businesses connect website performance, search visibility, paid ads, follow-up, conversion, and retention into one practical system. That is the difference between paying for marketing activity and building a structure that supports real business growth.
            </p>
          </div>
          <CardCTA
