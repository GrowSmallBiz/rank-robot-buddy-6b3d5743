...
import dublinHero from "@/assets/dublin-hero.webp";

import { Head } from "vite-react-ssg";
import { Link } from "react-router-dom";
import { MapPin, TrendingUp, Briefcase, Globe, Search, Target, Zap, Home, Heart, Building2, UtensilsCrossed, Brain, Eye, BarChart3, Users, Star, ArrowRight, Phone, Shield, MessageSquare, Award, CheckCircle } from "lucide-react";
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section className="hero-section">
        <img src={dublinHero} alt="Aerial view of Dublin, California, showcasing modern commercial buildings, residential neighborhoods, and rolling hills with Mount Diablo in the background, highlighting the local landscape and community." width={1920} height={768} className="absolute inset-0 w-full h-full object-cover" />
        ...
        <div className="container mx-auto px-4 max-w-5xl">
          <div className="text-center mb-12 animate-fade-up">
            ...
            <h2 className="text-3xl md:text-4xl font-display font-bold text-foreground bg-gradient-heading bg-clip-text text-transparent">
              How GrowSmallBiz's Dublin-Based Expertise Boosts Your Bottom Line
            </h2>
          </div>
          <p className="text-lg text-muted-foreground mb-8 max-w-4xl mx-auto animate-fade-up">
            Dublin's SERP landscape is dominated by national and out-of-area agencies — companies operating from out of state, from across the Bay, and from neighboring cities running generic Tri-Valley pages. GrowSmallBiz is different in ways that matter for local service businesses competing in Alameda County.
          </p>
