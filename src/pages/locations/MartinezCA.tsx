...
const MartinezCA = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      <Head>
        <title>Digital Marketing Agency in Martinez, CA | GrowSmallBiz</title>
      ...
      <section className="py-4" style={{ backgroundColor: 'hsl(var(--accent))' }}>
        <div className="container mx-auto px-4">
          <div className="flex flex-wrap justify-center gap-4 md:gap-8 text-sm font-medium text-accent-foreground">
            <a href="https://members.walnut-creek.com/list/Details/growsmallbiz-digital-marketing-4248068" target="_blank" rel="noopener noreferrer" className="hover:underline flex items-center gap-1.5"><CheckCircle className="w-3.5 h-3.5" /> Walnut Creek Chamber of Commerce</a>
        ...
        <div className="container mx-auto px-4 max-w-5xl">
          ...
          <div className="grid md:grid-cols-2 gap-4">
            {[
              ...
              { label: "Integrated system:", body: "One system, one strategy, one team accountable for your results. Streamline Results runs SEO. 360 Nerds runs ads. No one owns the full picture. Every channel GrowSmallBiz manages feeds a single coordinated goal." },
        ...
        <div className="container mx-auto px-4 max-w-5xl">
          ...
          <div className="hidden md:block overflow-x-auto mb-16">
            <table className="w-full text-sm border-collapse">
              ...
              <tbody>
                {[
                  { service: "Local SEO & Google Business Profile", whatWeDo: "GBP optimization, NAP citation building, Contra Costa County directory citations, review management, local link building", impact: "Rank in Google Maps 3-pack for Martinez; capture searches from Alhambra Avenue corridor, Waterfront, Vine Hill, Alhambra Valley — outperform Streamline Results' generic national pages" },
                  ...
                  { service: "Google Local Service Ads (LSA)", whatWeDo: "Background check coordination, license verification, budget management, Google Guaranteed badge setup", impact: "Appear above Streamline Results and 360 Nerds with a Google-verified trust badge — critical for home service contractors serving Martinez's suburban residential corridors" },
          ...
          <div className="md:hidden space-y-3 mb-16">
            {[
              { service: "Local SEO & Google Business Profile", whatWeDo: "GBP optimization, NAP citation building, Contra Costa County directory citations, review management, local link building", impact: "Rank in Google Maps 3-pack for Martinez; outperform Streamline Results' generic national pages" },
              ...
              { service: "Google Local Service Ads (LSA)", whatWeDo: "Background check coordination, license verification, Google Guaranteed badge setup", impact: "Appear above Streamline Results and 360 Nerds with a Google-verified trust badge" },
          ...
          <div className="mt-16 pt-10 border-t border-border/30">
            ...
            <ul className="space-y-3 mb-6">
              {[
                ...
                "Neighborhood-level keyword targeting: 'HVAC repair Vine Hill,' 'dentist Martinez CA,' 'plumber Alhambra Valley,' 'restaurant Waterfront Park Martinez' — hyper-local terms that Streamline Results' national template never builds",
      ...
      <FAQSection
        ...
        faqs={[
          ...
          { question: "How long does SEO take in Martinez?", answer: "Google Business Profile optimizations show measurable movement — increased views, calls, and direction requests — within 30 to 60 days. Organic rankings shift within 60 to 90 days for less competitive terms and 3 to 6 months for primary category keywords. Martinez is competitive but not saturated: the primary SERP leader (Streamline Results) is a national template agency that can be outperformed with a well-executed local strategy within 6 to 12 months." },
          { question: "How is GrowSmallBiz different from national agencies like Streamline Results that rank in Martinez searches?", answer: "National agencies build templated location pages from cities where they have no business presence. Streamline Results' Martinez page contains the same structure as their Sacramento, Fresno, and Riverside pages — with no knowledge of Vine Hill's residential character, the Alhambra Avenue dining corridor, the courthouse legal cluster, or the community-oriented buyer behavior that distinguishes Martinez from every other Contra Costa County city. GrowSmallBiz is based in Danville, 20 minutes away." },
