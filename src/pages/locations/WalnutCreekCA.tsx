  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section className="hero-section">
        <img src={walnutCreekHero} alt="Walnut Creek cityscape at sunset featuring modern buildings, tree-lined streets, and surrounding hills, highlighting the local business environment for GrowSmallBiz's digital marketing services." width={1920} height={768} className="absolute inset-0 w-full h-full object-cover" />
