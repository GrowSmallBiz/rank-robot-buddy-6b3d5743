          ...
          <div className="prose prose-lg prose-invert max-w-none space-y-12">
            ...
            <Accordion type="single" collapsible className="w-full">
              <AccordionItem value="q1">
                <AccordionTrigger className="text-left text-foreground font-semibold">What types of businesses does GrowSmallBiz work with in Walnut Creek, CA?</AccordionTrigger>
              ...
              <AccordionItem value="q4">
                <AccordionTrigger className="text-left text-foreground font-semibold">Do you offer Google Ads and Local Services Ads for Walnut Creek businesses?</AccordionTrigger>
            ...
            <h2 className="text-3xl font-display font-bold text-foreground mt-16">Ready to Build a Stronger Growth System for Walnut Creek?</h2>
            <p>GrowSmallBiz helps Walnut Creek businesses connect website performance, search visibility, paid ads, follow-up, conversion, and retention into one practical system. That is the difference between paying for marketing activity and building a structure that supports real business growth.</p>
            <p>If you want a smarter, more connected approach to digital marketing in Walnut Creek, GrowSmallBiz is built for that next step. We can look at where your current system is losing visibility, losing trust, or losing leads — and what a stronger local growth engine could look like.</p>
