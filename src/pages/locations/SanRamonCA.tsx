    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="py-20 bg-background">
        <div className="container mx-auto px-4 max-w-4xl">
          ...
          <div className="space-y-6">
            <div className="bg-card/50 border border-border/60 rounded-xl p-6 md:p-8">
              <p className="text-base md:text-lg text-foreground/90 leading-relaxed mb-4">According to <a href="https://www.brightlocal.com/research/local-consumer-review-survey/" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline">BrightLocal's Local Consumer Review Survey</a>, 81% of consumers use Google to evaluate local businesses and 80% search for local businesses on a weekly basis. Yet BrightLocal research shows that 56% of businesses have not fully optimized their Google Business Profile. In San Ramon's active market, that optimization gap translates directly to missed calls, missed bookings, and missed revenue — month after month.</p>
              <p className="text-base md:text-lg text-foreground/90 leading-relaxed">San Ramon's SERP landscape reinforces this opportunity. The top-ranking competitor for 'digital marketing san ramon ca' — Boomcycle — has a content score of 89 with 1,781 words. Most other visible competitors are thin pages under 1,200 words with minimal local specificity. A properly integrated, content-rich presence built specifically for San Ramon's market beats generic agency pages in both relevance and trust signals.</p>
            </div>
        ...
        <div className="container mx-auto px-4 max-w-4xl">
          ...
          <div className="space-y-6">
            <div className="bg-card/50 border border-border/60 rounded-xl p-6 md:p-8">
              ...
              <p className="text-base md:text-lg text-foreground/90 leading-relaxed mb-3">Our <Link to="/services/local-seo/" className="text-primary hover:underline">local SEO</Link> approach for San Ramon businesses includes:</p>
      ...
      <section className="py-20 bg-background">
        <div className="container mx-auto px-4 max-w-4xl">
          ...
          <div className="space-y-6">
            <div className="bg-card/50 border border-border/60 rounded-xl p-6 md:p-8">
              <p className="text-base md:text-lg text-foreground/90 leading-relaxed mb-4">According to research by MIT and InsideSales.com, leads contacted within 5 minutes are 21 times more likely to convert than those reached after just 30 minutes. In San Ramon's competitive Tri-Valley market, where multiple businesses receive the same emergency HVAC inquiry or dental appointment request simultaneously, the first business to respond wins — consistently. Manual teams cannot achieve five-minute response times around the clock. AI systems can.</p>
      ...
      <section className="py-20" style={{ background: 'linear-gradient(180deg, hsl(210 50% 8%) 0%, hsl(210 45% 14%) 50%, hsl(210 50% 8%) 100%)' }}>
        <div className="container mx-auto px-4 max-w-5xl">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-muted-foreground mt-4 max-w-3xl mx-auto">San Ramon is served by several active digital marketing agencies — including Boomcycle, D-Kode Technology, and others visible in local search results. Here is what makes the system GrowSmallBiz builds consistently outperform the competition in our own backyard:</p>
          </div>
