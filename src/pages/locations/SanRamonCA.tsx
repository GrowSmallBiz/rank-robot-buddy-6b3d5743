          ...
          <div className="prose prose-lg prose-invert max-w-none space-y-12">
            ...
            <Accordion type="single" collapsible className="w-full">
              <AccordionItem value="q1">
                <AccordionTrigger className="text-left text-foreground font-semibold">What types of businesses does GrowSmallBiz work with in San Ramon, CA?</AccordionTrigger>
              ...
              <AccordionItem value="q4">
                <AccordionTrigger className="text-left text-foreground font-semibold">Do you offer Google Ads and Local Services Ads for San Ramon businesses?</AccordionTrigger>
