...
const ConcordCA = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      <Head>
        <title>Digital Marketing Agency in Concord, CA | GrowSmallBiz</title>
      ...
      <section className="py-4" style={{ backgroundColor: 'hsl(var(--accent))' }}>
        <div className="container mx-auto px-4">
          <div className="flex flex-wrap justify-center gap-4 md:gap-8 text-sm font-medium text-accent-foreground">
            ...
            <span className="text-accent-foreground/40">|</span>
            <a href="https://www.concordchamber.com/list/member/growsmallbiz-digital-marketing-12991" target="_blank" rel="noopener noreferrer" className="hover:underline flex items-center gap-1.5">
      ...
      {/* ===== FAQ SECTION ===== */}
      <FAQSection
        title={<>Your Questions Answered — No Jargon, No Sales Pitch, Just Straight Answers About <span className="text-transparent bg-clip-text bg-gradient-primary italic">Digital Marketing in Concord</span></>}
        faqs={[
