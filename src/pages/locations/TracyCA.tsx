...
import { MapPin, ArrowRight, Phone, Shield, Search, Target, Zap, Globe, Star, Users, Home, Heart, Building2, UtensilsCrossed, BarChart3, Brain, TrendingUp, MessageSquare } from "lucide-react";
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section className="hero-section">
        <img src={tracyHero} alt="Aerial view of Tracy, CA, showcasing highway interchange and surrounding residential and commercial areas, highlighting local infrastructure relevant for digital marketing strategies." width={1920} height={768} className="absolute inset-0 w-full h-full object-cover" />
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-display font-bold text-foreground mb-3 animate-fade-up leading-tight bg-gradient-heading bg-clip-text text-transparent">
              Tracy Digital Marketing for Small Service Businesses
            </h1>
