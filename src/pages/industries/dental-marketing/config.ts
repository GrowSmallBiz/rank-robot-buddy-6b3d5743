...
export const dentalConfig: NicheConfig = {
  ...
  marketingCampaigns: [
    {
      genre: "Dental Implants & All-on-4", icon: Stethoscope, color: "from-rose-500 to-pink-500",
      offer: {
    ...
    {
      genre: "Smile Makeover & Veneers", icon: Sparkles, color: "from-violet-500 to-purple-500",
      offer: {
    ...
    {
      genre: "Invisalign & Clear Aligners", icon: Smile, color: "from-emerald-500 to-teal-500",
      offer: {
