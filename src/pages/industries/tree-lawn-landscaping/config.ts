...
export const treeLawnLandscapingConfig: NicheConfig = {
 ...
 description: "Spring fills up fast. Storm season creates emergency demand overnight. Most tree service and landscape remodeling companies start marketing reactively – when the phone goes quiet – and spend the peak season scrambling. A proactive seasonal calendar changes that.",
 hasImage: false,
 showAILogos: false,
 },
 {
 ...
 description: "Most tree service and landscape remodeling websites look outdated and load slowly on mobile. A homeowner who finds your site has five seconds to decide whether to call you or go back to Google. A conversion-focused website is your best salesperson.",
 hasImage: false,
 showAILogos: false,
 },
 {
 ...
 description: "Homeowners planning a landscape remodeling project research over weeks and compare three or four companies before calling anyone. If your portfolio is not visible on Google, your website does not load fast on mobile, and you have fewer reviews than a nearby competitor — you lose the job before the first phone call.",
 hasImage: false,
 showAILogos: false,
 },
 ],
 ...
 subheadline: "Verified industry data — the scale of the market your tree service and landscape remodeling business operates in and why local visibility determines who wins.",
 items: [
 {
 value: "$188.8B",
 ...
 whatWeDo: "Rank in the Map Pack for tree service near me and landscape remodeling near me searches – the queries that convert directly to booked jobs.",
 ...
 whatWeDo: "Google Local Services Ads for emergency tree service and landscape remodeling searches; Google Ads for seasonal campaigns ramped 4 to 6 weeks before peak demand.",
 ...
 stagedApproachSubheadline: "Most tree service and landscape remodeling companies try to launch SEO, Google Ads, a new website, and automation all at the same time — then wonder why nothing gets traction. GrowSmallBiz uses a staged approach that builds each layer on a solid foundation, so every dollar you invest compounds on the one before it.",
 ...
 // 4.7 WEBSITE DESIGN
 // ══════════════════════════════════════════════════════════════════════
 websiteDesignBadge: "Tree Service & Landscape Remodeling Website Design",
 ...
 "Service-specific pages for tree removal, stump grinding, emergency removal, and landscape remodeling",
 ...
 // 4.8 SEO SECTION
 // ══════════════════════════════════════════════════════════════════════
 seoBadge: "AI-Powered SEO for Tree Service & Landscape Remodeling",
 seoHeadline: "Local SEO That Puts Your Tree Service & Removal and Landscape Remodeling Company",
 ...
 "landscape remodeling company near me",
 ],
 competitors: "Local landscape remodeling firms, hardscape specialists, Houzz and Yelp listings",
 },
  landscaping: {
 ...
 fourLaneSubheadline: "When a homeowner needs a tree removed, their landscape maintained, or a landscape remodeling project designed, they search in four completely different ways — and each one requires a different strategy. GrowSmallBiz builds your presence across all four simultaneously so you own your market regardless of how your next customer searches.",
 fourLaneLanes: [
 {
 lane: "Map Pack",
 icon: MapPin,
 ...
 description: "Homeowners researching tree service costs, landscape remodeling options, or landscape remodeling project ideas find you through organic rankings. These buyers convert over days or weeks and represent the largest search volume and lowest long-term cost per acquisition.",
 howWeDoIt: [
 "Service pages optimized for tree service and landscape remodeling keywords",
 ...
 {
 genre: "Landscape Remodeling Companies",
 icon: Leaf,
 color: "from-green-500/20 to-green-600/10",
 primary: [
 { name: "Google Ads (Search)", reason: "Seasonal keyword campaigns ramped before spring and fall. Landscape remodeling near me and landscape remodeling company targeting." },
 ...
 secondary: [
 { name: "Facebook Ads", reason: "Spring landscape remodeling and seasonal refresh campaigns. Homeowner demographic targeting." },
 { name: "Nextdoor Ads", reason: "Neighborhood-level reach. Homeowner recommendations travel through neighbor networks." },
 ],
 },
 {
 genre: "Commercial & HOA Landscape Remodeling",
 icon: Building2,
 color: "from-blue-500/20 to-blue-600/10",
 primary: [
 { name: "Google Ads (Search)", reason: "Commercial landscape remodeling and HOA maintenance contract targeting. Higher CPC but highest lifetime value." },
 ...
 retargetingSubheadline: "A homeowner researching tree removal or spring landscape remodeling visits your site and leaves without calling. Retargeting brings them back when they're ready to make a decision.",
 retargetingBody: [
 "Tree removal and landscape remodeling decisions are rarely made on the first website visit. According to BrightLocal's 2026 research, the average consumer uses six different platforms when evaluating a local business before hiring. A homeowner getting estimates for tree removal or landscape remodeling will visit multiple websites, check reviews across platforms, and compare contractors over days before calling anyone. Retargeting ensures your company is visible throughout that entire decision window — not just during the first search.",
 "GrowSmallBiz sets up Google Display retargeting and Meta retargeting for every paid media client. Visitors who viewed your tree removal or landscape remodeling service pages see your ads across the web and social platforms for up to 30 days after their visit – keeping your brand in front of them until they are ready to book.",
 ],
 ...
 socialMediaSubheadline: "Platform-specific social media strategies for tree service and landscape remodeling companies – built around what actually drives homeowner trust and commercial inquiries in the home service industry.",
 socialMediaByGenre: [
 {
 genre: "Tree Service Companies",
 color: "from-emerald-500/20 to-emerald-600/10",
 ...
 color: "from-green-500/20 to-green-600/10",
 primary: [
 { name: "Facebook", icon: Facebook, strategy: "Before-and-after landscape remodeling photos, seasonal tips, spring prep announcements. Homeowner community engagement." },
 { name: "Instagram", icon: Instagram, strategy: "Before-and-after landscape remodeling photos, hardscape project showcases, seasonal transformation content. Visual brand building." },
 ],
 secondary: [
 ...
 color: "from-blue-500/20 to-blue-600/10",
 primary: [
 { name: "LinkedIn", icon: Linkedin, strategy: "Property manager and HOA board outreach. Commercial portfolio showcase. B2B landscape remodeling contract acquisition." },
 ...
 { stage: "Research", icon: Search, color: "from-purple-500 to-purple-600", description: "They search Google or ask an AI assistant for tree service or landscape remodeling companies near them.", goal: "Appear first in Map Pack, Google Ads, and AI search results" },
 ...
 { stage: "Retention", icon: RefreshCw, color: "from-amber-500 to-amber-600", description: "They become a repeat landscape remodeling client or refer friends after a positive tree removal experience.", goal: "Automate review requests, seasonal reminders, and referral follow-up" },
 ],
 emailNurturePoints: [
 { title: "Stay Top-of-Mind Through the Full Season", icon: Eye, description: "Most tree service and landscape remodeling decisions take days or weeks. Automated email and SMS sequences keep your company visible from first inquiry to booked job." },
 ...
 { title: "Turn Happy Clients Into Your Best Lead Source", icon: Gift, description: "An automated referral system reaches satisfied tree service and landscape remodeling clients with a referral offer — a discount on their next service for every new customer they send your way. Most clients refer one to three people when asked at the right moment with the right incentive. Zero ad spend required." },
 ],
 ...
 description: "Arrival window confirmation sequence for tree service and landscape remodeling estimate visits",
 ...
 noShowImpact: "Most tree service and landscape remodeling quotes are lost to silence — no follow-up, no closed job.",
 reminders: [
 ...
 reminders: [
 { timing: "6 weeks before spring", channels: ["email"], content: "Spring tree and landscape remodeling offer — book early, schedule filling fast" },
 ...
 {
 genre: "Landscape Remodeling", icon: Leaf, color: "from-green-500 to-green-600",
 offer: {
 headline: "Spring Landscape Refresh Package",
 tagline: "[Season Launch] — Get your outdoor space ready for the season",
 price: "$299", originalPrice: "$499", savings: "Save $200",
 includes: ["Seasonal bed cleanup and edging", "Mulch refresh and seasonal color", "Hardscape inspection and touch-up", "Outdoor living health assessment"],
 ...
 {
 genre: "Commercial Landscape Remodeling", icon: Building2, color: "from-blue-500 to-blue-600",
 offer: {
 headline: "Commercial Property Landscape Audit",
 tagline: "[Ongoing] — Annual maintenance and capital improvement review for HOAs and property managers",
 price: "Custom Quote", originalPrice: "", savings: "",
 includes: ["Full property walk-through", "12-month maintenance and renovation proposal", "Seasonal calendar", "HOA compliance assessment"],
 ...
 {
 genre: "Landscape Remodeling Design-Build",
 icon: Sprout,
 color: "from-teal-500 to-teal-600",
 offer: {
 headline: "Spring Landscape Design-Build Consultation",
 tagline: "[Season Launch] — Book your landscape remodeling project before the season fills up",
 price: "Free Consultation",
 originalPrice: "",
 savings: "",
 includes: [
 "Full property landscape assessment",
 ...
 seasonalCampaigns: [
 { campaign: "Spring Tree & Landscape Prep", timing: "Launch 4-6 weeks before March", offer: "Early-bird spring packages + tree health + landscape refresh", channels: ["Google Ads", "Facebook", "Email"] },
 ...
 { campaign: "Fall Cleanup Season", timing: "Launch in August for October peak", offer: "Leaf removal + tree pruning + seasonal cleanup packages", channels: ["Google Ads", "Facebook", "Email"] },
 ...
 { campaign: "Summer Maintenance", timing: "Active May-August", offer: "Seasonal landscape maintenance + irrigation tuning + weed control", channels: ["Google Ads", "Nextdoor", "Email"] },
 ],
 pastClientWorkflows: [
 ...
 { title: "Referral Incentive Automation", icon: Gift, description: "Automated referral offer sent to satisfied clients 2 weeks after job completion — a discount on their next tree service or landscape remodeling job for every new customer they refer. Tracked automatically, reward delivered via SMS. No manual follow-up required from your team." },
 ],
 ...
 reputationSubheadline: "According to BrightLocal's 2026 Local Consumer Review Survey, 97% of consumers read reviews before making a hiring decision, 31% ignore any business with a rating below 4.5 stars, and 74% only trust reviews from the last 90 days. For tree service and landscape remodeling companies, reviews determine whether a homeowner calls you or a competitor — before you've ever spoken.",
 reputationBullets: [
 ...
 reviewFlowSteps: [
 { step: "1", title: "Job Complete", description: "Crew completes tree removal or landscape remodeling project" },
 ...
 description: "Automated referral program that rewards existing clients for sending new tree service or landscape remodeling customers your way.",
 ...
 description: "Sell tree service and landscape remodeling gift cards year-round for neighbor gifts, holiday presents, and HOA move-in welcome packages.",
 ...
 aiReceptionistImageAlt: "AI-driven multi-call interface for tree service and landscape remodeling businesses, featuring emergency tree removal, landscape remodeling estimates, property management, and design-build consultations.",
 ...
 "Qualifies the lead by service type (tree removal, landscape remodeling, commercial) and urgency level",
 ...
 aiChatImageAlt: "Tree service website showcasing before-and-after images of tree removal, with a live chat feature on a smartphone for customer inquiries, emphasizing local landscape remodeling solutions.",
 ...
 whyChooseUsBody: "GrowSmallBiz Digital Marketing, founded by Subrata Guha and headquartered in Danville, CA, specializes in marketing for tree service and landscape remodeling companies across the San Francisco Bay Area and the United States. We bring 30+ years of enterprise marketing and digital transformation experience to the home service industry – combined with the local market knowledge that national agencies cannot replicate.",
 whyChooseUsCards: [
 { icon: TreePine, title: "Tree & Landscape Remodeling Specialists", description: "GrowSmallBiz focuses exclusively on tree service and landscape remodeling companies — not plumbers one week and restaurants the next. Specialization means we understand the emergency nature of storm-damage tree calls, the 300–400% seasonal demand spikes in spring and fall, and the specific Map Pack signals that drive bookings for tree service near me and landscape remodeling near me searches." },
 ...
 headline: "Chicagoland Tree Service & Landscape Remodeling Company",
 ...
 headline: "Tree Service & Landscape Remodeling Company",
 ...
 caseStudyLinks: [
 {
 title: "Marketing Case Study: Tree Service & Landscape Remodeling",
 description: "How a Chicagoland tree service and landscape remodeling company achieved a 1.1 average Map Pack rank, +138.54% impressions, and +770% phone clicks with AI SEO.",
 url: "/home-service-contractors/tree-lawn-landscaping-marketing/landscaping-marketing-case-study/",
 icon: Search,
 },
 {
 title: "Google Ads Case Study: Tree Service & Landscape Remodeling",
 description: "How GrowSmallBiz generated 553 conversions at $53.70 CPA for a tree service and landscape remodeling company — with a 211.5% lift in 90-day conversions after campaign scaling.",
 url: "/home-service-contractors/tree-lawn-landscaping-marketing/landscaping-marketing-case-study/",
 icon: Target,
 },
 ],
 ...
 faqs: [
 {
 question: "How long does it take to see results from SEO for a tree service or landscape remodeling company?",
 answer: "Most tree service and landscape remodeling companies see measurable movement in Google Map Pack rankings within 60 to 90 days of starting a managed SEO program. Top 3 Map Pack positions in competitive Bay Area markets typically take 4 to 6 months of consistent optimization. Emergency and near me keywords tend to rank faster than broad service terms because intent is immediate and Google weights proximity heavily. In a Chicagoland tree service and landscape remodeling campaign managed by GrowSmallBiz, the client reached a 1.1 average Map Pack rank across 123 grid points within six months.",
 },
 {
 question: "Is local SEO worth it for a small landscape remodeling or design-build business?",
 answer: "Yes — local SEO is the highest-ROI long-term marketing investment for a small landscape remodeling or design-build business because it builds organic visibility that compounds over time without a per-click cost. A well-optimized Google Business Profile with strong review velocity consistently generates inbound calls without ongoing ad spend. The tradeoff is time: local SEO takes 60 to 90 days to show measurable movement. For faster results in the first 90 days, run local SEO in parallel with Google Local Services Ads.",
 },
 ],
 },
 {
 ...
 faqs: [
 {
 question: "What is the difference between Google Local Services Ads and Google Ads for tree service and landscape remodeling companies?",
 answer: "Google Local Services Ads appear above all other results, carry the Google Guarantee badge, and charge per verified lead rather than per click — making them the best option for emergency tree service and landscape remodeling searches. Standard Google Ads charge per click and give more control over keywords, budget, and landing pages — making them better for seasonal campaigns and non-emergency targeting. GrowSmallBiz recommends running both simultaneously: LSA for emergency and high-intent queries, Google Ads for seasonal and service-specific campaigns.",
 },
 {
 question: "What digital marketing works best for tree service and landscape remodeling companies?",
 answer: "The highest-impact marketing channels for tree service and landscape remodeling companies are Google Local Services Ads for emergency removal searches, Local SEO and Google Business Profile optimization for Map Pack visibility, and reputation management to build the review count that drives click-through rates. Tree service and landscape remodeling companies benefit from a combined approach because buyers operate across two intent modes: emergency, which is immediate and Map Pack-driven, and planned, which is research-driven and portfolio and review-dependent. GrowSmallBiz structures campaigns to capture both buyer types simultaneously.",
 },
 ],
 },
 {
 ...
 faqs: [
 {
 question: "How do I stop relying on Angi and Thumbtack for landscape remodeling leads?",
 answer: "The fastest path away from lead aggregators is building Google Business Profile review velocity and activating Google Local Services Ads simultaneously — achievable within the first 8 to 12 weeks. After that, service-area landing pages targeting city-specific keywords provide organic lead flow over months 3 to 6. Most tree service and landscape remodeling contractors who follow this sequence reduce cost-per-lead by 40 to 55 percent within six months. The key difference: you own the channel instead of renting access to shared leads.",
 },
 {
 question: "Does GrowSmallBiz handle seasonal marketing for tree service and landscape remodeling companies?",
 answer: "Yes — GrowSmallBiz builds a 12-month seasonal marketing calendar for every tree service and landscape remodeling client, ramping Google Ads budgets 4 to 6 weeks before each peak season rather than during it. This includes activating seasonal landing pages for spring landscape refresh, fall cleanup, and storm damage removal, launching review push campaigns ahead of demand surges, and monitoring website performance before high-traffic months. Proactive seasonal management consistently outperforms reactive budgeting in the home service industry.",
 },
 {
 question: "Does GrowSmallBiz work with landscape remodeling design-build companies?",
 answer: "Yes — GrowSmallBiz works with landscape remodeling design-build companies whose primary challenge is converting long-cycle project research into booked consultations. The buyer journey for design-build is fundamentally different from emergency tree service: homeowners research over weeks, compare portfolios, and make decisions based on visual credibility, review count, and the quality of your website. Our approach combines portfolio-optimized website design, local SEO targeting design-intent queries like landscape remodeling company near me and landscape remodeling design Danville CA, Google Ads campaigns targeting homeowners actively planning a project, and automated follow-up sequences for consultation requests — because most design-build leads go cold without a consistent follow-up system.",
 },
 ],
 },
 {
 ...
 {
 question: "How long does it take to build a tree service or landscape remodeling website?",
 ...
 faqs: [
 {
 question: "Which social media platforms work best for tree service and landscape remodeling companies?",
 answer: "Facebook and Instagram are the primary platforms for residential tree service and landscape remodeling — before-and-after photos and storm response posts drive the most engagement with homeowners aged 35–65. LinkedIn is the right platform for commercial landscape remodeling and HOA contract acquisition. We allocate 80% of your social effort to your two highest-ROI platforms before expanding.",
 },
 {
 question: "How often should a tree service or landscape remodeling company post on social media?",
 ...
 faqs: [
 {
 question: "How many Google reviews does a tree service or landscape remodeling company need to rank in the Map Pack?",
 ...
 {
 question: "Can the AI Receptionist handle commercial landscape remodeling inquiries differently from residential calls?",
 answer: "Yes. The AI Receptionist is configured to route and qualify leads by service type — residential tree removal, landscape remodeling inquiries, commercial property inquiries, and HOA requests are each handled with the appropriate qualification questions and escalation paths.",
 },
 ],
 },
 {
 ...
 {
 question: "How quickly can the AI Growth System be set up for a tree service or landscape remodeling company?",
 ...
 // ══════════════════════════════════════════════════════════════════════
 stickyCtaConfig: {
 title: "Ready for a Tree Service & Landscape Remodeling Marketing System That Fills Your Schedule Year-Round?",
 ...
 // CONTACT SECTION
 // ══════════════════════════════════════════════════════════════════════
 contactSectionHeadline: "Ready to Grow Your Tree Service or Landscape Remodeling Business?",
 ...
 description: "Local SEO for tree service and landscape remodeling begins with your Google Business Profile — optimized from category selection to service areas, weekly posts, and photo cadence. Citation building and on-site location signals follow. This is the foundation every other channel builds on.",
 ...
 // WHO THIS IS FOR
 // ══════════════════════════════════════════════════════════════════════
 whoThisIsForHeadline: "Is GrowSmallBiz Right for Your Tree Service & Removal and Landscape Remodeling Company?",
 ...
 strongFitItems: [
 "Established tree service or landscape remodeling company with at least one full crew and consistent job volume",
 ...
 subtext: "Let's talk about what owning your local tree service and landscape remodeling market actually looks like. Free 30-minute strategy session, no commitment.",
