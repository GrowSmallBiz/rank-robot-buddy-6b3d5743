...
export const treeLawnLandscapingConfig: NicheConfig = {
 ...
 expectedReduction: "30–45% past client retention improvement",
  ...
  marketingCampaigns: [
    ...
    {
      genre: "Recurring Landscape Maintenance", icon: Sprout, color: "from-teal-500 to-teal-600",
      offer: {
        ...
        price: "Free", originalPrice: "$150", savings: "Complimentary",
        ...
        urgency: "Route capacity limited each season", cta: "Get My Maintenance Plan",
      },
