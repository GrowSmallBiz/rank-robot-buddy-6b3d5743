...
import { CardCTA, StickyCardCTA } from "@/components/services";
...
const colorConfig: Record<string, { bg: string; bgLight: string; text: string; border: string; gradient: string; steps: string[] }> = {
  pink: {
    bg: "bg-pink-500",
...
const caseStudies = [
  ...
  },
  {
    ...
    metrics: [
      ...
      { label: "LinkedIn Connections/Week", before: "5", after: "100+", improvement: "+1900%" },
      { label: "Average Session Value", before: "$350", after: "$650", improvement: "+86%" }
    ],
    quote: "LinkedIn outreach changed everything. I'm now the go-to headshot photographer in my market.",
  ...
  return (
    <div className="min-h-screen bg-background">
      <Head>
        ...
        <link rel="canonical" href="https://growsmallbiz.io/professional-services/photographers-marketing/" />
      </Head>
      <ServiceJsonLd
        ...
        breadcrumbs={[
          ...
          { name: "Photography Marketing", url: "/professional-services/photographers-marketing" },
        ]}
      />
      ...
      <section className="py-24 bg-card/50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <span className="inline-block px-4 py-1.5 bg-destructive/10 text-destructive text-sm font-semibold rounded-full mb-4">
              ⚠️ The Reality
            </span>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl mx-auto">
            {realityChallenges.map((challenge, index) => (
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          <div className="mb-16 p-8 md:p-12 bg-gradient-to-br from-primary/20 via-purple-500/10 to-blue-500/10 rounded-3xl border border-primary/30 relative overflow-hidden">
            ...
            <div className="relative z-10 max-w-4xl mx-auto text-center">
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                <Button variant="hero" size="lg" asChild>
                  <a href={freeAuditUrl} className="inline-flex items-center gap-2">
          ...
          <div id="seo-keywords" className="mb-12 scroll-mt-24">
            <h3 className="text-xl font-display font-bold text-foreground mb-6 flex items-center gap-2">
              ...
              We Research Keywords Your Ideal Clients Are Searching
            </h3>
            <div className="grid md:grid-cols-3 gap-6">
              {Object.entries(keywordExamples).map(([key, genre]) => (
                <GlowCard key={key} className="overflow-hidden">
                  <div className="relative h-40 overflow-hidden">
                    <img src={genre.image} alt={genre.label} className="w-full h-full object-cover" />
                    <div className="absolute inset-0 bg-gradient-to-t from-card to-transparent" />
                  ...
                  <div className="p-5">
                    <h5 className="text-xs font-semibold text-muted-foreground uppercase tracking-wider mb-3">Target Keywords</h5>
                    <ul className="space-y-2">
                      {genre.keywords.map((kw, i) => (
                        <li key={i} className="flex items-center gap-2 text-sm">
                          <Search className="w-3 h-3 text-primary shrink-0" />
                          <span className="text-foreground font-mono text-xs">{kw}</span>
                        </li>
                      ))}
                    </ul>
                    <div className="mt-4 pt-3 border-t border-border/50">
                      <p className="text-xs text-muted-foreground">
                        <span className="font-medium text-foreground">Competitors:</span> {genre.competitors}
                      </p>
                    </div>
                  </div>
                </GlowCard>
          ...
          <div id="seo-competitors" className="mb-12 scroll-mt-24">
            <h3 className="text-xl font-display font-bold text-foreground mb-6 flex items-center gap-2">
              ...
              We Analyze Your Competitors & Find Your Edge
            </h3>
            <GlowCard className="p-6">
              <p className="text-muted-foreground mb-4">
                We reverse-engineer what's working for the top-ranking photographers in your market—their keywords, backlinks, content strategy, and review profiles—then build a plan to outrank them.
              </p>
              <div className="grid md:grid-cols-3 gap-4">
                {[
                  { title: "Keyword Gap Analysis", desc: "Find keywords your competitors rank for that you don't" },
                  { title: "Backlink Profile Review", desc: "See where competitors get their authority from" },
                  { title: "Content Strategy Audit", desc: "Identify content gaps you can fill to win rankings" }
                ].map((item, i) => (
          ...
          <div id="seo-technical" className="mb-12 scroll-mt-24">
            <h3 className="text-xl font-display font-bold text-foreground mb-6 flex items-center gap-2">
              ...
              We Fix Your Technical SEO Foundation
            </h3>
              ...
              {technicalSEOSections.map((section, i) => (
                <GlowCard key={i} className="overflow-hidden">
                  ...
                  <div className="p-4">
                    ...
                    {section.note && (
                      <p className="text-xs text-muted-foreground mt-3 border-l-2 border-primary/30 pl-2 italic">{section.note}</p>
                    )}
                  </div>
                </GlowCard>
              ))}
      ...
      <section id="paid-media" className="py-24 bg-background scroll-mt-24">
        <div className="container mx-auto px-4">
          ...
          {/* Platform Recommendations by Genre - Table */}
          <div className="mb-16">
            ...
            <GlowCard className="p-8 bg-gradient-to-br from-blue-950/60 via-slate-900/80 to-blue-950/60 border-blue-500/20">
              ...
              <div className="grid md:grid-cols-2 gap-8">
                <div>
                  ...
                  <ul className="space-y-2">
                    {[
                      "Custom audience creation (engaged couples, new parents, professionals)",
                      "Carousel ads showcasing your best work",
                ...
                <div>
                  ...
                  <ul className="space-y-2">
                    {[
                      ...
                      "Copy Pulled From Existing Site"
                    ].map((item, i) => (
                      <li key={i} className="flex items-start gap-2 text-sm">
      ...
      <section id="client-growth" className="py-24 bg-background scroll-mt-24">
        <div className="container mx-auto px-4">
          <SectionHeader
            ...
            title="We Build Your Complete"
            titleHighlight="Client Growth System"
            description="From first click to lifetime client — every step automated"
          />
          ...
          <div className="mb-16">
            <div className="text-center mb-8">
              ...
              <h3 className="text-2xl md:text-3xl font-display font-bold text-foreground mb-4">
                Your Photography Studio's <span className="text-transparent bg-clip-text bg-gradient-primary italic">Growth Funnel</span>
              </h3>
            </div>
            ...
            <div className="max-w-5xl mx-auto mb-12">
              <img 
                ...
                alt="AI Growth System Funnel for Photography Studios"
            ...
            <div className="grid grid-cols-1 lg:grid-cols-5 gap-4">
              ...
              <div className="relative bg-card border-2 border-blue-500/30 rounded-2xl p-6 hover:border-blue-500/60 transition-all hover:-translate-y-2 group">
                ...
                <h4 className="text-lg font-bold text-foreground mb-2 text-center lg:text-left">Stranger</h4>
                <p className="text-sm text-muted-foreground leading-relaxed">
                  They don't know your studio exists yet. They're searching for <span className="text-blue-400 font-medium">"photographer near me"</span> or asking AI for recommendations.
                </p>
                <div className="mt-3 pt-3 border-t border-border">
                  <p className="text-xs text-blue-400 italic">Goal: Get found on Google + AI search</p>
                </div>
              </div>
              ...
              <div className="relative bg-card border-2 border-purple-500/30 rounded-2xl p-6 hover:border-purple-500/60 transition-all hover:-translate-y-2 group">
                ...
                <h4 className="text-lg font-bold text-foreground mb-2 text-center lg:text-left">Visitor</h4>
                <p className="text-sm text-muted-foreground leading-relaxed">
                  Interested visitors land on your website. They're browsing your <span className="text-purple-400 font-medium">portfolio</span>, checking <span className="text-purple-400 font-medium">pricing</span>, reading <span className="text-purple-400 font-medium">reviews</span>.
                </p>
                <div className="mt-3 pt-3 border-t border-border">
              ...
              <div className="relative bg-card border-2 border-primary/30 rounded-2xl p-6 hover:border-primary/60 transition-all hover:-translate-y-2 group">
                ...
                <p className="text-sm text-muted-foreground leading-relaxed">
                  They've submitted an <span className="text-primary font-medium">inquiry form</span> or <span className="text-primary font-medium">called your studio</span>. <span className="text-primary font-medium">Speed and nurturing</span> determine if they book.
                </p>
                <div className="mt-3 pt-3 border-t border-border">
              ...
              <div className="relative bg-card border-2 border-emerald-500/30 rounded-2xl p-6 hover:border-emerald-500/60 transition-all hover:-translate-y-2 group">
                ...
                <p className="text-sm text-muted-foreground leading-relaxed">
                  They <span className="text-emerald-400 font-medium">booked and paid</span>. Session complete. But most photographers stop here—leaving massive revenue on the table.
                </p>
                <div className="mt-3 pt-3 border-t border-border">
              ...
              <div className="relative bg-card border-2 border-amber-500/30 rounded-2xl p-6 hover:border-amber-500/60 transition-all hover:-translate-y-2 group">
                ...
                <p className="text-sm text-muted-foreground leading-relaxed">
                  The gold mine. <span className="text-amber-400 font-medium">Repeat bookings</span>, <span className="text-amber-400 font-medium">referrals</span>, <span className="text-amber-400 font-medium">upsells</span>. Your past clients are your <span className="text-amber-400 font-medium">lowest-cost, highest-value</span> source.
                </p>
                <div className="mt-3 pt-3 border-t border-border">
          ...
          <div className="mb-20">
            <div className="text-center mb-10">
              ...
              <p className="text-muted-foreground max-w-2xl mx-auto">
                The difference between a struggling photography studio and a thriving one isn't talent—it's systems.
              </p>
            </div>
            ...
            <div className="grid lg:grid-cols-3 gap-8">
              ...
              <GlowCard className="p-8 border-red-500/30 bg-gradient-to-b from-red-500/5 to-transparent">
                ...
                <div className="mb-6">
                  ...
                  <p className="text-sm text-muted-foreground leading-relaxed">
                    You're in a 2-hour family session when an inquiry hits. By the time you check your phone, that bride has already messaged 3 other photographers.
                  </p>
                </div>
                <div className="bg-emerald-500/10 border border-emerald-500/30 rounded-xl p-4">
                  ...
                  <p className="text-sm text-muted-foreground leading-relaxed">
                    <span className="text-emerald-400 font-medium">AI Receptionist</span> auto-responds to every inquiry within seconds—24/7.
                  </p>
                </div>
              </GlowCard>
              ...
              <GlowCard className="p-8 border-purple-500/30 bg-gradient-to-b from-purple-500/5 to-transparent">
                ...
                <div className="mb-6">
                  ...
                  <p className="text-sm text-muted-foreground leading-relaxed">
                    Most photographers send one email with pricing and hope the lead books.
                  </p>
                </div>
                <div className="bg-emerald-500/10 border border-emerald-500/30 rounded-xl p-4">
                  <p className="text-sm font-semibold text-foreground mb-2 flex items-center gap-2">
                  ...
                  <p className="text-sm text-muted-foreground leading-relaxed">
                    <span className="text-emerald-400 font-medium">Automated email sequences</span> that send 5-7 strategic touchpoints over 2-3 weeks.
                  </p>
                </div>
              </GlowCard>
              ...
              <GlowCard className="p-8 border-amber-500/30 bg-gradient-to-b from-amber-500/5 to-transparent">
                ...
                <div className="mb-6">
                  ...
                  <p className="text-sm text-muted-foreground leading-relaxed">
                    Photographers spend thousands on ads while ignoring past happy clients.
                  </p>
                </div>
                <div className="bg-emerald-500/10 border border-emerald-500/30 rounded-xl p-4">
                  <p className="text-sm font-semibold text-foreground mb-2 flex items-center gap-2">
                  ...
                  <p className="text-sm text-muted-foreground leading-relaxed">
                    <span className="text-emerald-400 font-medium">Automated re-engagement campaigns</span>—session anniversary reminders, milestone triggers, and referral incentives.
                  </p>
                </div>
              </GlowCard>
            </div>
              ...
              <GlowCard className="p-6 border-purple-500/30 bg-gradient-to-b from-purple-500/5 to-transparent">
                ...
                <div className="space-y-4">
                  {[
                    ...
                    { day: "1", label: "Day 1", channels: "Email", title: "Portfolio Showcase", desc: "Send curated gallery of your best work matching their event type" },
                    { day: "2", label: "Day 2", channels: "SMS", title: "Quick Check-In", desc: "Friendly text: 'Any questions about the info I sent? Happy to chat!'" },
                    { day: "3", label: "Day 3", channels: "Email", title: "Social Proof", desc: "Client testimonial + recent 5-star reviews highlighting experience" },
                    { day: "5", label: "Day 5", channels: "Email + SMS", title: "Urgency Close", desc: "Limited dates available + special offer for booking this week" }
                  ].map((step, i) => (
                    <div key={i} className="flex items-start gap-4">
                      <div className="flex flex-col items-center">
                        <div className={`w-10 h-10 rounded-full ${i === 0 ? 'bg-emerald-500' : 'bg-purple-500'} flex items-center justify-center text-white font-bold text-sm`}>
                          {step.day}
                        </div>
          ...
          <div className="mb-16">
            <div className="text-center mb-10">
              ...
              <h3 className="text-2xl md:text-3xl font-display font-bold text-foreground mb-4">
                We Set Up <span className="text-primary">Session Reminder Workflows</span>
              </h3>
              <p className="text-muted-foreground max-w-2xl mx-auto">
                Automated reminders that reduce no-shows and keep clients prepared
              </p>
            </div>

            <div className="grid md:grid-cols-3 gap-6 mb-10">
              {sessionReminderWorkflows.map((workflow, i) => {
                const colors = colorConfig[workflow.color];
                return (
                  <GlowCard key={i} className={`p-6 ${colors.border}`}>
                    ...
                    <div className={`p-3 ${colors.bgLight} rounded-lg border ${colors.border} text-center`}>
                      <p className={`text-sm font-semibold ${colors.text}`}>No-show reduction: {workflow.expectedReduction}</p>
                    </div>
                  </GlowCard>
                );
              })}
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              {noShowResearchCitations.map((citation, i) => (
                <div key={i} className="p-4 bg-card border border-border rounded-xl text-center">
                  <span className="text-xs text-primary font-medium">{citation.label}</span>
                  <p className="text-sm font-bold text-foreground mt-2">{citation.stat}</p>
                  <p className="text-[10px] text-muted-foreground mt-1">{citation.source}, {citation.year}</p>
                </div>
              ))}
            </div>
          </div>
                      ...
                      <div className="space-y-2">
                        {campaign.funnel.map((step, stepIndex) => (
                          <div key={stepIndex} className="flex flex-col items-center">
                            <div className={`${widthClasses[stepIndex]} ${colors.steps[stepIndex]} py-2.5 px-4 rounded-lg text-center text-sm font-medium text-white transition-all duration-300 hover:scale-[1.02]`}>
