  ...
  return (
    <div className="min-h-screen bg-background">
      <Head>
        ...
        <link rel="canonical" href="https://growsmallbiz.io/services/local-seo-services/local-seo/" />
      </Head>
      ...
      <ServiceJsonLd
        ...
        url="/services/local-seo-services/local-seo"
        breadcrumbs={[
          { name: "Services", url: "/services" },
          { name: "Managed AI SEO", url: "/services/local-seo-services" },
          { name: "Local SEO", url: "/services/local-seo-services/local-seo" },
        ]}
      />
