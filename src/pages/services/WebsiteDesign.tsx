  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <ServiceHero
        ...
        title={<>Websites Built to Turn Visitors Into <span className="text-transparent bg-clip-text bg-gradient-primary">Calls, Bookings,</span> and <span className="text-transparent bg-clip-text bg-gradient-primary italic">Leads.</span></>}
