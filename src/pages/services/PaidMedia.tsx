  ...
  return (
    <div className="min-h-screen bg-background">
      <Head>
        ...
        <link rel="canonical" href="https://growsmallbiz.io/paid-advertising-services/" />
      </Head>
      <ServiceJsonLd
        ...
        url="/paid-advertising-services"
        breadcrumbs={[
          { name: "Services", url: "/services" },
          { name: "Paid Advertising", url: "/paid-advertising-services" },
        ]}
      />
      <Header />
