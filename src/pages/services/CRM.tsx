  ...
  const pricingPlans = [
    {
      ...
      period: "/month",
      annualSave: "Save $194",
      annualPrice: "$970/year",
      popular: false,
      description: "Perfect for getting started with reputation and communication",
      features: [
        "1 Team Member",
        "Email Support within 24 hrs",
        "Account Setup & Training Call",
        "Review Request Automation",
        "Review Sharing On Social Sites",
        "Website Testimonials Widget",
        "QR Codes for Easy Scan",
        "Automated Review Response",
        "Google Review Website Widget",
        "Speed 2 Lead - Multi Channel Messaging",
    ...
    },
    {
      ...
      popular: true,
      description: "Everything you need to grow and automate your business",
      features: [
        "Everything in Starter +",
        "3 Team Members",
        "24x7 Live Chat Support",
        "Pre-scheduled Support Call via Zoom",
        "Multiple Calendars & Round Robin",
        "Automatic Booking Reminders",
        "Google Calendar Sync",
        "Email & SMS Marketing",
        "Social Post Planner",
        "Landing Pages That Convert",
        "Smart CRM with Unlimited Contacts",
    ...
    },
    {
      ...
      popular: false,
      description: "Full AI automation with unlimited team members",
      features: [
        "Everything in Growth +",
        "Unlimited Team Members",
        "24x7 AI Receptionist",
        "AI Webchat",
        "Conversation AI (SMS, FB, IG, GBP)",
        "Memberships & Courses",
        "Course Builder",
        "Community Builder",
