  ...
  return (
    <div className="min-h-screen bg-background">
      <Head>
        ...
        <link rel="canonical" href="https://growsmallbiz.io/facebook-ads-management-services/" />
      </Head>
      <ServiceJsonLd
        ...
        url="/facebook-ads-management-services"
        breadcrumbs={[
          { name: "Services", url: "/services" },
          { name: "Facebook Ads Management", url: "/facebook-ads-management-services" },
        ]}
      />
      <Header />
