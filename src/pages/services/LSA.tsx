  ...
  return (
    <div className="min-h-screen bg-background">
      <Head>
        ...
        <meta name="keywords" content="Google Local Service Ads, LSAs management, local lead generation, verified leads, Google Guarantee badge, digital marketing agency, optimize LSA profiles, free strategy call" />
        <meta property="og:title" content="Grow Locally: Expert Google LSA Management | GrowSmallBiz" />
          ...
          <div className="max-w-5xl mx-auto">
            ...
            <div className="grid sm:grid-cols-2 gap-6 mt-12">
              {[
                ...
                { icon: Target, title: "A Complete Local Advertising Presence", desc: <>We integrate your LSA campaign with your <Link to="/services/paid-advertising/google-ads/" className="text-primary hover:underline">Google Search Ads</Link> and organic SEO footprint so every channel reinforces the other and your business dominates local search end to end.</> },
              ].map((card, i) => (
          ...
          <div className="max-w-5xl mx-auto">
            ...
            <div className="grid sm:grid-cols-2 gap-6 mt-12">
              {[
                ...
                { icon: Target, title: "Integration with Your Full Local Advertising Strategy", desc: <>We align your LSA campaign with your Google Search Ads, <Link to="/services/seo-agency/local-seo/" className="text-primary hover:underline">local SEO</Link>, and website to create a complete local advertising ecosystem where every channel amplifies the others.</> },
              ].map((svc, i) => (
