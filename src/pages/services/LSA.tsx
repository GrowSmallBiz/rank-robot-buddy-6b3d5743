  ...
  const strategyUrl = buildUrl(CTA_URLS.strategySession, "strategy-session");
    <div className="min-h-screen bg-background">
      <Head>
        ...
        <link rel="canonical" href="https://growsmallbiz.io/google-local-services-ads-management/" />
      </Head>
      <ServiceJsonLd
        ...
        url="/google-local-services-ads-management"
        breadcrumbs={[
          { name: "Services", url: "/services" },
          { name: "Google Local Service Ads Management", url: "/google-local-services-ads-management" },
        ]}
      />
      <Header />
