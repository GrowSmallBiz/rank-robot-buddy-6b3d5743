...
const OnPageSEO = () => {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "min-h-screen bg-background", children: [
    /* @__PURE__ */ jsxs(Head, { children: [
      /* @__PURE__ */ jsx("title", { children: "On-Page SEO for Local Service Businesses | GrowSmallBiz" }),
      /* @__PURE__ */ jsx("meta", { name: "description", content: "Managed on-page SEO execution for local service businesses. GrowSmallBiz optimizes title tags, headings, content, internal links, and page structure to improve rankings and conversions." }),
      /* @__PURE__ */ jsx("link", { rel: "canonical", href: "https://growsmallbiz.io/services/seo-agency/on-page-seo/" })
    ] }),
    /* @__PURE__ */ jsx(
      ServiceJsonLd,
      {
    ...
    /* @__PURE__ */ jsxs("main", { id: "main-content", children: [
      /* @__PURE__ */ jsx(
        ServiceHero,
        {
          ...
          title: /* @__PURE__ */ jsxs(Fragment, { children: [
            "On-Page SEO That Makes All Money Pages Easier to Rank — and Easier to",
            " "
          ] }),
      ...
      /* @__PURE__ */ jsx("section", { className: "py-24", children: /* @__PURE__ */ jsx("div", { className: "container mx-auto px-4", children: /* @__PURE__ */ jsxs("div", { className: "max-w-4xl mx-auto", children: [
        /* @__PURE__ */ jsxs("div", { className: "text-center mb-16 animate-fade-up", children: [
          ...
          /* @__PURE__ */ jsxs("h2", { className: "section-title", children: [
            ...
            " ",
            /* @__PURE__ */ jsx("span", { className: "text-transparent bg-clip-text bg-gradient-primary italic", children: "Rank, Get Understood, and Convert" })
          ] })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "space-y-6 text-muted-foreground leading-relaxed max-w-3xl mx-auto animate-fade-up", children: [
          /* @__PURE__ */ jsx("p", { children: "Most local service businesses already have a website. Far fewer have pages that are strategically structured to attract the right search traffic, communicate clear relevance, and turn that traffic into calls, forms, and booked jobs." }),
          /* @__PURE__ */ jsx("p", { children: "That gap is on-page SEO." }),
          /* @__PURE__ */ jsx("p", { children: `When someone searches on Google for "emergency HVAC repair in Austin," "plumber near me," or "Botox med spa near me," and when they ask ChatGPT things like "Who offers emergency HVAC repair in Austin?" or "What's the best med spa near me for Botox?" your page needs to send strong, consistent relevance signals.` }),
          /* @__PURE__ */ jsxs("div", { className: "rounded-2xl p-6 space-y-4 border-l-4 border-primary", style: { backgroundColor: "hsl(210 40% 16%)" }, children: [
            /* @__PURE__ */ jsx("p", { className: "text-foreground leading-relaxed", children: "Google evaluates whether your page is giving those signals through:" }),
            /* @__PURE__ */ jsx("ul", { className: "space-y-2 text-foreground/90", children: ["Title tags", "Heading structure", "Semantic context", "Internal linking", "Content depth", "Overall page clarity"].map((item, i) => /* @__PURE__ */ jsxs("li", { className: "flex items-start gap-3", children: [
              /* @__PURE__ */ jsx(CheckCircle2, { className: "w-4 h-4 text-primary mt-0.5 shrink-0" }),
              /* @__PURE__ */ jsx("span", { children: item })
            ] }, i)) })
          ] }),
          /* @__PURE__ */ jsx("p", { children: "Those same signals also help your business content become easier to interpret across broader search systems and AI-assisted discovery experiences." }),
          /* @__PURE__ */ jsx("p", { children: "At the same time, the people who land on your pages are making split-second judgments. Is this business credible? Do they serve my area? Do they offer exactly what I need? Is the next step obvious? If the page feels vague, generic, or poorly aligned with the search, the opportunity is lost." }),
          /* @__PURE__ */ jsx("p", { className: "text-xl md:text-2xl font-display font-bold text-foreground text-center pt-4", children: "On-page SEO closes both gaps at once. It helps your pages communicate clearly to search engines while also helping real people feel confident enough to contact you. Inside GrowSmallBiz's Managed AI SEO system, that stronger on-page foundation makes every other SEO investment more effective." })
        ] })
      ] }) }) }),
      /* @__PURE__ */ jsx("section", { className: "py-24 bg-card", children: /* @__PURE__ */ jsxs("div", { className: "container mx-auto px-4", children: [
        /* @__PURE__ */ jsxs("div", { className: "text-center mb-16 animate-fade-up", children: [
          /* @__PURE__ */ jsx("p", { className: "section-subtitle", children: "OUR ON-PAGE SEO METHODOLOGY" }),
          /* @__PURE__ */ jsxs("h2", { className: "section-title", children: [
            "Managed On-Page SEO Execution Across",
            " ",
            /* @__PURE__ */ jsx("span", { className: "text-transparent bg-clip-text bg-gradient-primary italic", children: "Every Important Page" })
          ] }),
          /* @__PURE__ */ jsx("p", { className: "section-description mt-4", children: "On-page SEO is not just adding a keyword to a title tag and calling it done. It is a systematic, multi-element optimization of the pages that matter most to your growth — your service pages, location pages, and homepage." }),
          /* @__PURE__ */ jsx("p", { className: "text-muted-foreground mt-2", children: "Here is what GrowSmallBiz optimizes as part of your managed program." })
        ] }),
        /* @__PURE__ */ jsx("div", { className: "grid sm:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl mx-auto", children: onPageServices.map((service, index) => /* @__PURE__ */ jsxs(
          GlowCard,
          {
      ...
      /* @__PURE__ */ jsx("section", { className: "py-24", children: /* @__PURE__ */ jsx("div", { className: "container mx-auto px-4", children: /* @__PURE__ */ jsxs("div", { className: "max-w-4xl mx-auto", children: [
        /* @__PURE__ */ jsxs("div", { className: "text-center mb-16 animate-fade-up", children: [
          /* @__PURE__ */ jsx("p", { className: "section-subtitle", children: "COMMON ISSUES" }),
          /* @__PURE__ */ jsxs("h2", { className: "section-title", children: [
            "The On-Page Problems Silently",
            " ",
            /* @__PURE__ */ jsx("span", { className: "text-transparent bg-clip-text bg-gradient-primary italic", children: "Suppressing Your Search Rankings" })
          ] })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "space-y-6 text-muted-foreground leading-relaxed max-w-3xl mx-auto animate-fade-up", children: [
          /* @__PURE__ */ jsx("p", { children: "Most local business websites have not been touched since they were built. And most were never optimized for search to begin with — they were built to look good, not to rank. These are the on-page issues we see most consistently, and they quietly cost businesses rankings and leads every single month." }),
          /* @__PURE__ */ jsx("div", { className: "space-y-0", children: commonMistakes.map((mistake, i) => /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsxs("div", { className: "flex items-start gap-3 rounded-2xl p-6 bg-background/60 border border-border/50", children: [
              /* @__PURE__ */ jsx(XCircle, { className: "w-5 h-5 text-destructive mt-0.5 shrink-0" }),
              /* @__PURE__ */ jsx("span", { className: "text-foreground/90", children: mistake })
            ] }),
            i < commonMistakes.length - 1 && /* @__PURE__ */ jsx("div", { className: "border-b border-primary/10 mx-8" })
          ] }, i)) }),
          /* @__PURE__ */ jsx("p", { className: "text-xl md:text-2xl font-display font-bold text-foreground text-center pt-4", children: "None of these are unusual. They are the default state of most local business websites. The good news is that every one of them is fixable, and fixing them produces measurable results." })
        ] })
      ] }) }) }),
      /* @__PURE__ */ jsx("section", { className: "py-24 bg-card", children: /* @__PURE__ */ jsx("div", { className: "container mx-auto px-4", children: /* @__PURE__ */ jsxs("div", { className: "max-w-4xl mx-auto", children: [
        ...
        ].map((item, i) => /* @__PURE__ */ jsxs("div", { className: "animate-fade-up rounded-2xl p-8 bg-background/60 border border-border/50", style: { animationDelay: `${i * 0.1}s` }, children: [
        ...
        /* @__PURE__ */ jsx("div", { className: "max-w-3xl mx-auto mt-8 animate-fade-up", children: /* @__PURE__ */ jsx("div", { className: "rounded-2xl p-6 space-y-4 border-l-4 border-primary", style: { backgroundColor: "hsl(210 40% 16%)" }, children: /* @__PURE__ */ jsx("p", { className: "text-muted-foreground leading-relaxed", children: "The result is a stronger on-page SEO workflow: faster than manual-only execution, more consistent than ad hoc freelancer work, and better suited to building durable visibility across both search rankings and modern discovery environments." }) }) })
      ] }) }) }),
      /* @__PURE__ */ jsx(
        CardCTA,
        {
      ...
      /* @__PURE__ */ jsx("section", { className: "py-24", children: /* @__PURE__ */ jsx("div", { className: "container mx-auto px-4", children: /* @__PURE__ */ jsxs("div", { className: "max-w-4xl mx-auto", children: [
        /* @__PURE__ */ jsxs("div", { className: "text-center mb-16 animate-fade-up", children: [
          ...
          /* @__PURE__ */ jsxs("h2", { className: "section-title", children: [
            ...
            " ",
            /* @__PURE__ */ jsx("span", { className: "text-transparent bg-clip-text bg-gradient-primary italic", children: "Step by Step" })
          ] })
        ] }),
        /* @__PURE__ */ jsx("div", { className: "space-y-0 max-w-3xl mx-auto", children: processSteps.map((item, i) => /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsxs("div", { className: "animate-fade-up rounded-2xl p-8 bg-background/60 border border-border/50", style: { animationDelay: `${i * 0.05}s` }, children: [
            /* @__PURE__ */ jsx("div", { className: "flex items-center gap-3 mb-3", children: /* @__PURE__ */ jsx("span", { className: "text-xs font-bold text-primary bg-primary/10 rounded-full px-3 py-1", children: item.step }) }),
            /* @__PURE__ */ jsx("h3", { className: "text-xl font-display font-bold text-foreground mb-3", children: item.title }),
            /* @__PURE__ */ jsx("p", { className: "text-muted-foreground leading-relaxed", children: item.description })
          ] }),
          i < processSteps.length - 1 && /* @__PURE__ */ jsx("div", { className: "border-b border-primary/10 mx-8" })
        ] }, i)) })
      ] }) }) }),
      /* @__PURE__ */ jsx("section", { className: "py-24 bg-card", children: /* @__PURE__ */ jsxs("div", { className: "container mx-auto px-4", children: [
        /* @__PURE__ */ jsxs("div", { className: "text-center mb-16 animate-fade-up", children: [
          ...
          /* @__PURE__ */ jsxs("h2", { className: "section-title", children: [
            ...
            " ",
            /* @__PURE__ */ jsx("span", { className: "text-transparent bg-clip-text bg-gradient-primary italic", children: "That Need to Win on Search" })
          ] }),
          /* @__PURE__ */ jsx("p", { className: "section-description mt-4", children: "On-page SEO delivers the greatest impact for businesses where search visibility translates directly to phone calls, form fills, appointment bookings, and revenue. If your customers search for what you offer before they buy, this service is built for you." })
        ] }),
        /* @__PURE__ */ jsx("div", { className: "grid sm:grid-cols-2 lg:grid-cols-3 gap-6 max-w-5xl mx-auto", children: industries.map((item, i) => /* @__PURE__ */ jsxs(
          "div",
          {
        ...
        /* @__PURE__ */ jsx("p", { className: "text-center text-muted-foreground mt-10 max-w-3xl mx-auto animate-fade-up", style: { animationDelay: "0.3s" }, children: "If your business fits any of these categories and you are not showing up consistently on the first page for your most valuable service searches, on-page SEO is likely one of the key gaps holding you back." })
      ] }) }),
      /* @__PURE__ */ jsx("section", { className: "py-24 bg-card", children: /* @__PURE__ */ jsx("div", { className: "container mx-auto px-4", children: /* @__PURE__ */ jsxs("div", { className: "max-w-4xl mx-auto", children: [
        /* @__PURE__ */ jsxs("div", { className: "text-center mb-16 animate-fade-up", children: [
          ...
          /* @__PURE__ */ jsxs("h2", { className: "section-title", children: [
            ...
            " ",
            /* @__PURE__ */ jsx("span", { className: "text-transparent bg-clip-text bg-gradient-primary italic", children: "On-Page SEO" })
          ] })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "space-y-6 text-muted-foreground leading-relaxed max-w-3xl mx-auto animate-fade-up", children: [
          /* @__PURE__ */ jsx("p", { children: "Most businesses do not need another SEO report. They need the right pages improved, the right issues fixed, and the work executed consistently over time." }),
          /* @__PURE__ */ jsx("p", { children: "That is how GrowSmallBiz operates. We are a managed SEO partner for local service businesses, not a strategy-only consultant handing over recommendations for someone else to implement." })
        ] }),
        ...
        /* @__PURE__ */ jsx("p", { className: "text-center text-muted-foreground mt-10 italic max-w-2xl mx-auto animate-fade-up", style: { animationDelay: "0.25s" }, children: "In other words, GrowSmallBiz helps local service businesses turn on-page SEO into a practical growth asset — not just a checklist item." }),
        /* @__PURE__ */ jsx("div", { className: "text-center mt-8 animate-fade-up", style: { animationDelay: "0.3s" }, children: /* @__PURE__ */ jsx(Link, { to: "/services/seo-agency/", className: "text-primary hover:underline text-sm font-medium inline-flex items-center gap-1", children: "← Back to Managed AI SEO Overview" }) })
      ] }) }) }),
      /* @__PURE__ */ jsx(
        FAQSection,
        {
      ...
      /* @__PURE__ */ jsx("section", { id: "final-cta", className: "py-20 lg:py-28", style: { background: "linear-gradient(180deg, hsl(210 50% 8%) 0%, hsl(210 45% 14%) 50%, hsl(210 50% 8%) 100%)" }, children: /* @__PURE__ */ jsxs("div", { className: "container mx-auto px-4", children: [
        /* @__PURE__ */ jsxs("div", { className: "max-w-4xl mx-auto text-center animate-fade-up", children: [
          ...
          /* @__PURE__ */ jsxs("h2", { className: "text-3xl md:text-4xl font-display font-bold text-foreground mb-6 leading-tight", children: [
            ...
            " ",
            /* @__PURE__ */ jsx("span", { className: "text-transparent bg-clip-text bg-gradient-primary italic", children: "More Leads" })
          ] }),
          /* @__PURE__ */ jsx("p", { className: "text-lg text-muted-foreground mb-8 max-w-3xl mx-auto", children: "If your key service pages and location pages are unclear, under-optimized, or poorly aligned with search intent, they can hold back both your rankings and your conversion rate. That means lost visibility, lost clicks, and lost business." }),
          /* @__PURE__ */ jsx("p", { className: "text-base text-muted-foreground mb-4 max-w-3xl mx-auto", children: "On-page SEO helps turn your existing website into a stronger growth asset by improving page clarity, relevance, structure, and conversion readiness. It also strengthens the foundation that supports your broader SEO performance over time." }),
          /* @__PURE__ */ jsx("p", { className: "text-base text-muted-foreground mb-10 max-w-3xl mx-auto", children: "GrowSmallBiz can audit your current pages, identify the gaps that are limiting performance, and implement a managed on-page optimization plan built around measurable business impact." }),
          /* @__PURE__ */ jsx("p", { className: "text-foreground font-medium mb-6", children: "Start with a free audit and see where your most important pages stand now." })
        ] }),
        /* @__PURE__ */ jsx(
          CardCTA,
          {
