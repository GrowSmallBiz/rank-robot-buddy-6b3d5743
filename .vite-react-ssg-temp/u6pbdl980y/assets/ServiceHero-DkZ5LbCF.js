...
const ServiceHero = ({
  ...
  const renderCTA = (cta, isPrimary) => {
    ...
    const content = /* @__PURE__ */ jsxs(Fragment, { children: [
      cta.label,
      isPrimary && /* @__PURE__ */ jsx(ArrowRight, { className: "w-5 h-5 ml-2" })
    ] });
    if (cta.external) {
      return /* @__PURE__ */ jsx(Button, { variant, size: "lg", asChild: true, children: /* @__PURE__ */ jsx("a", { href: cta.href, target: "_blank", rel: "noopener noreferrer", children: content }) });
    }
