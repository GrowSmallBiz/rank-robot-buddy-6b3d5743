...
const heroBg = "/assets/case-studies-roofers-hero-bg-o4sSzTZR.jpg";
...
const Roofers = () => {
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    /* @__PURE__ */ jsxs(Head, { children: [
      /* @__PURE__ */ jsx("title", { children: "Case Studies for Roofing Businesses | GrowSmallBiz" }),
      /* @__PURE__ */ jsx(
        "meta",
        {
          name: "description",
      ...
      /* @__PURE__ */ jsx("link", { rel: "canonical", href: "https://growsmallbiz.io/case-studies/roofers/" })
    ] }),
    /* @__PURE__ */ jsx(
      PageJsonLd,
      {
