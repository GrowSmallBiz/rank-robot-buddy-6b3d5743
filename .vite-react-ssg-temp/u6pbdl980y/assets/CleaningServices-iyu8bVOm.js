...
const heroBg = "/assets/case-studies-cleaning-hero-bg-CljP9Amh.jpg";
const summaryCards = [
  {
...
const CleaningServices = () => {
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    /* @__PURE__ */ jsxs(Head, { children: [
      /* @__PURE__ */ jsx("title", { children: "Case Studies for Cleaning Services Businesses | GrowSmallBiz" }),
      /* @__PURE__ */ jsx(
        "meta",
        {
          name: "description",
      ...
      /* @__PURE__ */ jsx("link", { rel: "canonical", href: "https://growsmallbiz.io/case-studies/cleaning-services/" })
    ] }),
    /* @__PURE__ */ jsx(
      PageJsonLd,
      {
