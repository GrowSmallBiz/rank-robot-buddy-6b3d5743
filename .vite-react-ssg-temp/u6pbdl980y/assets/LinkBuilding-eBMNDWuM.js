...
const linkBuildingHeroBg = "/assets/link-building-hero-bg-KfF9EzlR.jpg";
...
const LinkBuilding = () => {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "min-h-screen bg-background", children: [
    /* @__PURE__ */ jsxs(Head, { children: [
      /* @__PURE__ */ jsx("title", { children: "Premium SEO Link Building Services For Local Service Businesses: Build Authority in Your Local Market | GrowSmallBiz" }),
