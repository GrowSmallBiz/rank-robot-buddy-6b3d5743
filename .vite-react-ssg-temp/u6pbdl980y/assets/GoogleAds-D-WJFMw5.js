...
import { Target, ArrowRight, Zap, Eye, MapPin, BarChart3, RefreshCw, Search, ShieldCheck, CheckCircle2, Home, Stethoscope, Star, Wrench, Scale, Car, Users, Camera, TrendingUp, Phone } from "lucide-react";
...
const GoogleAds = () => {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "min-h-screen bg-background", children: [
    /* @__PURE__ */ jsxs(Head, { children: [
      /* @__PURE__ */ jsx("title", { children: "Google Ads for Local Businesses | Local PPC Management | GrowSmallBiz" }),
      /* @__PURE__ */ jsx("meta", { name: "description", content: "Stop paying for clicks that go nowhere. GrowSmallBiz builds and manages Google Ads campaigns for local service businesses — so every dollar you spend works harder to fill your calendar, your phone line, and your revenue goals." }),
    ...
    /* @__PURE__ */ jsxs("section", { className: "relative pt-32 pb-24 overflow-hidden", children: [
      ...
      /* @__PURE__ */ jsx("div", { className: "container mx-auto px-4 relative z-10", children: /* @__PURE__ */ jsxs("div", { className: "max-w-4xl mx-auto text-center space-y-8", children: [
        ...
        /* @__PURE__ */ jsxs("h1", { className: "text-4xl md:text-5xl lg:text-6xl font-display font-bold text-foreground leading-tight animate-fade-up", children: [
          ...
          " ",
          /* @__PURE__ */ jsx("span", { className: "text-transparent bg-clip-text bg-gradient-primary", children: "Actually Bring in Customers" })
        ] }),
        /* @__PURE__ */ jsx("p", { className: "text-lg md:text-xl text-muted-foreground leading-relaxed max-w-3xl mx-auto animate-fade-up", style: { animationDelay: "0.1s" }, children: "Stop paying for clicks that go nowhere. GrowSmallBiz builds and manages Google Ads campaigns for local service businesses — so every dollar you spend works harder to fill your calendar, your phone line, and your revenue goals." }),
        /* @__PURE__ */ jsx("p", { className: "text-base text-muted-foreground leading-relaxed max-w-3xl mx-auto animate-fade-up", style: { animationDelay: "0.15s" }, children: "Most local businesses run Google Ads and get disappointed. The ads run, the budget drains, and the phone stays quiet. That is not a Google problem — it is a strategy problem." }),
        /* @__PURE__ */ jsx("p", { className: "text-base text-muted-foreground leading-relaxed max-w-3xl mx-auto animate-fade-up", style: { animationDelay: "0.2s" }, children: "At GrowSmallBiz, we specialize exclusively in local service businesses. We build campaigns that target the right customers in your area, at the right moment, with the right message — and we track every lead back to its source so you always know what is working." }),
    ...
    /* @__PURE__ */ jsx("section", { className: "py-16 bg-card", children: /* @__PURE__ */ jsxs("div", { className: "container mx-auto px-4", children: [
      /* @__PURE__ */ jsx(SectionHeader, { title: "Proven Results for", titleHighlight: "Local Service Businesses", className: "mb-12" }),
      ...
      /* @__PURE__ */ jsx("p", { className: "text-sm text-muted-foreground text-center mt-8", children: "Results from GrowSmallBiz client campaigns across HVAC, Med Spa, Home Services, Dental, and more." })
    ] }) }),
    ...
    /* @__PURE__ */ jsx("section", { className: "py-24", children: /* @__PURE__ */ jsx("div", { className: "container mx-auto px-4", children: /* @__PURE__ */ jsxs("div", { className: "max-w-5xl mx-auto", children: [
      ...
      /* @__PURE__ */ jsx("div", { className: "grid sm:grid-cols-2 gap-8 mt-12", children: [
        ...
        {
          icon: ShieldCheck,
          title: "Google Local Service Ads (LSA) Management",
      ...
      ].map((svc, i) => /* @__PURE__ */ jsxs("div", { className: "bg-card border border-border rounded-xl p-6 space-y-4 animate-fade-up", style: { animationDelay: `${i * 0.05}s` }, children: [
    ...
    /* @__PURE__ */ jsx("section", { id: "how-it-works", className: "py-24 bg-card", children: /* @__PURE__ */ jsx("div", { className: "container mx-auto px-4", children: /* @__PURE__ */ jsxs("div", { className: "max-w-5xl mx-auto", children: [
      ...
      /* @__PURE__ */ jsx("div", { className: "space-y-6 mt-12", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "flex flex-col items-center", children: [
          ...
          i < 4 && /* @__PURE__ */ jsx("div", { className: "w-px flex-1 bg-border mt-2" })
        ] }),
    ...
    /* @__PURE__ */ jsx("section", { className: "py-24", children: /* @__PURE__ */ jsx("div", { className: "container mx-auto px-4", children: /* @__PURE__ */ jsxs("div", { className: "max-w-5xl mx-auto", children: [
      ...
      /* @__PURE__ */ jsx("div", { className: "grid sm:grid-cols-2 lg:grid-cols-4 gap-6 mt-12", children: [
      ...
      ].map((ind, i) => /* @__PURE__ */ jsxs("div", { className: "bg-card border border-border rounded-xl p-5 text-center space-y-3 animate-fade-up", style: { animationDelay: `${i * 0.05}s` }, children: [
        /* @__PURE__ */ jsx("div", { className: "w-10 h-10 mx-auto rounded-lg bg-primary/10 flex items-center justify-center", children: /* @__PURE__ */ jsx(ind.icon, { className: "w-5 h-5 text-primary" }) }),
    ...
    /* @__PURE__ */ jsx("section", { className: "py-24", children: /* @__PURE__ */ jsx("div", { className: "container mx-auto px-4", children: /* @__PURE__ */ jsxs("div", { className: "max-w-5xl mx-auto", children: [
      ...
      /* @__PURE__ */ jsx("div", { className: "grid lg:grid-cols-3 gap-8 mt-12", children: ["HVAC Company", "Roofing Contractor", "Med Spa"].map((name, i) => /* @__PURE__ */ jsxs("div", { className: "bg-card border border-border rounded-2xl p-8 text-center animate-fade-up", style: { animationDelay: `${i * 0.1}s` }, children: [
