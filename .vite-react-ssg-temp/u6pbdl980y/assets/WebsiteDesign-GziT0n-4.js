...
import { u as useUtm, H as Header, B as Button, b as baseContactCTA, F as Footer } from "../main.mjs";
...
import { Globe, Clock, TrendingUp, Wrench, Layers, AlertTriangle, Search, MousePointerClick, CheckCircle2, Link2, ArrowRight, Smartphone, Zap, MessageSquare, Layout, Shield, Eye, BarChart3, Home, Heart, Sparkles, Scale, Building } from "lucide-react";
import "react";
...
const websiteDesignHeroBg = "/assets/website-design-hero-bg-3piSPqD-.jpg";
...
const includedFeatures = [
  ...
  },
  {
    ...
    description: "A call to action is not just a button. It's a specific prompt, placed at the right moment in the visitor's experience, written in a way that reduces hesitation and makes the next step feel easy. We place CTAs strategically throughout your site and write them to reflect what your ideal customer actually needs to hear before they reach out."
  },
  {
    icon: Search,
...
const WebsiteDesign = () => {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "min-h-screen bg-background", children: [
    ...
    /* @__PURE__ */ jsx("section", { className: "py-16 lg:py-20", style: { background: "linear-gradient(180deg, hsl(210 50% 8%) 0%, hsl(210 45% 14%) 50%, hsl(210 50% 8%) 100%)" }, children: /* @__PURE__ */ jsx("div", { className: "container mx-auto px-4", children: /* @__PURE__ */ jsx("div", { className: "max-w-5xl mx-auto", children: /* @__PURE__ */ jsxs("div", { className: "grid lg:grid-cols-2 gap-10 lg:gap-16 animate-fade-up", children: [
      /* @__PURE__ */ jsxs("div", { className: "space-y-6", children: [
        /* @__PURE__ */ jsxs("div", { className: "flex items-start gap-4", children: [
          /* @__PURE__ */ jsx("div", { className: "p-3 rounded-xl bg-primary/10 shrink-0 mt-1", children: /* @__PURE__ */ jsx(Clock, { className: "h-5 w-5 text-primary" }) }),
          /* @__PURE__ */ jsx("p", { className: "text-muted-foreground text-lg leading-relaxed", children: "When a potential customer lands on your site, you have roughly eight seconds before they decide whether to stay or leave. If your phone number isn't obvious, your services aren't immediately clear, and there's no compelling reason to reach out — they're gone. And they're calling someone else." })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "flex items-start gap-4", children: [
          /* @__PURE__ */ jsx("div", { className: "p-3 rounded-xl bg-primary/10 shrink-0 mt-1", children: /* @__PURE__ */ jsx(TrendingUp, { className: "h-5 w-5 text-primary" }) }),
          /* @__PURE__ */ jsx("p", { className: "text-muted-foreground text-lg leading-relaxed", children: "Your website is not a brochure. It's your highest-leverage sales asset. It works around the clock, and within seconds of someone arriving, it either builds confidence or quietly loses them." })
        ] })
      ] }),
      /* @__PURE__ */ jsxs("div", { className: "space-y-6", children: [
        /* @__PURE__ */ jsxs("div", { className: "flex items-start gap-4", children: [
          /* @__PURE__ */ jsx("div", { className: "p-3 rounded-xl bg-primary/10 shrink-0 mt-1", children: /* @__PURE__ */ jsx(Wrench, { className: "h-5 w-5 text-primary" }) }),
          /* @__PURE__ */ jsx("p", { className: "text-muted-foreground text-lg leading-relaxed", children: "At GrowSmallBiz, we build websites specifically for local service businesses — contractors, healthcare practices, med spas, professional services — where every lead represents real revenue. We start with strategy, not templates. Every layout decision, every line of copy, and every call to action is designed to move a visitor toward contacting you." })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "flex items-start gap-4", children: [
          /* @__PURE__ */ jsx("div", { className: "p-3 rounded-xl bg-primary/10 shrink-0 mt-1", children: /* @__PURE__ */ jsx(Layers, { className: "h-5 w-5 text-primary" }) }),
          /* @__PURE__ */ jsx("p", { className: "text-muted-foreground text-lg leading-relaxed", children: "But a high-converting website doesn't operate in isolation. It's the conversion foundation of a broader digital growth system — the hub that makes your SEO investment produce actual leads, your paid traffic convert instead of bounce, and your referrals close faster. That's the conversation we start on our free growth strategy call." })
        ] })
      ] })
    ] }) }) }) }),
    /* @__PURE__ */ jsx("section", { className: "py-20 lg:py-28", children: /* @__PURE__ */ jsxs("div", { className: "container mx-auto px-4", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "max-w-5xl mx-auto animate-fade-up", children: [
        /* @__PURE__ */ jsxs("div", { className: "grid lg:grid-cols-5 gap-10 lg:gap-16 mb-12", children: [
          /* @__PURE__ */ jsxs("div", { className: "lg:col-span-3 space-y-6 text-muted-foreground text-lg leading-relaxed", children: [
          ...
          /* @__PURE__ */ jsx("div", { className: "lg:col-span-2", children: /* @__PURE__ */ jsxs("div", { className: "rounded-2xl border-2 border-destructive/30 bg-destructive/5 p-6 lg:p-8 h-full", children: [
            ...
            /* @__PURE__ */ jsx("ul", { className: "space-y-3", children: problemBullets.map((bullet, i) => /* @__PURE__ */ jsxs("li", { className: "flex items-start gap-3", children: [
              /* @__PURE__ */ jsx(AlertTriangle, { className: "h-5 w-5 text-primary mt-0.5 shrink-0" }),
              /* @__PURE__ */ jsx("span", { className: "text-muted-foreground text-sm leading-relaxed", children: bullet })
            ] }, i)) })
          ] }) })
        ] }),
        /* @__PURE__ */ jsx("div", { className: "rounded-2xl border border-primary/20 bg-primary/5 p-6 lg:p-8 text-center", children: /* @__PURE__ */ jsx("p", { className: "text-muted-foreground text-lg leading-relaxed max-w-3xl mx-auto", children: "A website that doesn't convert isn't a neutral investment. It's an active liability — costing you leads, bookings, and revenue every day it stays the way it is. And it's undermining every other marketing channel you're running at the same time." }) })
      ] })
    ] }) }),
    /* @__PURE__ */ jsx("section", { className: "py-20 lg:py-28 bg-secondary/30", children: /* @__PURE__ */ jsxs("div", { className: "container mx-auto px-4", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "max-w-5xl mx-auto animate-fade-up", children: [
        /* @__PURE__ */ jsxs("div", { className: "grid lg:grid-cols-2 gap-8 lg:gap-12 mb-12", children: [
          /* @__PURE__ */ jsxs(GlowCard, { className: "p-8", glowOnHover: true, liftOnHover: false, children: [
            /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3 mb-4", children: [
              /* @__PURE__ */ jsx("div", { className: "p-2.5 rounded-lg bg-primary/10", children: /* @__PURE__ */ jsx(Search, { className: "h-5 w-5 text-primary" }) }),
              /* @__PURE__ */ jsx("h3", { className: "text-lg font-bold text-foreground", children: "Strategy First" })
            ] }),
            /* @__PURE__ */ jsx("p", { className: "text-muted-foreground leading-relaxed", children: "Before we touch a design or write a line of copy, we do strategy. We look at your business, your market, your ideal customer, and the specific action you need your website to drive — whether that's a phone call, a form submission, a booking, or a quote request. Every decision after that is made in service of that outcome." })
          ] }),
          /* @__PURE__ */ jsxs(GlowCard, { className: "p-8", glowOnHover: true, liftOnHover: false, children: [
            /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3 mb-4", children: [
              /* @__PURE__ */ jsx("div", { className: "p-2.5 rounded-lg bg-primary/10", children: /* @__PURE__ */ jsx(MousePointerClick, { className: "h-5 w-5 text-primary" }) }),
              /* @__PURE__ */ jsx("h3", { className: "text-lg font-bold text-foreground", children: "Built for Real People" })
            ] }),
            /* @__PURE__ */ jsx("p", { className: "text-muted-foreground leading-relaxed", children: "That means your website isn't built around what looks attractive to a designer. It's built around what moves a real person — someone who found you on Google or clicked your ad — to trust you quickly, understand your value clearly, and take the next step without friction." })
          ] }),
          /* @__PURE__ */ jsxs(GlowCard, { className: "p-8", glowOnHover: true, liftOnHover: false, children: [
            /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3 mb-4", children: [
              /* @__PURE__ */ jsx("div", { className: "p-2.5 rounded-lg bg-primary/10", children: /* @__PURE__ */ jsx(CheckCircle2, { className: "h-5 w-5 text-primary" }) }),
              /* @__PURE__ */ jsx("h3", { className: "text-lg font-bold text-foreground", children: "Clarity at Every Level" })
            ] }),
            /* @__PURE__ */ jsx("p", { className: "text-muted-foreground leading-relaxed", children: "In practice, that looks like this: your homepage communicates exactly what you do and who you serve within seconds of arrival. Your services are described in terms of outcomes, not just tasks. Your credibility is established through proof — real reviews, verifiable credentials, and specifics that matter to a buyer in your market. Your calls to action are clear, well-placed, and written to reduce hesitation. And your site performs just as well on a phone as it does on a desktop." })
          ] }),
          /* @__PURE__ */ jsxs(GlowCard, { className: "p-8", glowOnHover: true, liftOnHover: false, children: [
            /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3 mb-4", children: [
              /* @__PURE__ */ jsx("div", { className: "p-2.5 rounded-lg bg-primary/10", children: /* @__PURE__ */ jsx(Link2, { className: "h-5 w-5 text-primary" }) }),
              /* @__PURE__ */ jsx("h3", { className: "text-lg font-bold text-foreground", children: "Connected From Day One" })
            ] }),
            /* @__PURE__ */ jsx("p", { className: "text-muted-foreground leading-relaxed", children: "Your website is also built from day one to integrate with the rest of your marketing — connecting to your CRM, booking system, and tracking tools. It's the conversion hub of the Digital Dominance Method, designed to work alongside your SEO, paid advertising, and lead generation efforts — not as a standalone project handed off and forgotten." })
          ] })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "grid lg:grid-cols-2 gap-8", children: [
          /* @__PURE__ */ jsxs("div", { className: "rounded-2xl border-2 border-primary/30 bg-card/50 backdrop-blur-sm p-8 animate-fade-up", children: [
            /* @__PURE__ */ jsx("h3", { className: "text-xl font-bold text-foreground mb-4", children: "A note on how we work:" }),
          ...
          /* @__PURE__ */ jsxs("div", { className: "rounded-2xl border-2 border-primary/30 bg-card/50 backdrop-blur-sm p-8 animate-fade-up", style: { animationDelay: "0.1s" }, children: [
            /* @__PURE__ */ jsx("h3", { className: "text-xl font-bold text-foreground mb-4", children: "Why GrowSmallBiz:" }),
            /* @__PURE__ */ jsx("p", { className: "text-muted-foreground leading-relaxed", children: "Most web design agencies hand you a finished site and move on. GrowSmallBiz works exclusively with local service businesses — which means we're not learning your industry on your dime. We know what makes a roofing lead different from a med spa inquiry. We know what trust signals matter to a patient choosing a specialist versus a homeowner vetting a contractor. That specificity is what separates a website that looks right from one that actually performs — and it's built into every engagement we take on." })
          ] })
        ] })
      ] })
    ] }) }),
    /* @__PURE__ */ jsx("section", { className: "py-20 lg:py-28", children: /* @__PURE__ */ jsxs("div", { className: "container mx-auto px-4", children: [
      ...
      /* @__PURE__ */ jsx("div", { className: "grid md:grid-cols-2 gap-8", children: includedFeatures.map((feature, index) => /* @__PURE__ */ jsx(GlowCard, { className: "p-8 animate-fade-up", style: { animationDelay: `${index * 0.05}s` }, children: /* @__PURE__ */ jsxs("div", { className: "flex items-start gap-4", children: [
        /* @__PURE__ */ jsx("div", { className: "p-3 rounded-xl bg-primary/10 shrink-0", children: /* @__PURE__ */ jsx(feature.icon, { className: "h-6 w-6 text-primary" }) }),
    ...
    /* @__PURE__ */ jsx("section", { className: "py-20 lg:py-28 bg-secondary/30", children: /* @__PURE__ */ jsxs("div", { className: "container mx-auto px-4", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "max-w-5xl mx-auto animate-fade-up", children: [
        /* @__PURE__ */ jsxs("div", { className: "grid lg:grid-cols-2 gap-8 lg:gap-12 mb-12", children: [
          /* @__PURE__ */ jsxs("div", { className: "space-y-6 text-muted-foreground text-lg leading-relaxed", children: [
            /* @__PURE__ */ jsx("p", { children: "Think through the path a new customer takes before they contact you. Maybe they searched for a service in your area and found you on Google. Maybe a neighbor mentioned your name. Maybe they clicked your ad. In almost every case, the next thing they do is visit your website. That visit is the moment. And it's almost entirely within your control." }),
            /* @__PURE__ */ jsx("p", { children: "If your site communicates clearly — here's who we are, here's what we do, here's why we're the right choice, here's how to reach us — a meaningful percentage of those visitors will contact you. If it doesn't, they'll hesitate. And hesitation almost always ends the same way: a closed tab and a competitor's number getting dialed instead." })
          ] }),
          /* @__PURE__ */ jsxs("div", { className: "space-y-6 text-muted-foreground text-lg leading-relaxed", children: [
            /* @__PURE__ */ jsx("p", { children: "This is why your website isn't just one marketing asset among many — it's the conversion layer that your entire growth strategy runs through. Every channel feeds it. Every dollar you spend on visibility, traffic, and reach either pays off or gets wasted based on what happens when a prospect arrives." }),
            /* @__PURE__ */ jsx("p", { children: "A strong website makes your Google Ads more profitable — because the traffic you're paying for actually converts. It makes your SEO investment produce real leads instead of just rankings. It makes your referrals close faster, because the prospect arrives informed and leaves ready to book. It gives your social media a destination worth sending people to." })
          ] })
        ] }),
    ...
    /* @__PURE__ */ jsx("section", { className: "py-20 lg:py-28", children: /* @__PURE__ */ jsxs("div", { className: "container mx-auto px-4", children: [
          ...
          return /* @__PURE__ */ jsxs(
            "div",
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsx("div", { className: `md:w-[calc(50%-2rem)] ${isLeft ? "md:mr-auto" : "md:ml-auto"}`, children: /* @__PURE__ */ jsxs("div", { className: "bg-card/50 border border-border rounded-2xl p-8 hover:shadow-[0_0_30px_rgba(255,127,80,0.15)] transition-all duration-300", children: [
                  /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3 mb-4", children: [
                    ...
                    /* @__PURE__ */ jsx("span", { className: "text-sm font-semibold text-primary", children: step.step })
                  ] }),
                  /* @__PURE__ */ jsx("h3", { className: "text-xl font-bold text-foreground mb-4", children: step.title }),
                  /* @__PURE__ */ jsx("p", { className: "text-muted-foreground leading-relaxed mb-4", children: step.description }),
                  /* @__PURE__ */ jsx("p", { className: "text-sm font-medium text-primary/80 italic", children: step.deliverable })
                ] }) })
              ]
            },
            index
      ...
      /* @__PURE__ */ jsxs("div", { className: "flex flex-col sm:flex-row gap-4 justify-center mt-12 animate-fade-up", children: [
        ...
        /* @__PURE__ */ jsx(Button, { variant: "heroOutline", size: "lg", asChild: true, children: /* @__PURE__ */ jsx(Link, { to: "/contact/", children: "View Industries We Serve" }) })
      ] })
    ] }) }),
    /* @__PURE__ */ jsx("section", { className: "py-20 lg:py-28 bg-secondary/30", children: /* @__PURE__ */ jsxs("div", { className: "container mx-auto px-4", children: [
      /* @__PURE__ */ jsx(
      ...
      /* @__PURE__ */ jsx("div", { className: "grid md:grid-cols-2 lg:grid-cols-3 gap-8", children: afterLaunchItems.map((item, index) => /* @__PURE__ */ jsxs(GlowCard, { className: "p-8 animate-fade-up", style: { animationDelay: `${index * 0.05}s` }, children: [
        /* @__PURE__ */ jsx("div", { className: "p-3 rounded-xl bg-primary/10 w-fit mb-4", children: /* @__PURE__ */ jsx(item.icon, { className: "h-6 w-6 text-primary" }) }),
        /* @__PURE__ */ jsx("h3", { className: "text-lg font-bold text-foreground mb-3", children: item.title }),
        /* @__PURE__ */ jsx("p", { className: "text-muted-foreground leading-relaxed text-sm", children: item.description })
      ] }, index)) })
    ] }) }),
    /* @__PURE__ */ jsx("section", { className: "py-20 lg:py-28", children: /* @__PURE__ */ jsxs("div", { className: "container mx-auto px-4", children: [
      /* @__PURE__ */ jsx(
    ...
    /* @__PURE__ */ jsx("section", { className: "py-20 lg:py-28", style: { background: "linear-gradient(180deg, hsl(210 50% 8%) 0%, hsl(210 45% 14%) 50%, hsl(210 50% 8%) 100%)" }, children: /* @__PURE__ */ jsxs("div", { className: "container mx-auto px-4", children: [
      ...
      /* @__PURE__ */ jsx("div", { className: "max-w-4xl mx-auto animate-fade-up", style: { animationDelay: "0.1s" }, children: /* @__PURE__ */ jsxs("div", { className: "grid lg:grid-cols-2 gap-8 lg:gap-12", children: [
        /* @__PURE__ */ jsxs("div", { className: "space-y-6", children: [
          /* @__PURE__ */ jsx("p", { className: "text-xl font-semibold text-foreground", children: "That's what the free growth strategy call is for." }),
          /* @__PURE__ */ jsx("p", { className: "text-muted-foreground text-lg leading-relaxed", children: "In 30 minutes, we'll look at your current website, identify the specific gaps that are costing you leads, and walk you through what a conversion-focused rebuild would look like for your business. We'll also look at the bigger picture: how your website connects to your SEO, your paid traffic, and your lead generation system — and where the highest-leverage opportunities are in your specific market." })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "space-y-6", children: [
          /* @__PURE__ */ jsx("p", { className: "text-muted-foreground text-lg leading-relaxed", children: "This isn't a website consultation. It's a growth strategy conversation. The website is almost always where it starts — because without a strong conversion foundation, nothing else performs the way it should. But the call covers the full picture: website, AI SEO, paid search, conversion strategy, and what a complete digital growth system looks like for a business like yours." }),
