...
import { Users, ArrowRight, Target, Image, RefreshCw, MousePointerClick, Settings, FileText, Layers, Home, Star, Stethoscope, Wrench, Car, Scale, Camera, Briefcase, TrendingUp, CheckCircle2, Phone } from "lucide-react";
...
const FacebookAds = () => {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "min-h-screen bg-background", children: [
    /* @__PURE__ */ jsxs(Head, { children: [
      /* @__PURE__ */ jsx("title", { children: "Facebook Ads Management for Local Businesses — GrowSmallBiz" }),
      /* @__PURE__ */ jsx("meta", { name: "description", content: "Stop wasting ad spend on clicks that never convert. GrowSmallBiz manages your Facebook & Instagram Ads with precision targeting, conversion-focused creative, and full-funnel tracking — so every dollar drives real leads for your local business." }),
    ...
    /* @__PURE__ */ jsxs("section", { className: "relative pt-32 pb-24 overflow-hidden", children: [
      ...
      /* @__PURE__ */ jsx("div", { className: "container mx-auto px-4 relative z-10", children: /* @__PURE__ */ jsxs("div", { className: "max-w-4xl mx-auto text-center space-y-8", children: [
        ...
        /* @__PURE__ */ jsx("p", { className: "text-lg md:text-xl text-muted-foreground leading-relaxed max-w-3xl mx-auto animate-fade-up", style: { animationDelay: "0.1s" }, children: "Most local businesses waste thousands on Facebook Ads chasing likes and impressions. You need leads. We build, manage, and optimize Meta ad campaigns that turn your ad spend into booked appointments, service calls, and paying customers." }),
        /* @__PURE__ */ jsx("p", { className: "text-base text-muted-foreground leading-relaxed max-w-3xl mx-auto animate-fade-up", style: { animationDelay: "0.15s" }, children: "If you've tried running Facebook Ads on your own — or handed them off to an agency that sent you vanity metrics instead of phone calls — you already know the problem. Targeting without strategy, creative without direction, and campaigns running on autopilot with no one watching the results." }),
        /* @__PURE__ */ jsx("p", { className: "text-base text-muted-foreground leading-relaxed max-w-3xl mx-auto animate-fade-up", style: { animationDelay: "0.2s" }, children: "At GrowSmallBiz, we manage Facebook and Instagram Ads the way they were meant to be used: as a precision lead-generation engine for local service businesses. From audience research and ad creative to pixel tracking, retargeting, and monthly reporting, we handle every layer so you can focus on serving the customers we send you." }),
    ...
    /* @__PURE__ */ jsx("section", { className: "py-24", children: /* @__PURE__ */ jsx("div", { className: "container mx-auto px-4", children: /* @__PURE__ */ jsxs("div", { className: "max-w-5xl mx-auto", children: [
      ...
      /* @__PURE__ */ jsx("div", { className: "grid lg:grid-cols-3 gap-8 mt-12", children: ["Med Spa", "Dental Practice", "Home Services"].map((name, i) => /* @__PURE__ */ jsxs("div", { className: "bg-card border border-border rounded-2xl p-8 text-center animate-fade-up", style: { animationDelay: `${i * 0.1}s` }, children: [
    ...
    /* @__PURE__ */ jsx("section", { className: "py-24", children: /* @__PURE__ */ jsx("div", { className: "container mx-auto px-4", children: /* @__PURE__ */ jsxs("div", { className: "max-w-3xl mx-auto text-center space-y-6", children: [
      ...
      /* @__PURE__ */ jsx("p", { className: "text-muted-foreground leading-relaxed", children: "The question is whether your business is showing up — and whether the campaigns driving that visibility are built to convert. GrowSmallBiz manages Facebook and Instagram Ads exclusively for local service businesses. We know your customer, we know your market, and we know how to build campaigns that turn ad spend into revenue." }),
      /* @__PURE__ */ jsx("p", { className: "text-sm text-muted-foreground", children: "Schedule your free strategy session today. There's no obligation, no contract pitch, and no fluff — just a direct conversation about what your Facebook Ads should be doing for your business and how we'll get you there." }),
