...
import { Target, ArrowRight, Phone, LayoutTemplate, Zap, BarChart3, Clock, MessageSquare, Megaphone, MousePointerClick, Home, Heart, Scale, Car, CheckCircle2, XCircle, AlertTriangle, Eye, RefreshCw, TrendingUp, MapPin, Link2, PenTool } from "lucide-react";
...
const PaidMedia = () => {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "min-h-screen bg-background", children: [
    ...
    /* @__PURE__ */ jsxs("section", { className: "py-4 overflow-hidden bg-white", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "relative w-full", children: [
        ...
        /* @__PURE__ */ jsx("div", { className: "py-4", children: /* @__PURE__ */ jsx("div", { className: "flex animate-marquee gap-16 items-center", children: [0, 1].map((dupeIdx) => /* @__PURE__ */ jsxs(React__default.Fragment, { children: [
          /* @__PURE__ */ jsxs("div", { className: "flex-shrink-0 flex items-center gap-2", children: [
            /* @__PURE__ */ jsx("svg", { className: "w-8 h-8", viewBox: "0 0 24 24", fill: "#4285F4", xmlns: "http://www.w3.org/2000/svg", children: /* @__PURE__ */ jsx("path", { d: "M3.9998 22.9291C1.7908 22.9291 0 21.1383 0 18.9293s1.7908-3.9998 3.9998-3.9998 3.9998 1.7908 3.9998 3.9998-1.7908 3.9998-3.9998 3.9998zm19.4643-6.0004L15.4632 3.072C14.3586 1.1587 11.9121.5028 9.9988 1.6074S7.4295 5.1585 8.5341 7.0718l8.0009 13.8567c1.1046 1.9133 3.5511 2.5679 5.4644 1.4646 1.9134-1.1046 2.568-3.5511 1.4647-5.4644zM7.5137 4.8438L1.5645 15.1484A4.5 4.5 0 0 1 4 14.4297c2.5597-.0075 4.6248 2.1585 4.4941 4.7148l3.2168-5.5723-3.6094-6.25c-.4499-.7793-.6322-1.6394-.5878-2.4784z" }) }),
            /* @__PURE__ */ jsx("span", { className: "text-sm font-semibold text-gray-700 whitespace-nowrap", children: "Google Ads" })
          ] }),
          /* @__PURE__ */ jsxs("div", { className: "flex-shrink-0 flex items-center gap-2", children: [
            /* @__PURE__ */ jsxs("svg", { className: "w-8 h-8", viewBox: "0 0 24 24", fill: "none", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "flex-shrink-0 flex items-center gap-2", children: [
            /* @__PURE__ */ jsx("svg", { className: "w-8 h-8", viewBox: "0 0 24 24", fill: "#1877F2", children: /* @__PURE__ */ jsx("path", { d: "M24 12.073C24 5.405 18.627 0 12 0S0 5.405 0 12.073C0 18.1 4.388 23.094 10.125 24v-8.437H7.078v-3.49h3.047V9.41c0-3.017 1.793-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.49h-2.796V24C19.612 23.094 24 18.1 24 12.073z" }) }),
            /* @__PURE__ */ jsx("span", { className: "text-sm font-semibold text-gray-700 whitespace-nowrap", children: "Facebook Ads" })
          ] }),
          /* @__PURE__ */ jsxs("div", { className: "flex-shrink-0 flex items-center gap-2", children: [
            /* @__PURE__ */ jsxs("svg", { className: "w-8 h-8", viewBox: "0 0 24 24", children: [
              /* @__PURE__ */ jsx("defs", { children: /* @__PURE__ */ jsxs("radialGradient", { id: `ig-grad-${dupeIdx}`, cx: "30%", cy: "107%", r: "150%", children: [
              ...
              /* @__PURE__ */ jsx("rect", { width: "24", height: "24", rx: "6", fill: `url(#ig-grad-${dupeIdx})` }),
          ...
          /* @__PURE__ */ jsxs("div", { className: "flex-shrink-0 flex items-center gap-2", children: [
            /* @__PURE__ */ jsxs("svg", { className: "w-8 h-8", viewBox: "0 0 24 24", fill: "none", children: [
              /* @__PURE__ */ jsx("path", { d: "M4 0v17.5l4.5 2.5 7.5-4.5v-4L8.5 8V0H4z", fill: "#00897B" }),
              /* @__PURE__ */ jsx("path", { d: "M8.5 8l7.5 3.5v4l-7.5 4.5L4 17.5", fill: "#00ACC1" }),
              /* @__PURE__ */ jsx("path", { d: "M4 0l4.5 3v5L4 5.5V0z", fill: "#004D40" })
            ] }),
            /* @__PURE__ */ jsx("span", { className: "text-sm font-semibold text-gray-700 whitespace-nowrap", children: "Bing Ads" })
          ] })
        ] }, dupeIdx)) }) })
      ] })
    ] }),
    ...
    /* @__PURE__ */ jsx("section", { className: "py-24", children: /* @__PURE__ */ jsx("div", { className: "container mx-auto px-4", children: /* @__PURE__ */ jsxs("div", { className: "max-w-5xl mx-auto", children: [
      ...
      ].map((card, i) => /* @__PURE__ */ jsxs("div", { className: "bg-card border border-border rounded-xl p-6 space-y-3 animate-fade-up", style: { animationDelay: `${i * 0.05}s` }, children: [
      ...
      ].map((card, i) => /* @__PURE__ */ jsxs("div", { className: "bg-primary/5 border border-primary/20 rounded-xl p-5 animate-fade-up", style: { animationDelay: `${i * 0.05}s` }, children: [
        /* @__PURE__ */ jsx("div", { className: "w-8 h-8 rounded-lg bg-primary/10 flex items-center justify-center mb-3", children: /* @__PURE__ */ jsx(card.icon, { className: "w-4 h-4 text-primary" }) }),
        /* @__PURE__ */ jsx("h5", { className: "text-sm font-display font-semibold text-foreground mb-1", children: card.title }),
        /* @__PURE__ */ jsx("p", { className: "text-xs text-muted-foreground leading-relaxed", children: card.body })
      ] }, i)) })
    ] }) }) }),
    /* @__PURE__ */ jsx("section", { className: "py-24 bg-card", children: /* @__PURE__ */ jsx("div", { className: "container mx-auto px-4", children: /* @__PURE__ */ jsxs("div", { className: "max-w-3xl mx-auto", children: [
      ...
      /* @__PURE__ */ jsx("div", { className: "space-y-4 mb-8 animate-fade-up", style: { animationDelay: "0.1s" }, children: [
      ...
      ].map((item, i) => /* @__PURE__ */ jsxs("div", { className: "flex items-start gap-3 bg-card border border-border rounded-xl p-4", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "flex items-start gap-3 bg-muted/50 border border-border rounded-xl p-4 animate-fade-up", style: { animationDelay: "0.15s" }, children: [
        /* @__PURE__ */ jsx(XCircle, { className: "w-5 h-5 text-muted-foreground mt-0.5 shrink-0" }),
        /* @__PURE__ */ jsxs("p", { className: "text-sm text-muted-foreground", children: [
          /* @__PURE__ */ jsx("span", { className: "font-medium text-foreground", children: "Not ideal fit:" }),
          " This is not the right fit for businesses looking for the cheapest possible ad management without landing page, tracking, or follow-up infrastructure."
        ] })
      ] })
    ] }) }) }),
    /* @__PURE__ */ jsx("section", { className: "py-24 bg-card", children: /* @__PURE__ */ jsx("div", { className: "container mx-auto px-4", children: /* @__PURE__ */ jsxs("div", { className: "max-w-5xl mx-auto", children: [
    ...
    /* @__PURE__ */ jsx("section", { className: "py-24", children: /* @__PURE__ */ jsx("div", { className: "container mx-auto px-4", children: /* @__PURE__ */ jsxs("div", { className: "max-w-5xl mx-auto", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "grid lg:grid-cols-3 gap-8 mt-12", children: [
        /* @__PURE__ */ jsxs("div", { className: "bg-card border border-border rounded-2xl overflow-hidden flex flex-col animate-fade-up", children: [
          /* @__PURE__ */ jsx("div", { className: "p-1.5", children: /* @__PURE__ */ jsxs("div", { className: "bg-primary/10 rounded-xl px-5 py-4", children: [
            /* @__PURE__ */ jsx("p", { className: "text-xs font-bold text-primary uppercase tracking-wider mb-1", children: "HVAC" }),
            /* @__PURE__ */ jsx("h3", { className: "text-lg font-display font-semibold text-foreground", children: "Stronger Visibility, Lower CPA" })
          ] }) }),
          /* @__PURE__ */ jsxs("div", { className: "p-6 flex-1 space-y-4", children: [
            /* @__PURE__ */ jsxs("div", { children: [
              ...
              /* @__PURE__ */ jsx("p", { className: "text-sm text-foreground", children: "Needed stronger visibility, more qualified leads, and lower acquisition costs in a competitive local market." })
            ] }),
            /* @__PURE__ */ jsxs("div", { children: [
              /* @__PURE__ */ jsx("p", { className: "text-xs font-semibold text-muted-foreground uppercase tracking-wider mb-2", children: "Strategy" }),
              /* @__PURE__ */ jsx("p", { className: "text-sm text-foreground", children: "Refined keyword targeting, stronger ad copy, geographic focus, ad extensions, and ongoing optimization." })
            ] }),
            /* @__PURE__ */ jsx("div", { className: "grid grid-cols-2 gap-3 pt-2", children: [
              { value: "+83%", label: "Conversions" },
              { value: "-41%", label: "CPA" },
              { value: "+50.23%", label: "CTR" },
              { value: "+56.3%", label: "Conversion Rate" }
            ].map((m, i) => /* @__PURE__ */ jsxs("div", { className: "bg-background rounded-lg p-3 text-center", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "bg-card border border-border rounded-2xl overflow-hidden flex flex-col animate-fade-up", style: { animationDelay: "0.1s" }, children: [
          /* @__PURE__ */ jsx("div", { className: "p-1.5", children: /* @__PURE__ */ jsxs("div", { className: "bg-primary/10 rounded-xl px-5 py-4", children: [
            /* @__PURE__ */ jsx("p", { className: "text-xs font-bold text-primary uppercase tracking-wider mb-1", children: "Roofing" }),
            /* @__PURE__ */ jsx("h3", { className: "text-lg font-display font-semibold text-foreground", children: "Better Estimates, Better Efficiency" })
          ] }) }),
          /* @__PURE__ */ jsxs("div", { className: "p-6 flex-1 space-y-4", children: [
            /* @__PURE__ */ jsxs("div", { children: [
              /* @__PURE__ */ jsx("p", { className: "text-xs font-semibold text-muted-foreground uppercase tracking-wider mb-2", children: "Challenge" }),
              /* @__PURE__ */ jsx("p", { className: "text-sm text-foreground", children: "Needed stronger estimate flow and better efficiency from existing ad spend." })
            ] }),
            /* @__PURE__ */ jsxs("div", { children: [
              /* @__PURE__ */ jsx("p", { className: "text-xs font-semibold text-muted-foreground uppercase tracking-wider mb-2", children: "Strategy" }),
              /* @__PURE__ */ jsx("p", { className: "text-sm text-foreground", children: "Improved campaign structure, tighter optimization, and continuous performance refinement." })
            ] }),
            /* @__PURE__ */ jsx("div", { className: "grid grid-cols-2 gap-3 pt-2", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "bg-card border border-border rounded-2xl overflow-hidden flex flex-col animate-fade-up", style: { animationDelay: "0.2s" }, children: [
          /* @__PURE__ */ jsx("div", { className: "p-1.5", children: /* @__PURE__ */ jsxs("div", { className: "bg-primary/10 rounded-xl px-5 py-4", children: [
            /* @__PURE__ */ jsx("p", { className: "text-xs font-bold text-primary uppercase tracking-wider mb-1", children: "Med Spa" }),
            /* @__PURE__ */ jsx("h3", { className: "text-lg font-display font-semibold text-foreground", children: "Long-Term Growth, Efficient CPA" })
          ] }) }),
          /* @__PURE__ */ jsxs("div", { className: "p-6 flex-1 space-y-4", children: [
            /* @__PURE__ */ jsxs("div", { children: [
              /* @__PURE__ */ jsx("p", { className: "text-xs font-semibold text-muted-foreground uppercase tracking-wider mb-2", children: "Challenge" }),
              /* @__PURE__ */ jsx("p", { className: "text-sm text-foreground", children: "The goal was long-term lead growth at a stable and efficient cost per acquisition." })
            ] }),
            /* @__PURE__ */ jsxs("div", { children: [
              /* @__PURE__ */ jsx("p", { className: "text-xs font-semibold text-muted-foreground uppercase tracking-wider mb-2", children: "Strategy" }),
              /* @__PURE__ */ jsx("p", { className: "text-sm text-foreground", children: "Multi-campaign Google Ads structure across Search and Display with ongoing optimization." })
            ] }),
            /* @__PURE__ */ jsx("div", { className: "grid grid-cols-2 gap-3 pt-2", children: [
    ...
    /* @__PURE__ */ jsx("section", { className: "py-24 bg-card", children: /* @__PURE__ */ jsx("div", { className: "container mx-auto px-4", children: /* @__PURE__ */ jsx("div", { className: "max-w-4xl mx-auto", children: /* @__PURE__ */ jsxs("div", { className: "grid md:grid-cols-2 gap-12 items-center", children: [
      /* @__PURE__ */ jsxs("div", { className: "animate-fade-up", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "space-y-4 text-muted-foreground leading-relaxed", children: [
          /* @__PURE__ */ jsx("p", { children: "Paid ads create immediate visibility, but many buyers do not act on the first visit. SEO helps your business show up organically as prospects continue researching. Retargeting keeps you visible after they leave." }),
          /* @__PURE__ */ jsx("p", { children: "Repeated exposure builds familiarity. Familiarity builds trust. Trust improves conversion. That is why the strongest campaigns are not built on traffic alone — they are built on multiple touchpoints working together." })
        ] })
      ] }),
      /* @__PURE__ */ jsx("div", { className: "space-y-4 animate-fade-up", style: { animationDelay: "0.1s" }, children: [
      ...
      ].map((item, i) => /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-4 bg-background border border-border rounded-xl p-4", children: [
