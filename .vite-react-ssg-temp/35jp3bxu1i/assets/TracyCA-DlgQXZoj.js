...
import { L as LocationJsonLd, C as ChamberTrustBar, a as CampaignResultsCards, t as tracyCards } from "./ChamberTrustBar-D96yL4i2.js";
import "react";
...
const tracyHero = "/assets/tracy-hero-2sLxzCgL.webp";
const TracyCA = () => {
  ...
  return /* @__PURE__ */ jsxDEV("div", { className: "min-h-screen bg-background", children: [
    /* @__PURE__ */ jsxDEV(Head, { children: [
      /* @__PURE__ */ jsxDEV("title", { children: "Digital Marketing Services in Tracy, CA | GrowSmallBiz" }, void 0, false, {
        fileName: "/dev-server/src/pages/locations/TracyCA.tsx",
        lineNumber: 25,
        columnNumber: 9
      }, void 0),
      /* @__PURE__ */ jsxDEV("meta", { name: "description", content: "Digital Marketing in Tracy, CA: Grow your business with AI Local SEO, AI optimized Google Ads, and 24x7 AI marketing automation." }, void 0, false, {
        fileName: "/dev-server/src/pages/locations/TracyCA.tsx",
        lineNumber: 26,
        columnNumber: 9
      }, void 0),
      /* @__PURE__ */ jsxDEV("meta", { name: "keywords", content: "digital marketing Tracy, local SEO Tracy, Google Ads management, reputation management Tracy, AI marketing automation, lead generation services, small business marketing, integrated marketing solutions" }, void 0, false, {
        fileName: "/dev-server/src/pages/locations/TracyCA.tsx",
        lineNumber: 27,
        columnNumber: 9
      }, void 0),
      /* @__PURE__ */ jsxDEV("link", { rel: "canonical", href: "https://growsmallbiz.io/locations/tracy-ca/" }, void 0, false, {
        fileName: "/dev-server/src/pages/locations/TracyCA.tsx",
        lineNumber: 28,
        columnNumber: 9
      }, void 0),
      /* @__PURE__ */ jsxDEV("meta", { property: "og:title", content: "AI-Powered Growth Solutions for Local Service Businesses" }, void 0, false, {
        fileName: "/dev-server/src/pages/locations/TracyCA.tsx",
        lineNumber: 29,
        columnNumber: 9
      }, void 0)
    ...
    /* @__PURE__ */ jsxDEV("main", { id: "main-content", children: [
      /* @__PURE__ */ jsxDEV("section", { className: "hero-section", children: [
        /* @__PURE__ */ jsxDEV("img", { src: tracyHero, alt: "Aerial view of Tracy, CA, showcasing highway interchange and surrounding residential and commercial areas, highlighting local infrastructure relevant for digital marketing strategies.", width: 1920, height: 768, className: "absolute inset-0 w-full h-full object-cover" }, void 0, false, {
          fileName: "/dev-server/src/pages/locations/TracyCA.tsx",
          lineNumber: 50,
          columnNumber: 9
        }, void 0),
        ...
        /* @__PURE__ */ jsxDEV("div", { className: "container mx-auto px-4 relative z-10", children: /* @__PURE__ */ jsxDEV("div", { className: "max-w-4xl mx-auto text-center", children: [
          /* @__PURE__ */ jsxDEV("div", { className: "service-badge mb-4 animate-fade-up", children: [
            ...
            /* @__PURE__ */ jsxDEV("span", { children: "Tracy, CA — Local Service Business Marketing | San Joaquin Valley Gateway City" }, void 0, false, {
              fileName: "/dev-server/src/pages/locations/TracyCA.tsx",
              lineNumber: 56,
              columnNumber: 15
            }, void 0)
          ...
          /* @__PURE__ */ jsxDEV("h1", { className: "text-4xl md:text-5xl lg:text-6xl font-display font-bold text-foreground mb-3 animate-fade-up leading-tight bg-gradient-heading bg-clip-text text-transparent", children: "Tracy Digital Marketing for Small Service Businesses" }, void 0, false, {
            fileName: "/dev-server/src/pages/locations/TracyCA.tsx",
            lineNumber: 59,
            columnNumber: 13
          }, void 0),
          /* @__PURE__ */ jsxDEV("p", { className: "max-w-3xl mx-auto text-base md:text-lg text-muted-foreground leading-relaxed animate-fade-up mt-6", style: { animationDelay: "0.1s" }, children: "Tracy is not a Bay Area suburb. It is San Joaquin County's fastest-growing gateway city — the first major Central Valley community on the I-205/I-580 corridor heading east from the Bay Area. It carries a large professional commuter population that works in the Bay Area and comes home to Tracy each evening, a steady wave of Bay Area families relocating for affordable homeownership, and a growing residential base that creates consistent demand for every local service category. The businesses that establish digital authority here now become the default choice for the households still arriving." }, void 0, false, {
            fileName: "/dev-server/src/pages/locations/TracyCA.tsx",
            lineNumber: 63,
            columnNumber: 13
          }, void 0),
          /* @__PURE__ */ jsxDEV("p", { className: "max-w-3xl mx-auto text-base md:text-lg text-muted-foreground leading-relaxed animate-fade-up mt-4", style: { animationDelay: "0.15s" }, children: "GrowSmallBiz is a digital marketing agency based in Danville — approximately 40 miles from Tracy via I-205/I-580. We build integrated marketing systems for local service businesses across Tracy and San Joaquin County. Contractors, dentists, restaurants, real estate professionals — if you serve Tracy clients, we are built for you." }, void 0, false, {
            fileName: "/dev-server/src/pages/locations/TracyCA.tsx",
            lineNumber: 67,
            columnNumber: 13
          }, void 0),
          ...
          /* @__PURE__ */ jsxDEV("p", { className: "text-primary text-sm font-medium mt-3 animate-fade-up", style: { animationDelay: "0.25s" }, children: "No commitment. No pressure. Just a clear path forward for your business." }, void 0, false, {
            fileName: "/dev-server/src/pages/locations/TracyCA.tsx",
            lineNumber: 86,
            columnNumber: 13
          }, void 0)
      ...
      /* @__PURE__ */ jsxDEV("section", { className: "py-16 md:py-24 bg-background", children: /* @__PURE__ */ jsxDEV("div", { className: "container mx-auto px-4 max-w-5xl", children: [
        /* @__PURE__ */ jsxDEV("div", { className: "text-center mb-12", children: [
          ...
          /* @__PURE__ */ jsxDEV("h2", { className: "text-3xl md:text-4xl font-display font-bold text-foreground bg-gradient-heading bg-clip-text text-transparent", children: "What Sets GrowSmallBiz Apart and Boosts Your Tracy Bottom Line" }, void 0, false, {
            fileName: "/dev-server/src/pages/locations/TracyCA.tsx",
            lineNumber: 100,
            columnNumber: 13
          }, void 0),
          /* @__PURE__ */ jsxDEV("p", { className: "text-lg text-muted-foreground mt-4 max-w-3xl mx-auto", children: "Tracy's SERP landscape is occupied by thin local pages and out-of-state template agencies ranking on domain authority alone. No agency currently offers Tracy service businesses an integrated marketing system — local SEO, paid ads, AI automation, and retention — under one coordinated strategy." }, void 0, false, {
            fileName: "/dev-server/src/pages/locations/TracyCA.tsx",
            lineNumber: 103,
            columnNumber: 13
          }, void 0),
          /* @__PURE__ */ jsxDEV("p", { className: "text-base text-muted-foreground mt-3 max-w-3xl mx-auto", children: "Subrata Guha, GrowSmallBiz founder, brings 30+ years of Fortune 500 sales, marketing, and growth strategy experience to the specific challenges of Tracy's commuter city market." }, void 0, false, {
            fileName: "/dev-server/src/pages/locations/TracyCA.tsx",
            lineNumber: 104,
            columnNumber: 13
          }, void 0)
      ...
      /* @__PURE__ */ jsxDEV("section", { className: "py-16 md:py-24", style: { background: "linear-gradient(180deg, hsl(210 50% 8%) 0%, hsl(210 45% 14%) 50%, hsl(210 50% 8%) 100%)" }, children: /* @__PURE__ */ jsxDEV("div", { className: "container mx-auto px-4 max-w-5xl", children: [
        /* @__PURE__ */ jsxDEV("div", { className: "text-center mb-12", children: [
          ...
          /* @__PURE__ */ jsxDEV("h2", { className: "text-3xl md:text-4xl font-display font-bold text-foreground bg-gradient-heading bg-clip-text text-transparent", children: "Your Competitors Are Winning in Tracy Search Results. Here's Exactly Why — and How to Take It Back." }, void 0, false, {
            fileName: "/dev-server/src/pages/locations/TracyCA.tsx",
            lineNumber: 132,
            columnNumber: 13
          }, void 0)
      ...
      /* @__PURE__ */ jsxDEV("section", { className: "py-16 md:py-24 bg-background", children: /* @__PURE__ */ jsxDEV("div", { className: "container mx-auto px-4 max-w-4xl", children: [
        /* @__PURE__ */ jsxDEV("div", { className: "text-center mb-12", children: [
          ...
          /* @__PURE__ */ jsxDEV("h2", { className: "text-3xl md:text-4xl font-display font-bold text-foreground bg-gradient-heading bg-clip-text text-transparent", children: "The Local Search Gap Costing Most Tracy Service Businesses 10–15 Leads Every Month" }, void 0, false, {
            fileName: "/dev-server/src/pages/locations/TracyCA.tsx",
            lineNumber: 160,
            columnNumber: 13
          }, void 0)
        ...
        /* @__PURE__ */ jsxDEV("div", { className: "prose prose-lg prose-invert max-w-none space-y-6", children: /* @__PURE__ */ jsxDEV("p", { className: "text-foreground/90 leading-relaxed", children: [
          "According to ",
          ...
          ", 76% of consumers who perform a local search on their smartphone visit or contact a business within 24 hours. In Tracy, where many of those searches arrive during evening and weekend commuter windows, map pack visibility at exactly the right hour determines whether that consumer becomes your client or your competitor's. ",
          /* @__PURE__ */ jsxDEV("a", { href: "https://www.brightlocal.com/research/local-consumer-review-survey-2024/", target: "_blank", rel: "noopener noreferrer", className: "text-primary hover:underline", children: "BrightLocal research" }, void 0, false, {
            fileName: "/dev-server/src/pages/locations/TracyCA.tsx",
            lineNumber: 165,
            columnNumber: 615
          }, void 0),
          " shows 81% of consumers use Google to evaluate local businesses — and ",
          /* @__PURE__ */ jsxDEV("a", { href: "https://www.brightlocal.com/resources/local-seo-statistics/", target: "_blank", rel: "noopener noreferrer", className: "text-primary hover:underline", children: "56% of businesses have still not fully optimized their Google Business Profile" }, void 0, false, {
            fileName: "/dev-server/src/pages/locations/TracyCA.tsx",
            lineNumber: 165,
            columnNumber: 874
          }, void 0),
          ". In a market growing as fast as Tracy, that optimization gap means real monthly revenue going to whoever shows up first."
        ] }, void 0, true, {
          fileName: "/dev-server/src/pages/locations/TracyCA.tsx",
          lineNumber: 165,
          columnNumber: 13
      ...
      /* @__PURE__ */ jsxDEV("section", { className: "py-16 md:py-24", style: { background: "linear-gradient(180deg, hsl(210 50% 8%) 0%, hsl(210 45% 14%) 50%, hsl(210 50% 8%) 100%)" }, children: /* @__PURE__ */ jsxDEV("div", { className: "container mx-auto px-4 max-w-5xl", children: [
        /* @__PURE__ */ jsxDEV("div", { className: "text-center mb-12", children: [
          ...
          /* @__PURE__ */ jsxDEV("h2", { className: "text-3xl md:text-4xl font-display font-bold text-foreground bg-gradient-heading bg-clip-text text-transparent", children: "The Integrated Marketing System Built for Tracy Service Businesses — Fills Your Calendar, Not Just Your Dashboard" }, void 0, false, {
            fileName: "/dev-server/src/pages/locations/TracyCA.tsx",
            lineNumber: 181,
            columnNumber: 13
          }, void 0),
          /* @__PURE__ */ jsxDEV("p", { className: "text-lg text-muted-foreground mt-4 max-w-3xl mx-auto", children: "Tracy's market rewards businesses that are visible at the right moment, responsive at the right speed, and trusted before first contact. An integrated system delivers all three — not as separate channel investments, but as a coordinated engine that compounds over time as Tracy's population continues to grow." }, void 0, false, {
            fileName: "/dev-server/src/pages/locations/TracyCA.tsx",
            lineNumber: 184,
            columnNumber: 13
          }, void 0)
        ...
        /* @__PURE__ */ jsxDEV("div", { className: "hidden md:block overflow-x-auto mb-16", children: /* @__PURE__ */ jsxDEV("table", { className: "w-full text-sm border-collapse", children: [
          /* @__PURE__ */ jsxDEV("thead", { children: /* @__PURE__ */ jsxDEV("tr", { children: [
            ...
            /* @__PURE__ */ jsxDEV("th", { className: "p-3 text-left font-bold text-foreground bg-card/80 border border-border/60", children: "Tracy Business Impact" }, void 0, false, {
              fileName: "/dev-server/src/pages/locations/TracyCA.tsx",
              lineNumber: 194,
              columnNumber: 19
            }, void 0)
        ...
        /* @__PURE__ */ jsxDEV("div", { className: "mt-16 pt-10 border-t border-border/30", children: [
          ...
          /* @__PURE__ */ jsxDEV("p", { className: "text-foreground/90 leading-relaxed mb-6", children: "Local SEO in Tracy requires keyword architecture that reflects two distinct search audiences: the long-time Tracy resident searching from home, and the Bay Area commuter searching on a smartphone during a transit window. Both audiences are valuable. Both need to find you at the top of Google Maps. And neither is well-served by the thin, generic pages currently occupying Tracy's local search results." }, void 0, false, {
            fileName: "/dev-server/src/pages/locations/TracyCA.tsx",
            lineNumber: 244,
            columnNumber: 13
          }, void 0),
        ...
        /* @__PURE__ */ jsxDEV("div", { className: "mt-16 pt-10 border-t border-border/30", children: [
          /* @__PURE__ */ jsxDEV("h3", { className: "text-2xl md:text-3xl font-display font-bold text-foreground mb-4", children: [
            ...
            " ",
            /* @__PURE__ */ jsxDEV("span", { className: "text-transparent bg-clip-text bg-gradient-primary", children: "Google Ads That Deliver Tracy Customers on Day One." }, void 0, false, {
              fileName: "/dev-server/src/pages/locations/TracyCA.tsx",
              lineNumber: 268,
              columnNumber: 15
            }, void 0)
          ...
          /* @__PURE__ */ jsxDEV("a", { href: strategyCallUrl, target: "_blank", rel: "noopener noreferrer", className: "inline-flex items-center gap-2 bg-primary/10 border border-primary/30 rounded-lg px-5 py-3 text-primary font-semibold hover:bg-primary/20 transition-colors", children: "→ Launch Google Ads for Your Tracy Business — Start Generating Leads This Week" }, void 0, false, {
            fileName: "/dev-server/src/pages/locations/TracyCA.tsx",
            lineNumber: 285,
            columnNumber: 13
          }, void 0)
        ...
        /* @__PURE__ */ jsxDEV("div", { className: "mt-16 pt-10 border-t border-border/30", children: [
          /* @__PURE__ */ jsxDEV("h3", { className: "text-2xl md:text-3xl font-display font-bold text-foreground mb-4", children: [
            ...
            " ",
            /* @__PURE__ */ jsxDEV("span", { className: "text-transparent bg-clip-text bg-gradient-primary", children: "More Tracy Leads, Pre-Qualified Before They Call" }, void 0, false, {
              fileName: "/dev-server/src/pages/locations/TracyCA.tsx",
              lineNumber: 294,
              columnNumber: 15
            }, void 0)
          ...
          /* @__PURE__ */ jsxDEV("a", { href: strategyCallUrl, target: "_blank", rel: "noopener noreferrer", className: "inline-flex items-center gap-2 bg-primary/10 border border-primary/30 rounded-lg px-5 py-3 text-primary font-semibold hover:bg-primary/20 transition-colors", children: "→ Set Up Google LSA for Your Tracy Business — Get Verified Leads" }, void 0, false, {
            fileName: "/dev-server/src/pages/locations/TracyCA.tsx",
            lineNumber: 310,
            columnNumber: 13
          }, void 0)
        ...
        /* @__PURE__ */ jsxDEV("div", { className: "mt-16 pt-10 border-t border-border/30", children: [
          ...
          /* @__PURE__ */ jsxDEV("p", { className: "text-foreground/90 leading-relaxed mb-6", children: "Meta advertising in Tracy requires audience intelligence that reflects the city's demographic reality. Bay Area transplant households respond to messaging that acknowledges their transition — finding trusted local providers in a new community is a real concern for recently relocated families. Long-time Tracy residents respond to community connection and local familiarity. Both segments are on Facebook and Instagram. Both require different creative approaches and different delivery timing." }, void 0, false, {
            fileName: "/dev-server/src/pages/locations/TracyCA.tsx",
            lineNumber: 321,
            columnNumber: 13
          }, void 0),
          ...
          /* @__PURE__ */ jsxDEV("a", { href: strategyCallUrl, target: "_blank", rel: "noopener noreferrer", className: "inline-flex items-center gap-2 bg-primary/10 border border-primary/30 rounded-lg px-5 py-3 text-primary font-semibold hover:bg-primary/20 transition-colors", children: "→ Launch Social Media Advertising for Your Tracy Business — Get Started" }, void 0, false, {
            fileName: "/dev-server/src/pages/locations/TracyCA.tsx",
            lineNumber: 335,
            columnNumber: 13
          }, void 0)
        ...
        /* @__PURE__ */ jsxDEV("div", { className: "mt-16 pt-10 border-t border-border/30", children: [
          /* @__PURE__ */ jsxDEV("h3", { className: "text-2xl md:text-3xl font-display font-bold text-foreground mb-4", children: [
            ...
            " ",
            /* @__PURE__ */ jsxDEV("span", { className: "text-transparent bg-clip-text bg-gradient-primary", children: "If It's Not Generating Tracy Leads Daily, It's Costing You Money." }, void 0, false, {
              fileName: "/dev-server/src/pages/locations/TracyCA.tsx",
              lineNumber: 370,
              columnNumber: 15
            }, void 0)
          ...
          /* @__PURE__ */ jsxDEV("a", { href: strategyCallUrl, target: "_blank", rel: "noopener noreferrer", className: "inline-flex items-center gap-2 bg-primary/10 border border-primary/30 rounded-lg px-5 py-3 text-primary font-semibold hover:bg-primary/20 transition-colors", children: "→ Get a Conversion-Focused Website Built for Tracy — See Our Work" }, void 0, false, {
            fileName: "/dev-server/src/pages/locations/TracyCA.tsx",
            lineNumber: 387,
            columnNumber: 13
          }, void 0)
        ...
        /* @__PURE__ */ jsxDEV("div", { className: "mt-16 pt-10 border-t border-border/30", children: [
          /* @__PURE__ */ jsxDEV("h3", { className: "text-2xl md:text-3xl font-display font-bold text-foreground mb-4", children: [
            ...
            " ",
            /* @__PURE__ */ jsxDEV("span", { className: "text-transparent bg-clip-text bg-gradient-primary", children: "Our AI Receptionist Follows Up in Seconds — So You Never Lose Another Lead to a Faster Competitor." }, void 0, false, {
              fileName: "/dev-server/src/pages/locations/TracyCA.tsx",
              lineNumber: 396,
              columnNumber: 15
            }, void 0)
          ...
          /* @__PURE__ */ jsxDEV("p", { className: "text-foreground/90 leading-relaxed mb-6", children: [
            "Research from ",
            /* @__PURE__ */ jsxDEV("a", { href: "https://www.insidesales.com/response-time-matters/", target: "_blank", rel: "noopener noreferrer", className: "text-primary hover:underline", children: "MIT and InsideSales.com" }, void 0, false, {
              fileName: "/dev-server/src/pages/locations/TracyCA.tsx",
              lineNumber: 398,
              columnNumber: 82
            }, void 0),
            " confirms that leads contacted within 5 minutes are 21 times more likely to convert than those reached after 30 minutes. In Tracy, the commuter timing pattern makes this stat particularly consequential. A Bay Area commuter searching for an HVAC contractor at 7:30pm on a Thursday after arriving home from work is making that decision tonight — not tomorrow morning. The contractor who responds in five minutes gets the appointment. The contractor whose phone rings to voicemail loses the job to whoever answers next."
          ] }, void 0, true, {
            fileName: "/dev-server/src/pages/locations/TracyCA.tsx",
            lineNumber: 398,
            columnNumber: 13
      ...
      /* @__PURE__ */ jsxDEV("section", { className: "py-16 md:py-24 bg-background", children: /* @__PURE__ */ jsxDEV("div", { className: "container mx-auto px-4 max-w-5xl", children: [
        /* @__PURE__ */ jsxDEV("div", { className: "text-center mb-12", children: [
          ...
          /* @__PURE__ */ jsxDEV("h2", { className: "text-3xl md:text-4xl font-display font-bold text-foreground bg-gradient-heading bg-clip-text text-transparent", children: "Built for Your Industry, Not Adapted From Someone Else's Playbook — See If We're the Right Fit for Tracy" }, void 0, false, {
            fileName: "/dev-server/src/pages/locations/TracyCA.tsx",
            lineNumber: 425,
            columnNumber: 13
          }, void 0),
          /* @__PURE__ */ jsxDEV("p", { className: "text-lg text-muted-foreground mt-4 max-w-3xl mx-auto", children: "GrowSmallBiz works exclusively with local service businesses in Tracy and the surrounding San Joaquin Valley. We do not work with eCommerce stores, national retailers, or product-based businesses. Our systems are purpose-built for the verticals below — with genuine knowledge of Tracy's commuter timing pattern, affordability migration wave, and Central Valley seasonal demand." }, void 0, false, {
            fileName: "/dev-server/src/pages/locations/TracyCA.tsx",
            lineNumber: 428,
            columnNumber: 13
          }, void 0)
        ...
        /* @__PURE__ */ jsxDEV("div", { className: "grid md:grid-cols-2 gap-6", children: [
          /* @__PURE__ */ jsxDEV("div", { className: "feature-card-teal rounded-2xl p-6", children: [
            ...
            /* @__PURE__ */ jsxDEV("h3", { className: "text-xl font-display font-bold text-foreground mb-3", children: "Home Service Contractors — HVAC, Roofing, Plumbing & Electrical: Fill Your Tracy Calendar Year-Round" }, void 0, false, {
              fileName: "/dev-server/src/pages/locations/TracyCA.tsx",
              lineNumber: 436,
              columnNumber: 15
            }, void 0),
            /* @__PURE__ */ jsxDEV("p", { className: "text-muted-foreground leading-relaxed", children: "Tracy's combination of rapid residential growth, extreme summer heat, and a large commuter household base creates consistent, year-round demand for home service contractors across every trade category. New construction throughout the I-205 corridor generates ongoing work for contractors who establish early relationships with developers and homeowners. Existing residential neighborhoods create steady replacement and maintenance demand. And Tracy's summer temperatures — regularly exceeding 100°F in July and August — create an emergency HVAC demand pattern that is more intense than any Bay Area city in GrowSmallBiz's service territory. We build the systems that make Tracy home service contractors visible when demand spikes, responsive when emergencies arrive, and trusted when new households are choosing their first local providers." }, void 0, false, {
              fileName: "/dev-server/src/pages/locations/TracyCA.tsx",
              lineNumber: 437,
              columnNumber: 15
            }, void 0)
          ...
          /* @__PURE__ */ jsxDEV("div", { className: "feature-card-teal rounded-2xl p-6", children: [
            ...
            /* @__PURE__ */ jsxDEV("h3", { className: "text-xl font-display font-bold text-foreground mb-3", children: "Dentists, Med Spas & Wellness Professionals: Attract Tracy Patients Who Book and Stay" }, void 0, false, {
              fileName: "/dev-server/src/pages/locations/TracyCA.tsx",
              lineNumber: 444,
              columnNumber: 15
            }, void 0),
            /* @__PURE__ */ jsxDEV("p", { className: "text-muted-foreground leading-relaxed", children: "Tracy's growing population brings growing demand for dental care, chiropractic care, wellness services, and specialty health practices — and a population that is actively choosing new healthcare providers for the first time. Bay Area transplants are looking for a new family dentist, a new chiropractor, a new med spa or wellness practice in their new community. Chiropractic care is a high-consideration service: patients research before they commit, making Google Maps visibility and review depth the primary conversion levers. We build the complete digital presence — optimized Google Business Profile, review velocity campaigns, and AI booking follow-up — that positions Tracy practices to be the first and most trusted choice when a new household searches for care in their ZIP code." }, void 0, false, {
              fileName: "/dev-server/src/pages/locations/TracyCA.tsx",
              lineNumber: 445,
              columnNumber: 15
            }, void 0)
          ...
          /* @__PURE__ */ jsxDEV("div", { className: "feature-card-teal rounded-2xl p-6", children: [
            ...
            /* @__PURE__ */ jsxDEV("h3", { className: "text-xl font-display font-bold text-foreground mb-3", children: "Restaurants & Hospitality: Fill More Tables, Build Loyal Regulars, Own Tracy's Dining Scene" }, void 0, false, {
              fileName: "/dev-server/src/pages/locations/TracyCA.tsx",
              lineNumber: 452,
              columnNumber: 15
            }, void 0),
            /* @__PURE__ */ jsxDEV("p", { className: "text-muted-foreground leading-relaxed", children: "Tracy's restaurant market is growing alongside its population, with a dining community that ranges from established local institutions to new concepts opening to serve the expanding residential base. Google Maps visibility and review recency are the primary discovery channels for Tracy's dining audience — particularly for households that are still exploring what the city has to offer. We build the full digital system — Local SEO, Google Maps optimization, social media, and VIP Club retention — that fills tables consistently, not just during peaks and weekends." }, void 0, false, {
              fileName: "/dev-server/src/pages/locations/TracyCA.tsx",
              lineNumber: 453,
              columnNumber: 15
            }, void 0)
      ...
      /* @__PURE__ */ jsxDEV("section", { className: "py-16 md:py-24", style: { background: "linear-gradient(180deg, hsl(210 50% 8%) 0%, hsl(210 45% 14%) 50%, hsl(210 50% 8%) 100%)" }, children: /* @__PURE__ */ jsxDEV("div", { className: "container mx-auto px-4 max-w-5xl", children: [
        ...
        /* @__PURE__ */ jsxDEV(CampaignResultsCards, { cards: tracyCards }, void 0, false, {
          fileName: "/dev-server/src/pages/locations/TracyCA.tsx",
          lineNumber: 480,
          columnNumber: 11
        }, void 0),
        /* @__PURE__ */ jsxDEV("h3", { className: "text-xl md:text-2xl font-display font-bold text-foreground mb-4", children: "Single-Channel Marketing Doesn't Win in Tracy's Growing Market. Here's What Actually Moves the Needle." }, void 0, false, {
          fileName: "/dev-server/src/pages/locations/TracyCA.tsx",
          lineNumber: 482,
          columnNumber: 11
        }, void 0),
        /* @__PURE__ */ jsxDEV("p", { className: "text-foreground/80 leading-relaxed mb-6", children: "The agencies currently ranking for Tracy digital marketing keywords are running thin pages or domain-authority plays with no genuine Tracy market knowledge. Outperforming them requires not just better content — it requires an integrated system aligned with Tracy's specific commuter timing, first-mover opportunity, and seasonal demand patterns." }, void 0, false, {
          fileName: "/dev-server/src/pages/locations/TracyCA.tsx",
          lineNumber: 483,
          columnNumber: 11
        }, void 0)
      ...
      /* @__PURE__ */ jsxDEV("section", { className: "py-16 md:py-24 bg-background", children: /* @__PURE__ */ jsxDEV("div", { className: "container mx-auto px-4 max-w-5xl", children: [
        /* @__PURE__ */ jsxDEV("div", { className: "text-center mb-12", children: [
          ...
          /* @__PURE__ */ jsxDEV("h2", { className: "text-3xl md:text-4xl font-display font-bold text-foreground bg-gradient-heading bg-clip-text text-transparent", children: "No Templates. No Generalists. No Excuses. Why GrowSmallBiz Outperforms Every Agency That's Failed Your Tracy Business Before" }, void 0, false, {
            fileName: "/dev-server/src/pages/locations/TracyCA.tsx",
            lineNumber: 494,
            columnNumber: 13
          }, void 0),
          /* @__PURE__ */ jsxDEV("p", { className: "text-lg text-muted-foreground mt-4 max-w-3xl mx-auto", children: "Tracy's SERPs are occupied by a thin local competitor and out-of-state agencies ranking on domain authority with no Central Valley market knowledge. Here is what makes the system GrowSmallBiz builds consistently outperform them in San Joaquin County's fastest-growing city:" }, void 0, false, {
            fileName: "/dev-server/src/pages/locations/TracyCA.tsx",
            lineNumber: 497,
            columnNumber: 13
          }, void 0)
      ...
      /* @__PURE__ */ jsxDEV(ConsultationFormSection, { utmCampaign: "tracy-consultation", utmMedium: "tracy-ca" }, void 0, false, {
        fileName: "/dev-server/src/pages/locations/TracyCA.tsx",
        lineNumber: 575,
        columnNumber: 7
      }, void 0),
