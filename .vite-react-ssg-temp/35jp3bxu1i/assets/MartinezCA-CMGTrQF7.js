...
import { MapPin, ArrowRight, Phone, Star, TrendingUp, Search, Target, Users, Home, Heart, UtensilsCrossed, Building2, BarChart3 } from "lucide-react";
import { L as LocationJsonLd, C as ChamberTrustBar, a as CampaignResultsCards, m as martinezCards } from "./ChamberTrustBar-D96yL4i2.js";
import "react";
...
const martinezHero = "/assets/martinez-hero-CRVw-lk8.webp";
const MartinezCA = () => {
  ...
  return /* @__PURE__ */ jsxDEV("div", { className: "min-h-screen bg-background", children: [
    /* @__PURE__ */ jsxDEV(Head, { children: [
      /* @__PURE__ */ jsxDEV("title", { children: "Digital Marketing Services in Martinez, CA | GrowSmallBiz" }, void 0, false, {
        fileName: "/dev-server/src/pages/locations/MartinezCA.tsx",
        lineNumber: 25,
        columnNumber: 9
      }, void 0),
      /* @__PURE__ */ jsxDEV("meta", { name: "description", content: "Martinez, CA digital marketing services by GrowSmallBiz: Grow your business with AI SEO, AI optimized paid ads, and AI marketing automation." }, void 0, false, {
        fileName: "/dev-server/src/pages/locations/MartinezCA.tsx",
        lineNumber: 26,
        columnNumber: 9
      }, void 0),
      /* @__PURE__ */ jsxDEV("meta", { name: "keywords", content: "local digital marketing, Martinez CA marketing services, AI-powered SEO, reputation management Martinez, Google Ads for local businesses, local SEO strategies, small business marketing, integrated marketing solutions" }, void 0, false, {
        fileName: "/dev-server/src/pages/locations/MartinezCA.tsx",
        lineNumber: 27,
        columnNumber: 9
      }, void 0),
      /* @__PURE__ */ jsxDEV("link", { rel: "canonical", href: "https://growsmallbiz.io/locations/martinez-ca/" }, void 0, false, {
        fileName: "/dev-server/src/pages/locations/MartinezCA.tsx",
        lineNumber: 28,
        columnNumber: 9
      }, void 0)
    ...
    /* @__PURE__ */ jsxDEV("main", { id: "main-content", children: [
      /* @__PURE__ */ jsxDEV("section", { className: "hero-section", children: [
        /* @__PURE__ */ jsxDEV("img", { src: martinezHero, alt: "Scenic view of Martinez, CA, featuring a marina with boats, waterfront homes, and surrounding mountains under a clear blue sky, illustrating the local landscape for digital marketing services.", width: 1920, height: 768, className: "absolute inset-0 w-full h-full object-cover" }, void 0, false, {
          fileName: "/dev-server/src/pages/locations/MartinezCA.tsx",
          lineNumber: 47,
          columnNumber: 9
        }, void 0),
        ...
        /* @__PURE__ */ jsxDEV("div", { className: "container mx-auto px-4 relative z-10", children: /* @__PURE__ */ jsxDEV("div", { className: "max-w-4xl mx-auto text-center", children: [
          /* @__PURE__ */ jsxDEV("div", { className: "service-badge mb-4 animate-fade-up", children: [
            ...
            /* @__PURE__ */ jsxDEV("span", { children: "Martinez, CA — Local Service Business Marketing | Contra Costa County Seat" }, void 0, false, {
              fileName: "/dev-server/src/pages/locations/MartinezCA.tsx",
              lineNumber: 53,
              columnNumber: 15
            }, void 0)
          ...
          /* @__PURE__ */ jsxDEV("h1", { className: "text-4xl md:text-5xl lg:text-6xl font-display font-bold text-foreground mb-3 animate-fade-up leading-tight bg-gradient-heading bg-clip-text text-transparent", children: "Digital Marketing in Martinez for Local Service Businesses" }, void 0, false, {
            fileName: "/dev-server/src/pages/locations/MartinezCA.tsx",
            lineNumber: 55,
            columnNumber: 13
          }, void 0),
          /* @__PURE__ */ jsxDEV("p", { className: "max-w-3xl mx-auto text-base md:text-lg text-muted-foreground leading-relaxed animate-fade-up mt-6", style: { animationDelay: "0.1s" }, children: "Martinez is not a suburban market. As the seat of Contra Costa County, it has its own distinct identity: a historic downtown with Victorian architecture, a working waterfront along the Carquinez Strait, residential neighborhoods ranging from blue-collar Vine Hill to semi-rural Alhambra Valley, and a legal and financial services cluster centered on the county courthouse. The businesses that serve Martinez's community deserve marketing built for this market — not repurposed from a Bay Area template. GrowSmallBiz is a Contra Costa County digital marketing agency based in Danville — 20 minutes from Martinez. We build integrated marketing systems for local service businesses across Martinez and the broader County. Contractors, dentists, restaurants, real estate professionals — if you serve Martinez clients, we are built for you." }, void 0, false, {
            fileName: "/dev-server/src/pages/locations/MartinezCA.tsx",
            lineNumber: 58,
            columnNumber: 13
          }, void 0),
      ...
      /* @__PURE__ */ jsxDEV("section", { className: "py-16 md:py-24 bg-background", children: /* @__PURE__ */ jsxDEV("div", { className: "container mx-auto px-4 max-w-5xl", children: [
        /* @__PURE__ */ jsxDEV("div", { className: "text-center mb-12", children: [
          ...
          /* @__PURE__ */ jsxDEV("h2", { className: "text-3xl md:text-4xl font-display font-bold text-foreground bg-gradient-heading bg-clip-text text-transparent", children: "Why GrowSmallBiz's Martinez Roots Boost Your Local Marketing ROI" }, void 0, false, {
            fileName: "/dev-server/src/pages/locations/MartinezCA.tsx",
            lineNumber: 83,
            columnNumber: 13
          }, void 0),
          /* @__PURE__ */ jsxDEV("p", { className: "text-lg text-muted-foreground mt-4 max-w-3xl mx-auto", children: "Martinez's SERP landscape is dominated by national agencies with no local roots. The current SERP leaders are national agencies running the same page templates across Sacramento, Fresno, and dozens of other California cities. Subrata Guha, GrowSmallBiz founder, brings 30+ years of Fortune 500 sales, marketing, and growth strategy experience to the specific challenges of Martinez's community-oriented local service market — combined with genuine Contra Costa County proximity that national agencies cannot replicate." }, void 0, false, {
            fileName: "/dev-server/src/pages/locations/MartinezCA.tsx",
            lineNumber: 86,
            columnNumber: 13
          }, void 0)
      ...
      /* @__PURE__ */ jsxDEV("section", { className: "py-16 md:py-24", style: { background: "linear-gradient(180deg, hsl(210 50% 8%) 0%, hsl(210 45% 14%) 50%, hsl(210 50% 8%) 100%)" }, children: /* @__PURE__ */ jsxDEV("div", { className: "container mx-auto px-4 max-w-5xl", children: [
        /* @__PURE__ */ jsxDEV("div", { className: "text-center mb-12", children: [
          ...
          /* @__PURE__ */ jsxDEV("h2", { className: "text-3xl md:text-4xl font-display font-bold text-foreground bg-gradient-heading bg-clip-text text-transparent", children: "Your Competitors Are Winning in Martinez Search Results. Here's Exactly Why — and How to Take It Back." }, void 0, false, {
            fileName: "/dev-server/src/pages/locations/MartinezCA.tsx",
            lineNumber: 109,
            columnNumber: 13
          }, void 0)
      ...
      /* @__PURE__ */ jsxDEV("section", { className: "py-16 md:py-24 bg-background", children: /* @__PURE__ */ jsxDEV("div", { className: "container mx-auto px-4 max-w-4xl", children: [
        /* @__PURE__ */ jsxDEV("div", { className: "text-center mb-12", children: [
          ...
          /* @__PURE__ */ jsxDEV("h2", { className: "text-3xl md:text-4xl font-display font-bold text-foreground bg-gradient-heading bg-clip-text text-transparent", children: "The Local Search Gap Costing Most Martinez Service Businesses 10–15 Leads Every Month" }, void 0, false, {
            fileName: "/dev-server/src/pages/locations/MartinezCA.tsx",
            lineNumber: 134,
            columnNumber: 13
          }, void 0)
        ...
        /* @__PURE__ */ jsxDEV("div", { className: "prose prose-lg prose-invert max-w-none space-y-6", children: [
          /* @__PURE__ */ jsxDEV("p", { className: "text-foreground/90 leading-relaxed", children: [
            ...
            ", 76% of consumers who perform a local search on their smartphone visit or contact a business within 24 hours. In Martinez, where over 68% of those searches occur on mobile devices, map pack visibility is the primary gateway between your business and a new client. Yet ",
            ...
            " shows that 81% of consumers use Google to evaluate local businesses and ",
          ...
          /* @__PURE__ */ jsxDEV("p", { className: "text-foreground/90 leading-relaxed", children: "The SERP landscape reinforces this opportunity. Streamline Results leads 'local seo martinez ca' with a 4,268-word page and a content score of 91 — but it is a national template agency with no genuine Martinez market knowledge. No local Contra Costa agency currently dominates Martinez's digital marketing search results. That position is available." }, void 0, false, {
            fileName: "/dev-server/src/pages/locations/MartinezCA.tsx",
            lineNumber: 140,
            columnNumber: 13
          }, void 0)
        ...
        /* @__PURE__ */ jsxDEV("div", { className: "mt-10 bg-primary/5 border-l-4 border-primary rounded-r-xl px-6 py-5", children: /* @__PURE__ */ jsxDEV("p", { className: "text-lg md:text-xl font-semibold italic text-foreground/90", children: '"Martinez is the Contra Costa County seat — a market with its own distinct identity, community culture, and search behavior. Generic Bay Area agency pages do not win here. Local market knowledge does."' }, void 0, false, {
          fileName: "/dev-server/src/pages/locations/MartinezCA.tsx",
          lineNumber: 143,
          columnNumber: 13
        }, void 0) }, void 0, false, {
      ...
      /* @__PURE__ */ jsxDEV("section", { className: "py-16 md:py-24", style: { background: "linear-gradient(180deg, hsl(210 50% 8%) 0%, hsl(210 45% 14%) 50%, hsl(210 50% 8%) 100%)" }, children: /* @__PURE__ */ jsxDEV("div", { className: "container mx-auto px-4 max-w-5xl", children: [
        /* @__PURE__ */ jsxDEV("div", { className: "text-center mb-12", children: [
          ...
          /* @__PURE__ */ jsxDEV("h2", { className: "text-3xl md:text-4xl font-display font-bold text-foreground bg-gradient-heading bg-clip-text text-transparent", children: "The Integrated Marketing System Built for Martinez Service Businesses — Fills Your Calendar, Not Just Your Dashboard" }, void 0, false, {
            fileName: "/dev-server/src/pages/locations/MartinezCA.tsx",
            lineNumber: 153,
            columnNumber: 13
          }, void 0),
          /* @__PURE__ */ jsxDEV("p", { className: "text-lg text-muted-foreground mt-4 max-w-3xl mx-auto", children: "Martinez's community-oriented market rewards businesses that are genuinely visible, consistently responsive, and authentically trusted. An integrated marketing system delivers all three simultaneously." }, void 0, false, {
            fileName: "/dev-server/src/pages/locations/MartinezCA.tsx",
            lineNumber: 156,
            columnNumber: 13
          }, void 0)
        ...
        /* @__PURE__ */ jsxDEV("div", { className: "hidden md:block overflow-x-auto mb-16", children: /* @__PURE__ */ jsxDEV("table", { className: "w-full text-sm border-collapse", children: [
          /* @__PURE__ */ jsxDEV("thead", { children: /* @__PURE__ */ jsxDEV("tr", { children: [
            ...
            /* @__PURE__ */ jsxDEV("th", { className: "p-3 text-left font-bold text-foreground bg-card/80 border border-border/60", children: "Martinez Business Impact" }, void 0, false, {
              fileName: "/dev-server/src/pages/locations/MartinezCA.tsx",
              lineNumber: 165,
              columnNumber: 17
            }, void 0)
        ...
        /* @__PURE__ */ jsxDEV("div", { className: "mt-16 pt-10 border-t border-border/30", children: [
          ...
          /* @__PURE__ */ jsxDEV("p", { className: "text-foreground/90 leading-relaxed mb-6", children: "Local SEO in Martinez operates differently from the I-680 corridor suburbs. Search radii in smaller Bay Area cities like Martinez tend to prioritize hyperlocal results within a 5-mile radius — meaning precise GBP service area configuration, neighborhood-level keyword targeting, and consistent local citation signals matter more here than in broader metropolitan markets." }, void 0, false, {
            fileName: "/dev-server/src/pages/locations/MartinezCA.tsx",
            lineNumber: 212,
            columnNumber: 13
          }, void 0),
        ...
        /* @__PURE__ */ jsxDEV("div", { className: "mt-16 pt-10 border-t border-border/30", children: [
          /* @__PURE__ */ jsxDEV("h3", { className: "text-2xl md:text-3xl font-display font-bold text-foreground mb-4", children: [
            ...
            " ",
            /* @__PURE__ */ jsxDEV("span", { className: "text-transparent bg-clip-text bg-gradient-primary", children: "Google Ads That Deliver Martinez Customers on Day One." }, void 0, false, {
              fileName: "/dev-server/src/pages/locations/MartinezCA.tsx",
              lineNumber: 232,
              columnNumber: 15
            }, void 0)
          ...
          /* @__PURE__ */ jsxDEV("a", { href: strategyCallUrl, target: "_blank", rel: "noopener noreferrer", className: "inline-flex items-center gap-2 bg-primary/10 border border-primary/30 rounded-lg px-5 py-3 text-primary font-semibold hover:bg-primary/20 transition-colors", children: "→ Launch Google Ads for Your Martinez Business — Start Generating Leads This Week" }, void 0, false, {
            fileName: "/dev-server/src/pages/locations/MartinezCA.tsx",
            lineNumber: 246,
            columnNumber: 13
          }, void 0)
        ...
        /* @__PURE__ */ jsxDEV("div", { className: "mt-16 pt-10 border-t border-border/30", children: [
          ...
          /* @__PURE__ */ jsxDEV("p", { className: "text-foreground/80 italic mb-6", children: [
            ...
            " found that 88% of consumers would use a business that responds to all of its reviews, compared to just 47% for businesses that do not respond at all."
          ] }, void 0, true, {
            fileName: "/dev-server/src/pages/locations/MartinezCA.tsx",
            lineNumber: 257,
            columnNumber: 13
          ...
          /* @__PURE__ */ jsxDEV("a", { href: strategyCallUrl, target: "_blank", rel: "noopener noreferrer", className: "inline-flex items-center gap-2 bg-primary/10 border border-primary/30 rounded-lg px-5 py-3 text-primary font-semibold hover:bg-primary/20 transition-colors", children: "→ Build a 4.5+ Star Reputation in Martinez — Start Your Review Campaign" }, void 0, false, {
            fileName: "/dev-server/src/pages/locations/MartinezCA.tsx",
            lineNumber: 268,
            columnNumber: 13
          }, void 0)
        ...
        /* @__PURE__ */ jsxDEV("div", { className: "mt-16 pt-10 border-t border-border/30", children: [
          /* @__PURE__ */ jsxDEV("h3", { className: "text-2xl md:text-3xl font-display font-bold text-foreground mb-4", children: [
            ...
            " ",
            /* @__PURE__ */ jsxDEV("span", { className: "text-transparent bg-clip-text bg-gradient-primary", children: "Our AI Receptionist Follows Up in Seconds — So You Never Lose Another Martinez Lead to a Faster Competitor." }, void 0, false, {
              fileName: "/dev-server/src/pages/locations/MartinezCA.tsx",
              lineNumber: 276,
              columnNumber: 15
            }, void 0)
          ...
          /* @__PURE__ */ jsxDEV("p", { className: "text-foreground/90 leading-relaxed mb-6", children: [
            ...
            " confirms that leads contacted within 5 minutes are 21 times more likely to convert than those reached after 30 minutes. In Martinez's home services market — where an emergency HVAC call, a burst pipe, or a power outage at 9pm requires immediate response — the business that answers first wins. Manual teams cannot achieve five-minute response times around the clock. AI systems can."
          ] }, void 0, true, {
            fileName: "/dev-server/src/pages/locations/MartinezCA.tsx",
            lineNumber: 278,
            columnNumber: 13
      ...
      /* @__PURE__ */ jsxDEV("section", { className: "py-16 md:py-24 bg-background", children: /* @__PURE__ */ jsxDEV("div", { className: "container mx-auto px-4 max-w-5xl", children: [
        /* @__PURE__ */ jsxDEV("div", { className: "text-center mb-12", children: [
          ...
          /* @__PURE__ */ jsxDEV("h2", { className: "text-3xl md:text-4xl font-display font-bold text-foreground bg-gradient-heading bg-clip-text text-transparent", children: "Built for Your Industry, Not Adapted From Someone Else's Playbook — See If We're the Right Fit for Martinez" }, void 0, false, {
            fileName: "/dev-server/src/pages/locations/MartinezCA.tsx",
            lineNumber: 299,
            columnNumber: 13
          }, void 0),
          /* @__PURE__ */ jsxDEV("p", { className: "text-lg text-muted-foreground mt-4 max-w-3xl mx-auto", children: "GrowSmallBiz works exclusively with local service businesses in Martinez and surrounding Contra Costa County. We do not work with eCommerce stores, national retailers, or product-based businesses. Our systems are purpose-built for the verticals below — with genuine knowledge of Martinez's neighborhoods, seasonal demand patterns, and community culture." }, void 0, false, {
            fileName: "/dev-server/src/pages/locations/MartinezCA.tsx",
            lineNumber: 302,
            columnNumber: 13
          }, void 0)
        ...
        /* @__PURE__ */ jsxDEV("div", { className: "grid md:grid-cols-2 gap-6", children: [
          /* @__PURE__ */ jsxDEV("div", { className: "feature-card-teal rounded-2xl p-6", children: [
            ...
            /* @__PURE__ */ jsxDEV("p", { className: "text-muted-foreground leading-relaxed", children: "Martinez's residential geography creates distinct demand patterns for home service contractors. Vine Hill's working-class homeowners generate consistent volume demand. Alhambra Valley's larger, more affluent properties create higher-ticket service opportunities. We build the systems that put Martinez home service contractors at the top of those searches and capture every lead the moment it arrives." }, void 0, false, {
              fileName: "/dev-server/src/pages/locations/MartinezCA.tsx",
              lineNumber: 308,
              columnNumber: 15
            }, void 0)
          ...
          /* @__PURE__ */ jsxDEV("div", { className: "feature-card-teal rounded-2xl p-6", children: [
            ...
            /* @__PURE__ */ jsxDEV("p", { className: "text-muted-foreground leading-relaxed", children: "Martinez's proximity to the Contra Costa County Regional Medical Center creates meaningful demand for dental care, physical therapy, chiropractic, and allied health services. Patients here choose their healthcare providers based on visible community trust signals. We build the complete digital presence that helps Martinez practices compete on community trust and personalized care." }, void 0, false, {
              fileName: "/dev-server/src/pages/locations/MartinezCA.tsx",
              lineNumber: 313,
              columnNumber: 15
            }, void 0)
          ...
          /* @__PURE__ */ jsxDEV("div", { className: "feature-card-teal rounded-2xl p-6", children: [
            ...
            /* @__PURE__ */ jsxDEV("p", { className: "text-muted-foreground leading-relaxed", children: "Martinez's waterfront dining corridor along the Carquinez Strait and the Alhambra Avenue restaurant district serve a community that treats local dining as a social institution. We build the full digital system — Local SEO, Google Maps optimization, social media community campaigns tied to the Martinez Farmers Market and Blues Festival, and the retention infrastructure that fills tables year-round." }, void 0, false, {
              fileName: "/dev-server/src/pages/locations/MartinezCA.tsx",
              lineNumber: 318,
              columnNumber: 15
            }, void 0)
      ...
      /* @__PURE__ */ jsxDEV("section", { className: "py-16 md:py-24", style: { background: "linear-gradient(180deg, hsl(210 50% 8%) 0%, hsl(210 45% 14%) 50%, hsl(210 50% 8%) 100%)" }, children: /* @__PURE__ */ jsxDEV("div", { className: "container mx-auto px-4 max-w-5xl", children: [
        ...
        /* @__PURE__ */ jsxDEV(CampaignResultsCards, { cards: martinezCards }, void 0, false, {
          fileName: "/dev-server/src/pages/locations/MartinezCA.tsx",
          lineNumber: 340,
          columnNumber: 11
        }, void 0)
      ...
      /* @__PURE__ */ jsxDEV("section", { className: "py-16 md:py-24", style: { background: "linear-gradient(180deg, hsl(210 50% 8%) 0%, hsl(210 45% 14%) 50%, hsl(210 50% 8%) 100%)" }, children: /* @__PURE__ */ jsxDEV("div", { className: "container mx-auto px-4", children: /* @__PURE__ */ jsxDEV("div", { className: "max-w-4xl mx-auto text-center mb-10", children: [
        /* @__PURE__ */ jsxDEV("h2", { className: "text-3xl md:text-4xl font-display font-bold text-foreground leading-tight mb-6 bg-gradient-heading bg-clip-text text-transparent", children: "Every Day You Wait, Your Competitors Book Another Martinez Customer That Should Have Been Yours" }, void 0, false, {
          fileName: "/dev-server/src/pages/locations/MartinezCA.tsx",
          lineNumber: 367,
          columnNumber: 13
        }, void 0),
        /* @__PURE__ */ jsxDEV("p", { className: "text-foreground/80 leading-relaxed mb-4", children: "Martinez's local search landscape is open. The dominant SERP competitor is a national template agency with no genuine knowledge of this community. The map pack positions for most local service categories in Martinez are not locked — they are available to the business that builds a properly structured local presence first and maintains it consistently." }, void 0, false, {
          fileName: "/dev-server/src/pages/locations/MartinezCA.tsx",
          lineNumber: 370,
          columnNumber: 13
        }, void 0),
        /* @__PURE__ */ jsxDEV("p", { className: "text-foreground/80 leading-relaxed mb-4", children: "GrowSmallBiz gives Martinez service businesses the integrated marketing system that wins in a community-oriented market: one connected platform spanning awareness to retention, powered by AI, and managed by a team based 20 minutes away in Danville." }, void 0, false, {
          fileName: "/dev-server/src/pages/locations/MartinezCA.tsx",
          lineNumber: 371,
          columnNumber: 13
        }, void 0),
        /* @__PURE__ */ jsxDEV("p", { className: "text-foreground/70 font-semibold mt-6", children: "No long-term contracts. No templates. No excuses. Just one integrated system built specifically for your Martinez business." }, void 0, false, {
          fileName: "/dev-server/src/pages/locations/MartinezCA.tsx",
          lineNumber: 372,
          columnNumber: 13
        }, void 0)
