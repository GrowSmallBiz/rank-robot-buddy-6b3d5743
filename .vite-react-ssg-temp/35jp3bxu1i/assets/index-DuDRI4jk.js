...
import { Thermometer, Eye, Phone, Calendar, Star, Search, DollarSign, Globe, Target, RefreshCw, Zap, TrendingUp, BarChart3, Home, Building2, MapPin, Shield, Bot, Facebook, Instagram, Linkedin, Youtube, Heart, Gift, ClipboardList, FileText, Sun, Flame, UserPlus, MessageSquare, Lightbulb, Palette, Megaphone, PhoneCall } from "lucide-react";
...
const hvacHeroImage = "/assets/industry-hvac-hero-C48KlvYj.webp";
const hvacWebsiteScreenshot = "/assets/hvac-website-screenshot-BVtzb5k_.webp";
const residentialHvacSeo = "/assets/residential-hvac-seo-Dq4ZLN_W.webp";
const emergencyRepairSeo = "/assets/emergency-repair-seo-DtLlzwqK.webp";
const commercialHvacSeo = "/assets/commercial-hvac-seo-Ch4-RhnD.webp";
const emergencyHvacAd = "/assets/emergency-hvac-ad-CKXAEKyU.webp";
const summerAcAd = "/assets/summer-ac-ad-BUHLAFJU.webp";
const winterHeatingAd = "/assets/winter-heating-ad-D7DuNiZm.webp";
const maintenancePlanAd = "/assets/maintenance-plan-ad-Dkz6Gxn8.webp";
const commercialHvacAd = "/assets/commercial-hvac-ad-Ccduotca.webp";
const aiReceptionistMulticall = "/assets/hvac-ai-receptionist-JiJssaUg.webp";
const aiWebsiteLivechat = "/assets/hvac-ai-website-chat-BE79YMhy.webp";
const hvacConfig = {
  // ══════════════════════════════════════════════════════════════════════
  // PAGE META
  // ══════════════════════════════════════════════════════════════════════
  pageTitle: "AI Powered Marketing for HVAC Contractors | GrowSmallBiz",
  ogTitle: "AI-Driven Growth for Local Service Businesses | GrowSmallBiz",
  ...
  paidMediaByGenre: [
    {
      genre: "Residential HVAC Contractors",
      icon: Home,
  ...
  socialMediaByGenre: [
    ...
    {
      genre: "Commercial HVAC Contractors",
      color: "from-blue-500/20 to-blue-600/10",
      primary: [
  ...
  sessionReminderWorkflows: [
    {
      sessionType: "Service Appointment",
      icon: ClipboardList,
    ...
    {
      sessionType: "Follow-Up Estimate",
      icon: FileText,
  ...
  marketingCampaigns: [
    ...
    {
      genre: "Maintenance Plan Enrollment",
      icon: Shield,
...
const HvacMarketingPage = () => {
  return /* @__PURE__ */ jsxDEV(NichePage, { config: hvacConfig }, void 0, false, {
    fileName: "/dev-server/src/pages/industries/hvac-marketing/index.tsx",
    lineNumber: 5,
    columnNumber: 10
  }, void 0);
};
export {
  HvacMarketingPage as default
};
