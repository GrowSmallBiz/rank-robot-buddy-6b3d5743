...
import { L as LocationJsonLd, C as ChamberTrustBar, a as CampaignResultsCards, l as livermoreCards } from "./ChamberTrustBar-D96yL4i2.js";
import "react";
...
const LivermoreCA = () => {
  ...
  return /* @__PURE__ */ jsxDEV("div", { className: "min-h-screen bg-background", children: [
    /* @__PURE__ */ jsxDEV(Head, { children: [
      /* @__PURE__ */ jsxDEV("title", { children: "Digital Marketing Services in Livermore, CA | GrowSmallBiz" }, void 0, false, {
        fileName: "/dev-server/src/pages/locations/LivermoreCA.tsx",
        lineNumber: 26,
        columnNumber: 9
      }, void 0),
      /* @__PURE__ */ jsxDEV("meta", { name: "description", content: "Livermore, CA digital marketing services by GrowSmallBiz: Grow your business with AI SEO, AI optimized paid ads, and AI marketing automation." }, void 0, false, {
        fileName: "/dev-server/src/pages/locations/LivermoreCA.tsx",
        lineNumber: 27,
        columnNumber: 9
      }, void 0),
      /* @__PURE__ */ jsxDEV("meta", { name: "keywords", content: "digital marketing Livermore, AI marketing solutions, local SEO services, Google Ads management, reputation management Livermore, lead generation strategies, small business marketing, GrowSmallBiz services" }, void 0, false, {
        fileName: "/dev-server/src/pages/locations/LivermoreCA.tsx",
        lineNumber: 28,
        columnNumber: 9
      }, void 0),
      /* @__PURE__ */ jsxDEV("link", { rel: "canonical", href: "https://growsmallbiz.io/locations/livermore-ca/" }, void 0, false, {
        fileName: "/dev-server/src/pages/locations/LivermoreCA.tsx",
        lineNumber: 29,
        columnNumber: 9
      }, void 0)
    ...
    /* @__PURE__ */ jsxDEV("main", { id: "main-content", children: [
      /* @__PURE__ */ jsxDEV("section", { className: "hero-section", children: [
        /* @__PURE__ */ jsxDEV("img", { src: livermoreHero, alt: "Vineyard landscape in Livermore, CA, featuring rolling hills, lush grapevines, and a Mediterranean-style building, highlighting the region's agricultural beauty and local business potential.", width: 1920, height: 768, className: "absolute inset-0 w-full h-full object-cover" }, void 0, false, {
          fileName: "/dev-server/src/pages/locations/LivermoreCA.tsx",
          lineNumber: 50,
          columnNumber: 9
        }, void 0),
        ...
        /* @__PURE__ */ jsxDEV("div", { className: "container mx-auto px-4 relative z-10", children: /* @__PURE__ */ jsxDEV("div", { className: "max-w-4xl mx-auto text-center", children: [
          /* @__PURE__ */ jsxDEV("div", { className: "service-badge mb-4 animate-fade-up", children: [
            ...
            /* @__PURE__ */ jsxDEV("span", { children: "Livermore, CA — Local Service Business Marketing | Labs Economy + Wine Country + I-580 Corridor" }, void 0, false, {
              fileName: "/dev-server/src/pages/locations/LivermoreCA.tsx",
              lineNumber: 56,
              columnNumber: 15
            }, void 0)
          ...
          /* @__PURE__ */ jsxDEV("h1", { className: "text-4xl md:text-5xl lg:text-6xl font-display font-bold text-foreground mb-3 animate-fade-up leading-tight bg-gradient-heading bg-clip-text text-transparent", children: "Stop Losing Livermore Leads: AI Digital Marketing for Local Services" }, void 0, false, {
            fileName: "/dev-server/src/pages/locations/LivermoreCA.tsx",
            lineNumber: 59,
            columnNumber: 13
          }, void 0),
          /* @__PURE__ */ jsxDEV("p", { className: "max-w-3xl mx-auto text-base md:text-lg text-muted-foreground leading-relaxed animate-fade-up mt-6", style: { animationDelay: "0.1s" }, children: "Livermore runs three distinct economies simultaneously — federal labs workforce, wine country hospitality, and I-580 commuter households. GrowSmallBiz builds integrated marketing systems for all three from our Danville base, 20 minutes away." }, void 0, false, {
            fileName: "/dev-server/src/pages/locations/LivermoreCA.tsx",
            lineNumber: 63,
            columnNumber: 13
          }, void 0),
      ...
      /* @__PURE__ */ jsxDEV("section", { className: "py-16 md:py-24", style: { background: "linear-gradient(180deg, hsl(210 50% 8%) 0%, hsl(210 45% 14%) 50%, hsl(210 50% 8%) 100%)" }, children: /* @__PURE__ */ jsxDEV("div", { className: "container mx-auto px-4 max-w-5xl", children: [
        /* @__PURE__ */ jsxDEV("div", { className: "text-center mb-12", children: [
          ...
          /* @__PURE__ */ jsxDEV("h2", { className: "text-3xl md:text-4xl font-display font-bold text-foreground bg-gradient-heading bg-clip-text text-transparent", children: "Your Competitors Are Winning in Livermore Search Results. Here's Exactly Why — and How to Take It Back." }, void 0, false, {
            fileName: "/dev-server/src/pages/locations/LivermoreCA.tsx",
            lineNumber: 130,
            columnNumber: 13
          }, void 0),
          /* @__PURE__ */ jsxDEV("p", { className: "text-lg text-muted-foreground mt-4 max-w-3xl mx-auto", children: "Most agencies that rank for Livermore keywords built pages that treat it as another I-580 corridor suburb — comparable to Dublin or Pleasanton with a slightly different demographic mix. That framing fundamentally misreads the market. Livermore is not one market. It is three distinct economies operating simultaneously within the same ZIP codes, and understanding that structure is what separates effective local marketing from expensive, underperforming campaigns." }, void 0, false, {
            fileName: "/dev-server/src/pages/locations/LivermoreCA.tsx",
            lineNumber: 133,
            columnNumber: 13
          }, void 0)
        ...
        /* @__PURE__ */ jsxDEV("div", { className: "space-y-5 max-w-4xl mx-auto", children: [
          ...
          /* @__PURE__ */ jsxDEV("div", { className: "bg-card/50 border border-border/60 rounded-xl p-6 md:p-8", children: [
            /* @__PURE__ */ jsxDEV("h3", { className: "text-lg font-display font-semibold text-primary mb-3", children: "The I-580 Commuter Economy — Professional Households" }, void 0, false, {
              fileName: "/dev-server/src/pages/locations/LivermoreCA.tsx",
              lineNumber: 148,
              columnNumber: 15
            }, void 0),
            /* @__PURE__ */ jsxDEV("p", { className: "text-foreground/90 leading-relaxed", children: "Beyond the Labs and wine country, Livermore's growing commuter population — professionals using Livermore as an affordable Tri-Valley base and commuting to Pleasanton, Dublin, and the South Bay — creates standard suburban service demand for home services, dental care, restaurants, and real estate. This is the audience most agencies target when they build a Livermore page. It is real, but it is only one third of the opportunity." }, void 0, false, {
              fileName: "/dev-server/src/pages/locations/LivermoreCA.tsx",
              lineNumber: 149,
              columnNumber: 15
            }, void 0)
        ...
        /* @__PURE__ */ jsxDEV("div", { className: "mt-16 max-w-4xl mx-auto", children: [
          /* @__PURE__ */ jsxDEV("h3", { className: "text-2xl md:text-3xl font-display font-bold text-foreground mb-6", children: [
            "The Dual-Track HVAC Problem —",
            " ",
            /* @__PURE__ */ jsxDEV("span", { className: "text-transparent bg-clip-text bg-gradient-primary", children: "and How GrowSmallBiz Solves It" }, void 0, false, {
              fileName: "/dev-server/src/pages/locations/LivermoreCA.tsx",
              lineNumber: 162,
              columnNumber: 15
            }, void 0)
          ...
          /* @__PURE__ */ jsxDEV("p", { className: "text-foreground/90 leading-relaxed mb-8", children: "Consider a Livermore HVAC contractor. In Springtown, they serve LLNL employees who research providers carefully, value the Google Guaranteed badge, call in the evening when they get home from work, and can afford a $15,000 heat pump installation. In South Livermore's wine country corridor, they may be servicing barrel rooms for Wente Vineyards or McGrail Vineyards — commercial refrigeration work where failure during harvest season costs the client tens of thousands of dollars and where a 24/7 emergency response capability is the primary criterion for vendor selection." }, void 0, false, {
            fileName: "/dev-server/src/pages/locations/LivermoreCA.tsx",
            lineNumber: 164,
            columnNumber: 13
          }, void 0),
          /* @__PURE__ */ jsxDEV("p", { className: "text-foreground/80 leading-relaxed mb-8", children: "These are two completely different businesses requiring two different marketing approaches — different keywords, different ad schedules, different landing pages, different trust signals, different retention systems. Most HVAC contractors run one generic campaign and capture only a fraction of the available market. GrowSmallBiz builds both tracks simultaneously from one integrated CRM." }, void 0, false, {
            fileName: "/dev-server/src/pages/locations/LivermoreCA.tsx",
            lineNumber: 165,
            columnNumber: 13
          }, void 0),
          /* @__PURE__ */ jsxDEV("div", { className: "overflow-x-auto", children: /* @__PURE__ */ jsxDEV("table", { className: "w-full text-sm border-collapse", children: [
            /* @__PURE__ */ jsxDEV("thead", { children: /* @__PURE__ */ jsxDEV("tr", { children: [
              /* @__PURE__ */ jsxDEV("th", { className: "p-3 text-left font-bold text-foreground bg-card/80 border border-border/60" }, void 0, false, {
                fileName: "/dev-server/src/pages/locations/LivermoreCA.tsx",
                lineNumber: 172,
                columnNumber: 21
              }, void 0),
              /* @__PURE__ */ jsxDEV("th", { className: "p-3 text-left font-bold text-foreground bg-card/80 border border-border/60", children: "Labs-Residential Track — 94550/94551 Homeowners" }, void 0, false, {
                fileName: "/dev-server/src/pages/locations/LivermoreCA.tsx",
                lineNumber: 173,
                columnNumber: 21
              }, void 0),
              /* @__PURE__ */ jsxDEV("th", { className: "p-3 text-left font-bold text-primary bg-card/80 border border-border/60", children: "Wine Country-Commercial Track — Wineries & Venues" }, void 0, false, {
                fileName: "/dev-server/src/pages/locations/LivermoreCA.tsx",
                lineNumber: 174,
                columnNumber: 21
              }, void 0)
            ...
            ].map((item, i) => /* @__PURE__ */ jsxDEV("tr", { children: [
              /* @__PURE__ */ jsxDEV("td", { className: "p-3 border border-border/60 font-semibold text-foreground bg-card/30", children: item.row }, void 0, false, {
                fileName: "/dev-server/src/pages/locations/LivermoreCA.tsx",
                lineNumber: 188,
                columnNumber: 23
              }, void 0),
              /* @__PURE__ */ jsxDEV("td", { className: "p-3 border border-border/60 text-foreground/80", children: item.labs }, void 0, false, {
                fileName: "/dev-server/src/pages/locations/LivermoreCA.tsx",
                lineNumber: 189,
                columnNumber: 23
              }, void 0),
              /* @__PURE__ */ jsxDEV("td", { className: "p-3 border border-border/60 text-primary/90 italic", children: item.wine }, void 0, false, {
                fileName: "/dev-server/src/pages/locations/LivermoreCA.tsx",
                lineNumber: 190,
                columnNumber: 23
              }, void 0)
      ...
      /* @__PURE__ */ jsxDEV("section", { className: "py-16 md:py-24 bg-background", children: /* @__PURE__ */ jsxDEV("div", { className: "container mx-auto px-4 max-w-4xl", children: [
        /* @__PURE__ */ jsxDEV("div", { className: "text-center mb-12", children: [
          ...
          /* @__PURE__ */ jsxDEV("h2", { className: "text-3xl md:text-4xl font-display font-bold text-foreground bg-gradient-heading bg-clip-text text-transparent", children: "Get Found First When Livermore Customers Search for Your Services — Local SEO & Google Maps Domination" }, void 0, false, {
            fileName: "/dev-server/src/pages/locations/LivermoreCA.tsx",
            lineNumber: 207,
            columnNumber: 13
          }, void 0)
        ...
        /* @__PURE__ */ jsxDEV("div", { className: "prose prose-lg prose-invert max-w-none space-y-6", children: [
          /* @__PURE__ */ jsxDEV("p", { className: "text-foreground/90 leading-relaxed", children: [
            ...
            /* @__PURE__ */ jsxDEV("a", { href: "https://www.brightlocal.com/resources/local-seo-statistics/", target: "_blank", rel: "noopener noreferrer", className: "text-primary hover:underline", children: "BrightLocal research shows 56% of businesses have not fully optimized their Google Business Profile" }, void 0, false, {
              fileName: "/dev-server/src/pages/locations/LivermoreCA.tsx",
              lineNumber: 212,
              columnNumber: 585
            }, void 0),
      ...
      /* @__PURE__ */ jsxDEV("section", { className: "py-16 md:py-24", style: { background: "linear-gradient(180deg, hsl(210 50% 8%) 0%, hsl(210 45% 14%) 50%, hsl(210 50% 8%) 100%)" }, children: /* @__PURE__ */ jsxDEV("div", { className: "container mx-auto px-4 max-w-5xl", children: [
        /* @__PURE__ */ jsxDEV("div", { className: "text-center mb-12", children: [
          ...
          /* @__PURE__ */ jsxDEV("h2", { className: "text-3xl md:text-4xl font-display font-bold text-foreground bg-gradient-heading bg-clip-text text-transparent", children: "The Integrated Marketing System Built for Livermore Service Businesses — Fills Your Calendar, Not Just Your Dashboard" }, void 0, false, {
            fileName: "/dev-server/src/pages/locations/LivermoreCA.tsx",
            lineNumber: 226,
            columnNumber: 13
          }, void 0),
          /* @__PURE__ */ jsxDEV("p", { className: "text-lg text-muted-foreground mt-4 max-w-3xl mx-auto", children: "Every component is engineered to work with every other component — and for Livermore, that means running dual-track campaigns across both audience profiles simultaneously from one coordinated system. That integration is what makes the difference between marketing that costs money and marketing that makes money across Livermore's uniquely complex market." }, void 0, false, {
            fileName: "/dev-server/src/pages/locations/LivermoreCA.tsx",
            lineNumber: 229,
            columnNumber: 13
          }, void 0)
        ...
        /* @__PURE__ */ jsxDEV("div", { className: "hidden md:block overflow-x-auto mb-16", children: /* @__PURE__ */ jsxDEV("table", { className: "w-full text-sm border-collapse", children: [
          /* @__PURE__ */ jsxDEV("thead", { children: /* @__PURE__ */ jsxDEV("tr", { children: [
            ...
            /* @__PURE__ */ jsxDEV("th", { className: "p-3 text-left font-bold text-foreground bg-card/80 border border-border/60", children: "Livermore Business Impact" }, void 0, false, {
              fileName: "/dev-server/src/pages/locations/LivermoreCA.tsx",
              lineNumber: 239,
              columnNumber: 19
            }, void 0)
        ...
        /* @__PURE__ */ jsxDEV("div", { className: "mt-16 pt-10 border-t border-border/30", children: [
          ...
          /* @__PURE__ */ jsxDEV("p", { className: "text-foreground/80 mb-4", children: "Our local SEO approach for Livermore businesses includes:" }, void 0, false, {
            fileName: "/dev-server/src/pages/locations/LivermoreCA.tsx",
            lineNumber: 290,
            columnNumber: 13
          }, void 0),
        ...
        /* @__PURE__ */ jsxDEV("div", { className: "mt-16 pt-10 border-t border-border/30", children: [
          /* @__PURE__ */ jsxDEV("h3", { className: "text-2xl md:text-3xl font-display font-bold text-foreground mb-4", children: [
            ...
            " ",
            /* @__PURE__ */ jsxDEV("span", { className: "text-transparent bg-clip-text bg-gradient-primary", children: "Google Ads That Deliver Livermore Customers on Day One." }, void 0, false, {
              fileName: "/dev-server/src/pages/locations/LivermoreCA.tsx",
              lineNumber: 314,
              columnNumber: 15
            }, void 0)
          ...
          /* @__PURE__ */ jsxDEV("a", { href: strategyCallUrl, target: "_blank", rel: "noopener noreferrer", className: "inline-flex items-center gap-2 bg-primary/10 border border-primary/30 rounded-lg px-5 py-3 text-primary font-semibold hover:bg-primary/20 transition-colors", children: "→ Launch Google Ads for Your Livermore Business — Start Generating Leads This Week" }, void 0, false, {
            fileName: "/dev-server/src/pages/locations/LivermoreCA.tsx",
            lineNumber: 332,
            columnNumber: 13
          }, void 0)
        ...
        /* @__PURE__ */ jsxDEV("div", { className: "mt-16 pt-10 border-t border-border/30", children: [
          /* @__PURE__ */ jsxDEV("h3", { className: "text-2xl md:text-3xl font-display font-bold text-foreground mb-4", children: [
            ...
            " ",
            /* @__PURE__ */ jsxDEV("span", { className: "text-transparent bg-clip-text bg-gradient-primary", children: "More Livermore Leads, Pre-Qualified Before They Call" }, void 0, false, {
              fileName: "/dev-server/src/pages/locations/LivermoreCA.tsx",
              lineNumber: 341,
              columnNumber: 15
            }, void 0)
          ...
          /* @__PURE__ */ jsxDEV("a", { href: strategyCallUrl, target: "_blank", rel: "noopener noreferrer", className: "inline-flex items-center gap-2 bg-primary/10 border border-primary/30 rounded-lg px-5 py-3 text-primary font-semibold hover:bg-primary/20 transition-colors", children: "→ Set Up Google LSA for Your Livermore Business — Get Verified Leads" }, void 0, false, {
            fileName: "/dev-server/src/pages/locations/LivermoreCA.tsx",
            lineNumber: 359,
            columnNumber: 13
          }, void 0)
        ...
        /* @__PURE__ */ jsxDEV("div", { className: "mt-16 pt-10 border-t border-border/30", children: [
          /* @__PURE__ */ jsxDEV("h3", { className: "text-2xl md:text-3xl font-display font-bold text-foreground mb-4", children: [
            ...
            " ",
            /* @__PURE__ */ jsxDEV("span", { className: "text-transparent bg-clip-text bg-gradient-primary", children: "Social Media That Builds Both Tracks" }, void 0, false, {
              fileName: "/dev-server/src/pages/locations/LivermoreCA.tsx",
              lineNumber: 368,
              columnNumber: 15
            }, void 0)
          ...
          /* @__PURE__ */ jsxDEV("a", { href: strategyCallUrl, target: "_blank", rel: "noopener noreferrer", className: "inline-flex items-center gap-2 bg-primary/10 border border-primary/30 rounded-lg px-5 py-3 text-primary font-semibold hover:bg-primary/20 transition-colors", children: "→ Launch Social Media Advertising for Your Livermore Business — Get Started" }, void 0, false, {
            fileName: "/dev-server/src/pages/locations/LivermoreCA.tsx",
            lineNumber: 385,
            columnNumber: 13
          }, void 0)
        ...
        /* @__PURE__ */ jsxDEV("div", { className: "mt-16 pt-10 border-t border-border/30", children: [
          ...
          /* @__PURE__ */ jsxDEV("p", { className: "text-foreground/80 italic mb-6", children: [
            /* @__PURE__ */ jsxDEV("a", { href: "https://www.brightlocal.com/research/local-consumer-review-survey-2024/", target: "_blank", rel: "noopener noreferrer", className: "text-primary hover:underline", children: "BrightLocal's 2024 survey found that 88% of consumers would use a business that responds to all of its reviews" }, void 0, false, {
              fileName: "/dev-server/src/pages/locations/LivermoreCA.tsx",
              lineNumber: 411,
              columnNumber: 59
            }, void 0),
          ...
          /* @__PURE__ */ jsxDEV("a", { href: strategyCallUrl, target: "_blank", rel: "noopener noreferrer", className: "inline-flex items-center gap-2 bg-primary/10 border border-primary/30 rounded-lg px-5 py-3 text-primary font-semibold hover:bg-primary/20 transition-colors", children: "→ Build a 4.5+ Star Reputation in Livermore — Start Your Review Campaign" }, void 0, false, {
            fileName: "/dev-server/src/pages/locations/LivermoreCA.tsx",
            lineNumber: 412,
            columnNumber: 13
          }, void 0)
        ...
        /* @__PURE__ */ jsxDEV("div", { className: "mt-16 pt-10 border-t border-border/30", children: [
          /* @__PURE__ */ jsxDEV("h3", { className: "text-2xl md:text-3xl font-display font-bold text-foreground mb-4", children: [
            ...
            " ",
            /* @__PURE__ */ jsxDEV("span", { className: "text-transparent bg-clip-text bg-gradient-primary", children: "If It's Not Converting Both Livermore Audiences, It's Leaving Money Behind." }, void 0, false, {
              fileName: "/dev-server/src/pages/locations/LivermoreCA.tsx",
              lineNumber: 421,
              columnNumber: 15
            }, void 0)
          ...
          /* @__PURE__ */ jsxDEV("a", { href: strategyCallUrl, target: "_blank", rel: "noopener noreferrer", className: "inline-flex items-center gap-2 bg-primary/10 border border-primary/30 rounded-lg px-5 py-3 text-primary font-semibold hover:bg-primary/20 transition-colors", children: "→ Get a Conversion-Focused Website Built for Livermore — See Our Work" }, void 0, false, {
            fileName: "/dev-server/src/pages/locations/LivermoreCA.tsx",
            lineNumber: 439,
            columnNumber: 13
          }, void 0)
        ...
        /* @__PURE__ */ jsxDEV("div", { className: "mt-16 pt-10 border-t border-border/30", children: [
          /* @__PURE__ */ jsxDEV("h3", { className: "text-2xl md:text-3xl font-display font-bold text-foreground mb-4", children: [
            ...
            " ",
            /* @__PURE__ */ jsxDEV("span", { className: "text-transparent bg-clip-text bg-gradient-primary", children: "Our AI Receptionist Captures Both Tracks — Labs Homeowners After Hours and Wine Country Emergencies at Harvest." }, void 0, false, {
              fileName: "/dev-server/src/pages/locations/LivermoreCA.tsx",
              lineNumber: 448,
              columnNumber: 15
            }, void 0)
          ...
          /* @__PURE__ */ jsxDEV("p", { className: "text-foreground/90 leading-relaxed mb-6", children: [
            "Research from ",
            /* @__PURE__ */ jsxDEV("a", { href: "https://www.insidesales.com/response-time-matters/", target: "_blank", rel: "noopener noreferrer", className: "text-primary hover:underline", children: "MIT and InsideSales.com confirms that leads contacted within 5 minutes are 21 times more likely to convert" }, void 0, false, {
              fileName: "/dev-server/src/pages/locations/LivermoreCA.tsx",
              lineNumber: 450,
              columnNumber: 82
            }, void 0),
          ...
          /* @__PURE__ */ jsxDEV("p", { className: "text-foreground/80 mb-4", children: "GrowSmallBiz's AI-powered automation for Livermore includes:" }, void 0, false, {
            fileName: "/dev-server/src/pages/locations/LivermoreCA.tsx",
            lineNumber: 451,
            columnNumber: 13
          }, void 0),
      ...
      /* @__PURE__ */ jsxDEV("section", { className: "py-16 md:py-24 bg-background", children: /* @__PURE__ */ jsxDEV("div", { className: "container mx-auto px-4 max-w-5xl", children: [
        /* @__PURE__ */ jsxDEV("div", { className: "text-center mb-12", children: [
          ...
          /* @__PURE__ */ jsxDEV("h2", { className: "text-3xl md:text-4xl font-display font-bold text-foreground bg-gradient-heading bg-clip-text text-transparent", children: "Built for Your Industry, Not Adapted From Someone Else's Playbook — See If We're the Right Fit for Livermore" }, void 0, false, {
            fileName: "/dev-server/src/pages/locations/LivermoreCA.tsx",
            lineNumber: 478,
            columnNumber: 13
          }, void 0),
          /* @__PURE__ */ jsxDEV("p", { className: "text-lg text-muted-foreground mt-4 max-w-3xl mx-auto", children: "GrowSmallBiz works exclusively with local service businesses in Livermore and the Tri-Valley. We do not work with eCommerce stores, national retailers, or product-based businesses. Our systems are purpose-built for the verticals below — with genuine understanding of Livermore's dual-identity market structure that generic agency pages never develop." }, void 0, false, {
            fileName: "/dev-server/src/pages/locations/LivermoreCA.tsx",
            lineNumber: 481,
            columnNumber: 13
          }, void 0)
        ...
        /* @__PURE__ */ jsxDEV("div", { className: "grid md:grid-cols-2 gap-6", children: [
          /* @__PURE__ */ jsxDEV("div", { className: "feature-card-teal rounded-2xl p-6", children: [
            ...
            /* @__PURE__ */ jsxDEV("h3", { className: "text-xl font-display font-bold text-foreground mb-3", children: "Home Service Contractors — HVAC, Roofing, Plumbing & Electrical: Capture Both Livermore Tracks Year-Round" }, void 0, false, {
              fileName: "/dev-server/src/pages/locations/LivermoreCA.tsx",
              lineNumber: 489,
              columnNumber: 15
            }, void 0),
            /* @__PURE__ */ jsxDEV("p", { className: "text-muted-foreground leading-relaxed", children: "A Livermore home service contractor operates in two markets simultaneously. The residential track — Springtown, South Livermore, Isabel Avenue neighborhoods — serves Labs-adjacent homeowners who research providers carefully, value licensing credentials and the Google Guaranteed badge, and can afford premium system installations and upgrades. The commercial track — Livermore Valley wineries, tasting rooms, event venues, and First Street commercial properties — serves B2B clients where barrel room climate control, commercial refrigeration, and harvest-season emergency availability are the primary service requirements. We build both tracks simultaneously from one integrated marketing system, so your Monday morning pipeline includes both a winery pre-harvest maintenance inquiry and three residential quote requests from Springtown homeowners — all captured while you were off the clock." }, void 0, false, {
              fileName: "/dev-server/src/pages/locations/LivermoreCA.tsx",
              lineNumber: 490,
              columnNumber: 15
            }, void 0)
      ...
      /* @__PURE__ */ jsxDEV("section", { className: "py-16 md:py-24", style: { background: "linear-gradient(180deg, hsl(210 50% 8%) 0%, hsl(210 45% 14%) 50%, hsl(210 50% 8%) 100%)" }, children: /* @__PURE__ */ jsxDEV("div", { className: "container mx-auto px-4 max-w-5xl", children: [
        ...
        /* @__PURE__ */ jsxDEV(CampaignResultsCards, { cards: livermoreCards }, void 0, false, {
          fileName: "/dev-server/src/pages/locations/LivermoreCA.tsx",
          lineNumber: 533,
          columnNumber: 11
        }, void 0),
        /* @__PURE__ */ jsxDEV("h3", { className: "text-xl md:text-2xl font-display font-bold text-foreground mb-4", children: "Single-Channel Marketing Doesn't Win in Livermore. Here's What Actually Moves Both Tracks." }, void 0, false, {
          fileName: "/dev-server/src/pages/locations/LivermoreCA.tsx",
          lineNumber: 536,
          columnNumber: 11
        }, void 0),
        /* @__PURE__ */ jsxDEV("p", { className: "text-foreground/80 leading-relaxed mb-6", children: "The current SERP leader for Livermore dominates with a 95 content score — but targets only one audience profile. Outperforming it requires not just more content but an integrated dual-track system that captures Livermore's full market opportunity simultaneously." }, void 0, false, {
          fileName: "/dev-server/src/pages/locations/LivermoreCA.tsx",
          lineNumber: 537,
          columnNumber: 11
        }, void 0),
        /* @__PURE__ */ jsxDEV("div", { className: "overflow-x-auto", children: /* @__PURE__ */ jsxDEV("table", { className: "w-full text-sm border-collapse", children: [
          /* @__PURE__ */ jsxDEV("thead", { children: /* @__PURE__ */ jsxDEV("tr", { children: [
            /* @__PURE__ */ jsxDEV("th", { className: "p-3 text-left font-bold text-foreground bg-primary/20 border border-border/60", children: "Channel" }, void 0, false, {
              fileName: "/dev-server/src/pages/locations/LivermoreCA.tsx",
              lineNumber: 542,
              columnNumber: 19
            }, void 0),
            /* @__PURE__ */ jsxDEV("th", { className: "p-3 text-left font-bold text-foreground bg-primary/20 border border-border/60", children: "Best For" }, void 0, false, {
              fileName: "/dev-server/src/pages/locations/LivermoreCA.tsx",
              lineNumber: 543,
              columnNumber: 19
            }, void 0),
            /* @__PURE__ */ jsxDEV("th", { className: "p-3 text-left font-bold text-foreground bg-primary/20 border border-border/60", children: "Time to Results" }, void 0, false, {
              fileName: "/dev-server/src/pages/locations/LivermoreCA.tsx",
              lineNumber: 544,
              columnNumber: 19
            }, void 0),
            /* @__PURE__ */ jsxDEV("th", { className: "p-3 text-left font-bold text-foreground bg-primary/20 border border-border/60", children: "Long-Term Value" }, void 0, false, {
              fileName: "/dev-server/src/pages/locations/LivermoreCA.tsx",
              lineNumber: 545,
              columnNumber: 19
            }, void 0)
          ...
          ].map((row, i) => /* @__PURE__ */ jsxDEV("tr", { className: i % 2 === 0 ? "" : "bg-card/30", children: [
            /* @__PURE__ */ jsxDEV("td", { className: "p-3 border border-border/60 font-semibold text-foreground", children: row.channel }, void 0, false, {
              fileName: "/dev-server/src/pages/locations/LivermoreCA.tsx",
              lineNumber: 558,
              columnNumber: 21
            }, void 0),
            /* @__PURE__ */ jsxDEV("td", { className: "p-3 border border-border/60 text-foreground/80", children: row.best }, void 0, false, {
              fileName: "/dev-server/src/pages/locations/LivermoreCA.tsx",
              lineNumber: 559,
              columnNumber: 21
            }, void 0),
            /* @__PURE__ */ jsxDEV("td", { className: "p-3 border border-border/60 text-foreground/80", children: row.time }, void 0, false, {
              fileName: "/dev-server/src/pages/locations/LivermoreCA.tsx",
              lineNumber: 560,
              columnNumber: 21
            }, void 0),
            /* @__PURE__ */ jsxDEV("td", { className: "p-3 border border-border/60 text-primary italic", children: row.value }, void 0, false, {
              fileName: "/dev-server/src/pages/locations/LivermoreCA.tsx",
              lineNumber: 561,
              columnNumber: 21
            }, void 0)
      ...
      /* @__PURE__ */ jsxDEV("section", { className: "py-16 md:py-24 bg-background", children: /* @__PURE__ */ jsxDEV("div", { className: "container mx-auto px-4 max-w-5xl", children: [
        /* @__PURE__ */ jsxDEV("div", { className: "text-center mb-12", children: [
          ...
          /* @__PURE__ */ jsxDEV("h2", { className: "text-3xl md:text-4xl font-display font-bold text-foreground bg-gradient-heading bg-clip-text text-transparent", children: "No Templates. No Generalists. No Excuses. Why GrowSmallBiz Outperforms Every Agency That's Failed Your Livermore Business Before." }, void 0, false, {
            fileName: "/dev-server/src/pages/locations/LivermoreCA.tsx",
            lineNumber: 577,
            columnNumber: 13
          }, void 0),
          /* @__PURE__ */ jsxDEV("p", { className: "text-lg text-muted-foreground mt-4 max-w-3xl mx-auto", children: "Livermore's SERPs are led by agencies that treat Livermore as one market and miss two thirds of the available opportunity. Here is why the system GrowSmallBiz builds consistently outperforms them across both of Livermore's distinct audience tracks:" }, void 0, false, {
            fileName: "/dev-server/src/pages/locations/LivermoreCA.tsx",
            lineNumber: 580,
            columnNumber: 13
          }, void 0)
      ...
      /* @__PURE__ */ jsxDEV(ConsultationFormSection, { utmCampaign: "livermore-consultation", utmMedium: "livermore-ca" }, void 0, false, {
        fileName: "/dev-server/src/pages/locations/LivermoreCA.tsx",
        lineNumber: 663,
        columnNumber: 7
      }, void 0),
