...
import { Layers, Calendar, MapPin, Shield, TrendingUp, Search, DollarSign, Bot, Star, Globe, Home, Flame, Hammer, Zap, BarChart3, Building2, Target, RefreshCw, Instagram, Facebook, Youtube, Linkedin, Eye, Phone, Heart, Gift, ClipboardList, FileText, UserPlus, MessageSquare, Lightbulb, Palette, Megaphone, PhoneCall } from "lucide-react";
...
const heroImage = "/assets/hero-B2pBT7Ti.webp";
const croWebsiteDesign = "/assets/cro-website-design-CLeynrob.webp";
const remodelingSeo = "/assets/full-remodel-B63Q85HS.webp";
const hardscapeSeo = "/assets/hardscape-CN8ZpPf5.webp";
const outdoorLivingSeo = "/assets/outdoor-living-ulD_upHa.webp";
const retainingWallSeo = "/assets/hillside-BDNqYZdh.webp";
const deckPergolaSeo = "/assets/decks-PRe6ZD65.webp";
const foundationSeo = "/assets/foundation-D8aXfzzw.webp";
const fullRemodelAd = "/assets/full-remodel-ad-fAhucLCz.webp";
const hardscapeAd = "/assets/hardscape-ad-oN7HLAAn.webp";
const outdoorKitchenAd = "/assets/outdoor-kitchen-ad-BxB_QZBX.webp";
const commercialAd = "/assets/commercial-ad-CsoeND2N.webp";
const localMapPack = "/assets/local-map-pack-ad-CE042dsS.webp";
const aiReceptionistImage = "/assets/ai-receptionist-DmkXSswC.webp";
const aiWebsiteLivechatImage = "/assets/ai-website-livechat-BoxTeV3S.webp";
const landscapeConstructionHardscapingConfig = {
  ...
  sessionReminderWorkflows: [
    {
      sessionType: "Design Consultation",
      icon: ClipboardList,
    ...
    {
      sessionType: "Follow-Up Proposal",
      icon: FileText,
    ...
    {
      sessionType: "Phase-Two Re-engagement",
      icon: Layers,
  ...
  marketingCampaigns: [
    {
      ...
      offer: {
        ...
        urgency: "Limited design-season slots per week",
        cta: "Book My Design Consultation"
      },
    ...
    },
    {
      ...
      offer: {
        ...
        urgency: "Install slots book 6–10 weeks out",
        cta: "Get Free Quote"
      },
    ...
    },
    {
      ...
      offer: {
        ...
        urgency: "Design pipeline books out for full season",
        cta: "Book My Design Session"
      },
    ...
    {
      genre: "Retaining Walls & Hillside",
      icon: Shield,
      ...
      offer: {
        ...
        urgency: "Wall failures are time-sensitive — priority scheduling",
    ...
    {
      genre: "Commercial & HOA Site Work",
      icon: Building2,
      ...
      offer: {
        ...
        urgency: "Commercial project pipeline books quarters in advance",
  ...
  giftAndReferralPrograms: [
    ...
    {
      title: "Client Gift Cards & Add-On Credits",
      icon: Gift,
...
const LandscapeConstructionHardscapingPage = () => {
  return /* @__PURE__ */ jsxDEV(NichePage, { config: landscapeConstructionHardscapingConfig }, void 0, false, {
    fileName: "/dev-server/src/pages/industries/landscape-construction-hardscaping/index.tsx",
    lineNumber: 5,
    columnNumber: 10
  }, void 0);
};
export {
  LandscapeConstructionHardscapingPage as default
};
