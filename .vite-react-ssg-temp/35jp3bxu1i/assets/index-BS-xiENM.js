...
import { Activity, Search, Users, Phone, Star, RefreshCw, Target, AlertTriangle, Heart, Shield, Facebook, BarChart3, Instagram, MapPin, Globe, Mail, Eye, Zap, CalendarCheck, Calendar, Gift, UserPlus, DollarSign, MessageSquare, Megaphone, Bot } from "lucide-react";
...
const chiroHeroImage = "/assets/chiro-hero-kpiA96gk.webp";
const portfolioChiroWebsite = "/assets/portfolio-chiro-website-DIcXQAy3.webp";
const chiropracticConfig = {
  // ── Page Meta ──
  ...
  metaKeywords: "chiropractor marketing, patient acquisition strategies, digital marketing for chiropractors, AI-powered SEO, automated marketing solutions, chiropractic practice growth, Google Ads for chiropractors, online presence for chiropractors",
  ...
  badgeIcon: Activity,
  h1Line1: "AI-Powered Chiropractic Marketing to Attract Loyal Long-Term Patients",
  h1Line2: "",
  h1Highlight: "",
  ...
  seoKeywordCategories: {
    ...
    personalInjury: {
      label: "Auto Accident & Personal Injury",
      icon: Shield,
      image: chiroHeroImage,
      keywords: [
  ...
  sessionReminderWorkflows: [
    {
      sessionType: "New Patient First Visit",
      icon: CalendarCheck,
      color: "blue",
    ...
    {
      sessionType: "Ongoing Treatment Visit",
      icon: Activity,
      color: "emerald",
    ...
    {
      sessionType: "Wellness / Maintenance Visit",
      icon: Calendar,
      color: "amber",
  ...
  marketingCampaigns: [
    {
      genre: "New Patient Special — General",
      icon: Activity,
    ...
    {
      genre: "Wellness Consultation — New Patients",
      icon: Heart,
    ...
    {
      genre: "Patient Recall & Reactivation",
      icon: RefreshCw,
...
const ChiropracticMarketingPage = () => {
  return /* @__PURE__ */ jsxDEV(NichePage, { config: chiropracticConfig }, void 0, false, {
    fileName: "/dev-server/src/pages/industries/chiropractic-marketing/index.tsx",
    lineNumber: 5,
    columnNumber: 10
  }, void 0);
};
export {
  ChiropracticMarketingPage as default
};
