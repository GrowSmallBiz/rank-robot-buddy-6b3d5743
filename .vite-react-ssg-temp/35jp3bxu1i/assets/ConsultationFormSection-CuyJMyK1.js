      ...
      "div",
      {
        ...
        children: /* @__PURE__ */ jsxDEV("div", { className: "relative rounded-2xl p-8", style: { backgroundColor: "#191321" }, children: [
          /* @__PURE__ */ jsxDEV("div", { className: "text-center mb-8", children: [
            ...
            /* @__PURE__ */ jsxDEV("h2", { className: `text-3xl md:text-4xl lg:text-5xl font-black uppercase tracking-tight mb-4 bg-clip-text text-transparent ${headingGradientClass ?? "bg-gradient-heading text-white"}`, children: headingOverride ?? "Get a Consultation" }, void 0, false, {
              fileName: "/dev-server/src/components/sections/ConsultationFormSection.tsx",
              lineNumber: 90,
              columnNumber: 15
            }, void 0),
