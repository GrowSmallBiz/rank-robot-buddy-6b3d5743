...
import { N as NichePage } from "./NichePage-BV4_61J0.js";
import { TreePine, Calendar, MapPin, Shield, TrendingUp, Search, DollarSign, Bot, Star, Globe, Layers, Target, Phone, RefreshCw, Sprout, Leaf, Zap, BarChart3, Building2, Facebook, Instagram, Youtube, Linkedin, Eye, Heart, Gift, ClipboardList, FileText, UserPlus, MessageSquare, Lightbulb, Palette, Megaphone, PhoneCall } from "lucide-react";
...
import "./ServiceJsonLd-BLh2oIn0.js";
import "./Header-DmWea8pt.js";
import "./button-Co-CyCVS.js";
import "@radix-ui/react-slot";
import "class-variance-authority";
import "./growsmallbiz-logo-bLUzBkSC.js";
import "./Footer-C67l1NbO.js";
import "./ConsultationFormSection-CuyJMyK1.js";
import "./use-utm-X_toIThi.js";
import "./CardCTA-DT9NPaz7.js";
import "./contactCTA-DlNQ95Kc.js";
import "./glow-card-2Rtno8B6.js";
import "./SectionHeader-BzL5eqYC.js";
import "embla-carousel-react";
import "./badge-lx1MgBuh.js";
import "./accordion-TqW6W-yi.js";
import "@radix-ui/react-accordion";
const heroImage = "/assets/tree-service-landscape-remodeling-hero-D9qXprEJ.webp";
const websiteScreenshot = "/assets/tree-stump-removal-website-screenshot-DCi2k66U.webp";
const treeServiceSeo = "/assets/tree-service-seo-keywords-B4M5NhaE.webp";
const landscapeRemodelingSeo = "/assets/landscape-remodeling-seo-keywords-0b4LT-yc.webp";
const landscapingSeo = "/assets/landscaping-seo-keywords-YGqNzEsJ.webp";
const stumpGrindingSeo = "/assets/stump-grinding-seo-keywords-Bg1p5lpd.webp";
const treePruningSeo = "/assets/tree-pruning-trimming-seo-keywords-CHFUWmv9.webp";
const emergencyTreeRemoval = "/assets/emergency-tree-removal-ad-Ced9FDQ9.webp";
const springLandscapeRemodeling = "/assets/spring-landscape-remodeling-ad-B1Af6d5S.webp";
const fallTreeService = "/assets/fall-tree-service-ad-ABq8huda.webp";
const commercialLandscaping = "/assets/commercial-landscaping-ad-BzfV4HNd.webp";
const localMapPack = "/assets/local-map-pack-ad-B7pa_g02.webp";
const aiReceptionistMulticall = "/assets/ai-receptionist-multicall-BvPpPeHt.webp";
const aiWebsiteLivechat = "/assets/ai-website-livechat-xFvGT1_7.webp";
const treeLawnLandscapingConfig = {
  // ══════════════════════════════════════════════════════════════════════
  // 4.1 PAGE META
  // ══════════════════════════════════════════════════════════════════════
  ...
  h1Line1: "We Generate Leads for Tree Removal Service & Landscape Maintenance Contractors",
  h1Highlight: "",
  h1Line2: "",
  ...
  marketingCampaigns: [
    {
      ...
      offer: {
        ...
        urgency: "Storm slots fill within hours",
    ...
    {
      genre: "Tree Removal & Stump Grinding",
      icon: TreePine,
      ...
      offer: {
        ...
        urgency: "Limited assessment slots per week",
        cta: "Get Free Quote"
      },
    ...
    {
      genre: "Recurring Landscape Maintenance",
      icon: Sprout,
      color: "from-teal-500 to-teal-600",
      offer: {
        headline: "Free Landscape Maintenance Plan & Quote",
        tagline: "[Recurring Revenue] — Custom seasonal maintenance plan for your property",
        price: "Free",
        originalPrice: "$150",
        savings: "Complimentary",
        includes: ["Full property walk-through", "Seasonal service calendar (mow, prune, cleanup)", "Fixed monthly or seasonal pricing", "Priority scheduling for contract clients"],
        urgency: "Route capacity limited each season",
        cta: "Get My Maintenance Plan"
      },
      funnel: ["Google Ads / Nextdoor", "Landing page", "Plan request form", "On-site walk-through", "Proposal delivered", "Contract signed", "Recurring service begins"],
      topPlatforms: ["Google Ads", "Nextdoor", "Facebook"],
      seasonality: "Peak: Spring (Feb–Apr) and Fall (Sep–Oct)"
    },
    {
      genre: "Commercial Grounds",
      icon: Building2,
  ...
  faqCategories: [
    {
      ...
      faqs: [
        ...
        {
          question: "Is local SEO worth it for a small tree service or landscape maintenance business?",
          answer: "Yes — local SEO is the highest-ROI long-term marketing investment for a small tree service or landscape maintenance business because it builds organic visibility that compounds over time without a per-click cost. A well-optimized Google Business Profile with strong review velocity consistently generates inbound calls without ongoing ad spend. The tradeoff is time: local SEO takes 60 to 90 days to show measurable movement. For faster results in the first 90 days, run local SEO in parallel with Google Local Services Ads."
        }
      ]
    },
    {
    ...
    },
    {
      ...
      faqs: [
        ...
        {
          question: "Does GrowSmallBiz work with recurring landscape maintenance and commercial grounds companies?",
          answer: "Yes — GrowSmallBiz works with landscape maintenance companies whose primary goal is building recurring residential routes, HOA contracts, and commercial grounds accounts. The buyer journey for recurring maintenance is different from emergency tree service: homeowners and property managers compare reviews, response speed, and reliability before signing a multi-month or annual contract. Our approach combines a conversion-focused website, local SEO targeting queries like landscape maintenance company near me and landscape maintenance service Danville CA, Google Ads campaigns for seasonal push periods, and automated follow-up sequences for quote requests — so recurring-contract leads don't go cold before you close them."
        }
      ]
    },
    {
...
const TreeLawnLandscapingMarketingPage = () => {
  return /* @__PURE__ */ jsxDEV(NichePage, { config: treeLawnLandscapingConfig }, void 0, false, {
    fileName: "/dev-server/src/pages/industries/tree-lawn-landscaping/index.tsx",
    lineNumber: 5,
    columnNumber: 10
  }, void 0);
};
export {
  TreeLawnLandscapingMarketingPage as default
};
