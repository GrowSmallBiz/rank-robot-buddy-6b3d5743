...
const ServiceCardLarge = ({
  ...
  "div",
  {
    ...
    children: [
      ...
      /* @__PURE__ */ jsx(Button, { variant: "outline", size: "lg", asChild: true, className: "w-fit", children: href.startsWith("http") ? /* @__PURE__ */ jsxs("a", { href, target: "_blank", rel: "noopener noreferrer", children: [
        "Learn More ",
        /* @__PURE__ */ jsx(ArrowRight, { className: "w-4 h-4 ml-2" })
      ] }) : /* @__PURE__ */ jsxs(Link, { to: href, children: [
        "Learn More ",
        /* @__PURE__ */ jsx(ArrowRight, { className: "w-4 h-4 ml-2" })
      ] }) })
    ]
    ...
    /* @__PURE__ */ jsxs("main", { id: "main-content", children: [
      /* @__PURE__ */ jsxs("section", { className: "hero-section", children: [
        ...
        /* @__PURE__ */ jsx("div", { className: "container mx-auto px-4 relative z-10", children: /* @__PURE__ */ jsxs("div", { className: "max-w-4xl mx-auto text-center", children: [
          ...
          /* @__PURE__ */ jsx("div", { className: "flex justify-center pt-4 animate-fade-up", style: { animationDelay: "0.2s" }, children: /* @__PURE__ */ jsx(Button, { variant: "hero", size: "xl", asChild: true, children: /* @__PURE__ */ jsxs("a", { href: strategySessionUrl, target: "_blank", rel: "noopener noreferrer", children: [
            "Schedule Strategy Call ",
            /* @__PURE__ */ jsx(ArrowRight, { className: "w-5 h-5 ml-2" })
          ] }) }) }),
          /* @__PURE__ */ jsx("div", { className: "grid grid-cols-2 md:grid-cols-4 gap-4 mt-10 animate-fade-up", style: { animationDelay: "0.25s" }, children: heroStats.map((stat, i) => /* @__PURE__ */ jsxs("div", { className: "rounded-xl p-5", style: { backgroundColor: "#0F2545" }, children: [
            /* @__PURE__ */ jsx("p", { className: "text-2xl md:text-3xl font-display font-bold text-primary mb-1", children: stat.number }),
            /* @__PURE__ */ jsx("p", { className: "text-sm text-foreground", children: stat.description })
          ] }, i)) }),
          /* @__PURE__ */ jsx("p", { className: "mt-6 text-sm text-muted-foreground animate-fade-up", style: { animationDelay: "0.3s" }, children: "Built for local service businesses that need more than disconnected tools and one-off tactics." })
        ] }) })
      ] }),
      /* @__PURE__ */ jsx("section", { className: "py-8", style: { backgroundColor: "#0F2545" }, children: /* @__PURE__ */ jsx("div", { className: "container mx-auto px-4", children: /* @__PURE__ */ jsx("div", { className: "grid md:grid-cols-3 divide-y md:divide-y-0 md:divide-x divide-white/10", children: proofMetrics.map((item, i) => /* @__PURE__ */ jsxs("div", { className: "text-center py-6 md:py-0 md:px-8", children: [
        /* @__PURE__ */ jsx("p", { className: "text-3xl md:text-4xl font-display font-bold text-primary mb-1", children: item.metric }),
        /* @__PURE__ */ jsx("p", { className: "text-sm text-foreground mb-1", children: item.label }),
        /* @__PURE__ */ jsx("p", { className: "text-xs", style: { color: "#94A3B8" }, children: item.attribution })
      ] }, i)) }) }) }),
      /* @__PURE__ */ jsx("section", { className: "py-16", children: /* @__PURE__ */ jsx("div", { className: "container mx-auto px-4", children: /* @__PURE__ */ jsxs("div", { className: "max-w-4xl mx-auto rounded-xl p-8 md:p-10", style: { backgroundColor: "#0F2545", border: "1px solid rgba(255,255,255,0.1)" }, children: [
        /* @__PURE__ */ jsx("h3", { className: "text-xl md:text-2xl font-display font-bold text-foreground mb-3", children: "Local Business Owners Are Already Asking AI These Questions" }),
        /* @__PURE__ */ jsx("p", { className: "text-sm text-foreground mb-6", children: "Before opening Google, local business owners are typing questions like these into ChatGPT, Gemini, and Perplexity:" }),
        /* @__PURE__ */ jsx("div", { className: "space-y-2", children: conversationalQueries.map((q, i) => /* @__PURE__ */ jsx("div", { className: "rounded-lg py-2.5 px-4 text-sm text-foreground", style: { backgroundColor: "#1B3A5C", borderLeft: "3px solid #F4803A" }, children: q }, i)) }),
        /* @__PURE__ */ jsx("p", { className: "text-base text-foreground mt-6", children: "If GrowSmallBiz isn't showing up as the answer to these questions, you're invisible to a growing segment of local business owners before they ever open Google. We change that." })
      ] }) }) }),
      ...
      /* @__PURE__ */ jsx("section", { id: "core-services", className: "py-24 lg:py-32 relative", style: { background: "linear-gradient(180deg, hsl(210 50% 8%) 0%, hsl(210 45% 14%) 50%, hsl(210 50% 8%) 100%)" }, children: /* @__PURE__ */ jsxs("div", { className: "container mx-auto px-4", children: [
        /* @__PURE__ */ jsx(
          SectionHeader,
          {
      ...
      /* @__PURE__ */ jsx("section", { className: "py-16", children: /* @__PURE__ */ jsx("div", { className: "container mx-auto px-4", children: /* @__PURE__ */ jsx("div", { className: "grid md:grid-cols-3 gap-6 max-w-6xl mx-auto", children: entityCards.map((card, i) => /* @__PURE__ */ jsxs("div", { className: "rounded-xl p-6", style: { backgroundColor: "#1B3A5C", border: "1px solid rgba(255,255,255,0.08)" }, children: [
        /* @__PURE__ */ jsx("span", { className: "inline-block px-3 py-1 rounded-lg text-xs font-semibold uppercase tracking-wider text-white mb-3", style: { backgroundColor: "#2BA3A0", fontSize: "11px" }, children: card.badge }),
        /* @__PURE__ */ jsx("h4", { className: "text-base font-display font-semibold text-foreground mb-2", children: card.title }),
        /* @__PURE__ */ jsx("p", { className: "text-sm text-foreground/80 leading-relaxed", children: card.body })
      ] }, i)) }) }) }),
      /* @__PURE__ */ jsx("section", { className: "py-12", children: /* @__PURE__ */ jsx("div", { className: "container mx-auto px-4", children: /* @__PURE__ */ jsxs("div", { className: "max-w-5xl mx-auto text-center", children: [
        /* @__PURE__ */ jsx("p", { className: "text-xs font-semibold uppercase tracking-widest text-primary mb-2", children: "QUICK NAVIGATION" }),
        /* @__PURE__ */ jsx("h3", { className: "text-xl font-display font-bold text-foreground mb-8", children: "On This Page" }),
        /* @__PURE__ */ jsx("div", { className: "grid grid-cols-3 gap-3 max-w-3xl mx-auto", children: navTiles.map((tile, i) => /* @__PURE__ */ jsxs(
          "button",
          {
            ...
            children: [
              /* @__PURE__ */ jsx(tile.icon, { className: "w-4 h-4 text-primary shrink-0" }),
              /* @__PURE__ */ jsx("span", { className: "text-sm text-foreground font-medium", children: tile.label })
            ]
          },
          i
        )) })
      ] }) }) }),
      /* @__PURE__ */ jsx("section", { id: "how-it-works", className: "py-24 lg:py-32", children: /* @__PURE__ */ jsxs("div", { className: "container mx-auto px-4", children: [
        /* @__PURE__ */ jsx(
          SectionHeader,
          {
        ...
        /* @__PURE__ */ jsx("div", { className: "max-w-6xl mx-auto mb-16", children: /* @__PURE__ */ jsxs("div", { className: "grid md:grid-cols-3 gap-0 relative", children: [
          /* @__PURE__ */ jsx("div", { className: "hidden md:block absolute top-10 left-[16.67%] right-[16.67%] h-0.5 bg-gradient-to-r from-primary via-muted-foreground/30 to-primary" }),
          systemSteps.map((step, si) => /* @__PURE__ */ jsxs("div", { className: "relative flex flex-col items-center text-center px-6 animate-fade-up", style: { animationDelay: `${si * 0.15}s` }, children: [
            /* @__PURE__ */ jsx("div", { className: "relative z-10 w-20 h-20 rounded-full flex items-center justify-center mb-4", style: { backgroundColor: "#F4803A" }, children: /* @__PURE__ */ jsx("span", { className: "text-2xl font-display font-bold text-white", children: step.number }) }),
            /* @__PURE__ */ jsx("h3", { className: "text-2xl font-display font-bold text-foreground mb-2", children: step.title }),
            /* @__PURE__ */ jsx("span", { className: "inline-block px-4 py-1.5 rounded-full text-xs font-semibold mb-6", style: { backgroundColor: "rgba(244,128,58,0.15)", color: "#F4803A" }, children: step.tag }),
            /* @__PURE__ */ jsx("ul", { className: "space-y-4 text-left w-full", children: step.items.map((item, ii) => /* @__PURE__ */ jsxs("li", { children: [
          ...
          "div",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsx(Button, { variant: "outline", size: "default", asChild: true, className: "w-fit", children: s.href ? /* @__PURE__ */ jsxs(Link, { to: s.href, children: [
                ...
                " ",
                /* @__PURE__ */ jsx(ArrowRight, { className: "w-4 h-4 ml-2" })
              ] }) : /* @__PURE__ */ jsxs("a", { href: strategySessionUrl, target: "_blank", rel: "noopener noreferrer", children: [
                s.cta,
                " ",
                /* @__PURE__ */ jsx(ArrowRight, { className: "w-4 h-4 ml-2" })
              ] }) })
      ...
      /* @__PURE__ */ jsx("section", { id: "growth-packages", className: "py-24 lg:py-32", children: /* @__PURE__ */ jsxs("div", { className: "container mx-auto px-4", children: [
        /* @__PURE__ */ jsx(
          SectionHeader,
          {
        ...
        /* @__PURE__ */ jsx("div", { className: "grid md:grid-cols-3 gap-8 max-w-6xl mx-auto mb-8", children: packages.map((pkg, i) => /* @__PURE__ */ jsxs(
          "div",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsx(Button, { variant: pkg.popular ? "hero" : "outline", size: "lg", asChild: true, className: "w-full", children: /* @__PURE__ */ jsxs("a", { href: strategySessionUrl, target: "_blank", rel: "noopener noreferrer", children: [
                "Schedule Strategy Call ",
                /* @__PURE__ */ jsx(ArrowRight, { className: "w-4 h-4 ml-2" })
              ] }) })
            ]
      ...
      /* @__PURE__ */ jsx("section", { id: "who-we-serve", className: "py-24 lg:py-32 relative", style: { background: "linear-gradient(180deg, hsl(210 50% 8%) 0%, hsl(210 45% 14%) 50%, hsl(210 50% 8%) 100%)" }, children: /* @__PURE__ */ jsxs("div", { className: "container mx-auto px-4", children: [
        /* @__PURE__ */ jsx(
          SectionHeader,
          {
      ...
      /* @__PURE__ */ jsx("section", { id: "why-growsmallbiz", className: "py-24 lg:py-32", children: /* @__PURE__ */ jsxs("div", { className: "container mx-auto px-4", children: [
        /* @__PURE__ */ jsx(
          SectionHeader,
          {
            subtitle: "Why Us",
        ...
        /* @__PURE__ */ jsx("div", { className: "grid md:grid-cols-3 gap-6 max-w-6xl mx-auto mb-12", children: whyCards.map((card, i) => /* @__PURE__ */ jsxs("div", { className: "rounded-xl p-6 animate-fade-up", style: { backgroundColor: "#1B3A5C", borderRadius: "12px", animationDelay: `${i * 0.08}s` }, children: [
          /* @__PURE__ */ jsx(card.icon, { className: "w-8 h-8 text-primary mb-4" }),
          /* @__PURE__ */ jsx("h3", { className: "text-[15px] font-display font-semibold text-foreground mb-2", children: card.title }),
          /* @__PURE__ */ jsx("p", { className: "text-[13px] text-foreground/80 leading-relaxed", children: card.body })
        ] }, i)) }),
      ...
      /* @__PURE__ */ jsx("div", { id: "faqs", children: /* @__PURE__ */ jsx(
        FAQSection,
        {
      ...
      /* @__PURE__ */ jsx("div", { id: "consultation", children: /* @__PURE__ */ jsx(ConsultationFormSection, {}) })
    ] }),
    /* @__PURE__ */ jsx(Footer, {})
  ] });
};
