...
import { TreePine, Calendar, MapPin, Shield, TrendingUp, Search, DollarSign, Bot, Star, Globe, Layers, Target, Phone, RefreshCw, Zap, BarChart3, Leaf, Sprout, Building2, Facebook, Instagram, Youtube, Linkedin, Eye, Heart, Gift, ClipboardList, FileText, UserPlus, MessageSquare, Lightbulb, Palette, Megaphone, PhoneCall } from "lucide-react";
...
const heroImage = "/assets/tree-lawn-landscaping-hero-D9qXprEJ.webp";
const websiteScreenshot = "/assets/tree-lawn-website-screenshot-C_HjK8aM.webp";
const treeServiceSeo = "/assets/tree-service-seo-keywords-B4M5NhaE.webp";
const lawnCareSeo = "/assets/lawn-care-seo-keywords-0b4LT-yc.webp";
...
const springLawnCare = "/assets/spring-lawn-care-ad-B1Af6d5S.webp";
...
const treeLawnLandscapingConfig = {
  ...
  // 4.1  PAGE META
  // ══════════════════════════════════════════════════════════════════════
  pageTitle: "Tree & Lawn Care Marketing Agency | GrowSmallBiz Digital Marketing",
  metaDescription: "Get more tree service, lawn care, and landscaping customers. GrowSmallBiz builds Local SEO, Google Ads, and AI-powered marketing for green industry contractors across the Bay Area.",
  ...
  marketingCampaigns: [
    ...
    },
    {
      ...
      offer: {
        ...
        urgency: "Spring schedule filling fast",
...
const TreeLawnLandscapingMarketingPage = () => {
  return /* @__PURE__ */ jsx(NichePage, { config: treeLawnLandscapingConfig });
};
export {
