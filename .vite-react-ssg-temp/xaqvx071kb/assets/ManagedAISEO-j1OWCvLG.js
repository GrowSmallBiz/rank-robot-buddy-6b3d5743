...
const pillarGeo = "/assets/pillar-geo-D9lgb_Vt.webp";
...
const ManagedAISEO = () => {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "min-h-screen bg-background", children: [
    /* @__PURE__ */ jsxs(Head, { children: [
      /* @__PURE__ */ jsx("title", { children: "AI-Powered SEO That Gets Local Service Businesses Found First | GrowSmallBiz" }),
    ...
    /* @__PURE__ */ jsxs("main", { id: "main-content", className: "min-h-screen bg-background pt-20", children: [
      ...
      /* @__PURE__ */ jsx("section", { className: "py-20 lg:py-28", style: { background: "linear-gradient(180deg, hsl(210 50% 8%) 0%, hsl(210 45% 14%) 50%, hsl(210 50% 8%) 100%)" }, children: /* @__PURE__ */ jsxs("div", { className: "container mx-auto px-4", children: [
        ...
        /* @__PURE__ */ jsx("div", { className: "max-w-5xl mx-auto animate-fade-up", children: /* @__PURE__ */ jsxs("div", { className: "feature-card-teal p-8 md:p-12", children: [
          ...
          /* @__PURE__ */ jsx("div", { className: "mt-8 pt-8 border-t border-[hsl(188_78%_41%_/_0.3)]", children: /* @__PURE__ */ jsx("p", { className: "text-lg font-medium text-foreground text-center max-w-3xl mx-auto", children: "The result is a search presence that compounds month over month, building lasting visibility and a reliable flow of qualified local leads." }) })
        ] }) })
      ] }) }),
      ...
      /* @__PURE__ */ jsx("section", { className: "py-20 lg:py-28", children: /* @__PURE__ */ jsxs("div", { className: "container mx-auto px-4", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "max-w-5xl mx-auto grid lg:grid-cols-2 gap-8 animate-fade-up", children: [
          /* @__PURE__ */ jsxs("div", { className: "feature-card-teal p-8", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "relative max-w-5xl mx-auto", children: [
          ...
          /* @__PURE__ */ jsx("div", { className: "space-y-16", children: processSteps.map((step, index) => {
            ...
            return /* @__PURE__ */ jsxs("div", { className: "relative animate-fade-up", style: { animationDelay: `${index * 0.1}s` }, children: [
              ...
              /* @__PURE__ */ jsx("div", { className: `md:w-[calc(50%-2rem)] ${isLeft ? "md:mr-auto" : "md:ml-auto"}`, children: /* @__PURE__ */ jsxs("div", { className: "feature-card-teal p-8", children: [
      ...
      /* @__PURE__ */ jsx("section", { className: "py-16 bg-background", children: /* @__PURE__ */ jsxs("div", { className: "container mx-auto max-w-6xl px-4", children: [
        /* @__PURE__ */ jsx("p", { className: "text-center text-primary font-bold tracking-widest uppercase text-[13px] mb-10", children: "Why Local SEO Matters Now" }),
        /* @__PURE__ */ jsx("div", { className: "grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-8", children: [
          {
            number: "46%",
        ...
        ].map((stat, i) => /* @__PURE__ */ jsxs("div", { className: "text-center md:text-left", children: [
          /* @__PURE__ */ jsx(
            "div",
            {
          ...
          /* @__PURE__ */ jsx("p", { className: "text-foreground/90 text-[15px] md:text-base font-medium leading-snug mb-2", children: stat.descriptor }),
          /* @__PURE__ */ jsxs("p", { className: "text-foreground/50 text-xs italic", children: [
            "—",
            " ",
            /* @__PURE__ */ jsx(
              "a",
