...
import { Stethoscope, Search, DollarSign, Phone, Star, Target, Users, Sparkles, AlertTriangle, Facebook, BarChart3, Instagram, MapPin, Globe, Mail, Eye, RefreshCw, Zap, CalendarCheck, Calendar, Smile, Gift, UserPlus, MessageSquare, Shield, Megaphone, Bot } from "lucide-react";
...
const dentalHeroImage = "/assets/industry-dental-hero-DsGi_3Ic.webp";
const portfolioDentalWebsite = "/assets/portfolio-dental-website-sTYg7Ful.webp";
const dentalConfig = {
  ...
  h1Line1: "Dental Marketing That Fills Your Chair with",
  h1Line2: "",
  ...
  sessionReminderWorkflows: [
    {
      sessionType: "New Patient First Appointment",
      icon: CalendarCheck,
      color: "blue",
    ...
    {
      sessionType: "Treatment Plan Appointment",
      icon: Stethoscope,
      color: "emerald",
    ...
    {
      sessionType: "Recall / Hygiene Visit",
      icon: Calendar,
      color: "amber",
  ...
  marketingCampaigns: [
    {
      genre: "Dental Implants & All-on-4",
      icon: Stethoscope,
      color: "from-rose-500 to-pink-500",
      offer: {
        headline: "Complimentary Implant Consultation + CBCT Review",
        tagline: "Start your smile restoration journey",
        price: "Free",
        originalPrice: "$350",
        savings: "Complimentary",
        includes: ["Comprehensive implant evaluation", "CBCT scan review", "All-on-4 / full-arch options", "Custom treatment plan & pricing"],
        urgency: "Limited implant consultations per month",
        cta: "Book Implant Consultation"
      },
      funnel: ["Google PPC / LSA → Implant Landing Page", "Form → AI follow-up", "Consultation → Treatment Plan"],
      topPlatforms: ["Google PPC", "Google LSA"],
      seasonality: "Year-round, peaks January and May"
    },
    {
      genre: "Smile Makeover & Veneers",
      icon: Sparkles,
      color: "from-violet-500 to-purple-500",
      offer: {
        headline: "Free Smile Design Consultation",
        tagline: "See your transformation before you commit",
        price: "Free",
        originalPrice: "$250",
        savings: "Complimentary",
        includes: ["Digital smile design preview", "Veneers vs. bonding consultation", "Before/after gallery review", "Custom treatment plan"],
        urgency: "Limited smile design consultations per month",
        cta: "See Your New Smile"
      },
      funnel: ["Google PPC / Instagram → Smile Makeover Landing Page", "Form → AI follow-up", "Consultation → Treatment Plan"],
      topPlatforms: ["Google PPC", "Instagram"],
      seasonality: "Year-round, peaks January, May, and November"
    },
    {
      genre: "Invisalign & Clear Aligners",
      icon: Smile,
      color: "from-emerald-500 to-teal-500",
      offer: {
        headline: "Free Invisalign Assessment",
        tagline: "Discover if clear aligners are right for you",
        price: "Free",
        originalPrice: "$200",
        savings: "Complimentary",
        includes: ["Invisalign candidacy scan", "Treatment timeline estimate", "Financing options review", "Straight smile preview"],
        urgency: "Limited Invisalign assessments per month",
        cta: "Book Invisalign Assessment"
      },
      funnel: ["Google PPC / Meta → Invisalign Landing Page", "Form → AI follow-up", "Consultation → Treatment Start"],
      topPlatforms: ["Google PPC", "Meta/Facebook"],
      seasonality: "Year-round, peaks January and September"
    }
  ],
  seasonalCampaigns: [
...
Every article passes a six-dimension quality scoring process — factuality, authority, content hierarchy, information gain, accuracy, and format — before publication. We don't publish generic dental health articles. Every piece is built around your specific services, service area, and competitive positioning.` },
  ...
  caseStudyLinks: [
    {
      title: "Dental Marketing Case Study",
...
const DentalMarketingPage = () => {
  return /* @__PURE__ */ jsxDEV(NichePage, { config: dentalConfig }, void 0, false, {
    fileName: "/dev-server/src/pages/industries/dental-marketing/index.tsx",
    lineNumber: 5,
    columnNumber: 10
  }, void 0);
};
export {
  DentalMarketingPage as default
};
