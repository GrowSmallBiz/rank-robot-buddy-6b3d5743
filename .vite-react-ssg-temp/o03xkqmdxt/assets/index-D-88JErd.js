...
import { Sparkles, Search, Users, Instagram, Star, RefreshCw, DollarSign, Target, Heart, Facebook, BarChart3, Phone, Globe, MapPin, Mail, Eye, Zap, CalendarCheck, Calendar, UserPlus, Gift, MessageSquare, Palette, Shield, Megaphone, Bot } from "lucide-react";
...
const medSpaHeroImage = "/assets/industry-medspa-hero-v2-CnNfmLi7.jpg";
const portfolioMedSpaWebsite = "/assets/portfolio-medspa-website-ClzNSAAS.webp";
const medSpaConfig = {
  ...
  metaKeywords: "medical spa marketing, digital marketing for med spas, AI marketing solutions, SEO for medical spas, client acquisition strategies, Google Ads for med spas, marketing challenges in med spas, attract high-value clients",
  ...
  badgeIcon: Sparkles,
  h1Line1: "AI-Powered Med Spa Marketing: Fill Your Calendar with Premium Clients",
  h1Line2: "",
  h1Highlight: "",
  ...
  seoKeywordCategories: {
    ...
    skincare: {
      label: "Skin Care & Facial Treatments",
      icon: Heart,
      image: medSpaHeroImage,
      keywords: [
        "HydraFacial near me",
  ...
  sessionReminderWorkflows: [
    ...
    {
      sessionType: "Treatment Appointment",
      icon: Sparkles,
      color: "emerald",
    ...
    {
      sessionType: "Follow-Up / Touch-Up Visit",
      icon: Calendar,
      color: "amber",
  ...
  marketingCampaigns: [
    {
      genre: "New Client Special — General",
      icon: UserPlus,
    ...
    {
      genre: "Membership — Recurring Revenue",
      icon: Heart,
    ...
    {
      genre: "Client Recall & Reactivation",
      icon: RefreshCw,
  ...
  caseStudyLinks: [
    {
      title: "Med Spa Marketing Case Study",
...
const MedSpaMarketingPage = () => {
  return /* @__PURE__ */ jsxDEV(NichePage, { config: medSpaConfig }, void 0, false, {
    fileName: "/dev-server/src/pages/industries/med-spa-marketing/index.tsx",
    lineNumber: 5,
    columnNumber: 10
  }, void 0);
};
export {
  MedSpaMarketingPage as default
};
