...
import { P as P2 } from "./PersonCTA-B97lddt0.js";
import { C } from "./CardCTA-_OitSbFr.js";
        ...
        children: [
          ...
          /* @__PURE__ */ jsxDEV("div", { className: "flex flex-col md:flex-row items-center gap-6 md:gap-10", children: [
            /* @__PURE__ */ jsxDEV("div", { className: "flex-shrink-0 text-center", children: [
              ...
              /* @__PURE__ */ jsxDEV("h3", { className: "mt-3 text-base font-display font-semibold text-foreground", children: baseContactCTA.name }, void 0, false, {
                fileName: "/dev-server/src/components/services/StickyCardCTA.tsx",
                lineNumber: 128,
                columnNumber: 15
              }, void 0),
            ...
            /* @__PURE__ */ jsxDEV("div", { className: "flex-1 text-center md:text-left", children: [
              /* @__PURE__ */ jsxDEV("h3", { className: "text-2xl md:text-3xl lg:text-4xl font-display font-bold mb-3 leading-tight bg-gradient-heading bg-clip-text text-transparent", children: title }, void 0, false, {
                fileName: "/dev-server/src/components/services/StickyCardCTA.tsx",
                lineNumber: 134,
                columnNumber: 15
              }, void 0),
