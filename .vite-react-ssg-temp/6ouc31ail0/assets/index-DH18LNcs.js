...
import { Stethoscope, Search, DollarSign, Phone, Star, Target, Users, Sparkles, AlertTriangle, Facebook, BarChart3, Instagram, MapPin, Globe, Mail, Eye, RefreshCw, Zap, CalendarCheck, Calendar, Gift, UserPlus, MessageSquare, Shield, Megaphone, Bot } from "lucide-react";
...
const dentalConfig = {
  ...
  marketingCampaigns: [
    ...
    {
      genre: "Cosmetic Consultation — Implants/Veneers",
      icon: Sparkles,
...
const DentalMarketingPage = () => {
  return /* @__PURE__ */ jsx(NichePage, { config: dentalConfig });
};
export {
