...
const LocalSEOHvacPlumbingElectrical = () => {
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    /* @__PURE__ */ jsxs(Head, { children: [
      /* @__PURE__ */ jsx("title", { children: "How Local SEO Helped HVAC, Plumbing & Electrical Contractors Own Local Search Businesses | GrowSmallBiz" }),
      /* @__PURE__ */ jsx("meta", { name: "description", content: "See how GrowSmallBiz used local SEO to put HVAC, plumbing, and electrical contractors at the top of local search — and keep them there." }),
      /* @__PURE__ */ jsx(
        "meta",
        {
          name: "description",
      ...
      /* @__PURE__ */ jsx("link", { rel: "canonical", href: "https://growsmallbiz.io/home-service-contractors/marketing-for-hvac-contractors/hvac-seo-case-study/" })
    ] }),
    /* @__PURE__ */ jsx(
      ArticleJsonLd,
      {
    ...
    /* @__PURE__ */ jsxs("main", { id: "main-content", children: [
      ...
      /* @__PURE__ */ jsx("section", { className: "py-6 bg-card/50 border-b border-border", children: /* @__PURE__ */ jsx("div", { className: "container mx-auto px-4 text-center", children: /* @__PURE__ */ jsxs("p", { className: "text-muted-foreground text-sm", children: [
        "Also see:",
        " ",
        /* @__PURE__ */ jsx(Link, { to: "/home-service-contractors/marketing-for-hvac-contractors/hvac-google-ads-case-study/", className: "text-primary hover:underline font-medium", children: "Google PPC Case Studies for HVAC, Plumbing & Electrical →" })
      ] }) }) }),
