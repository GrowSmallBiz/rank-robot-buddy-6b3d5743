...
import { L as LocationJsonLd, C as CampaignResultsCards, t as tracyCards } from "./LocationJsonLd-Dlwu2N1P.js";
import "react";
...
const TracyCA = () => {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "min-h-screen bg-background", children: [
    /* @__PURE__ */ jsxs(Head, { children: [
      /* @__PURE__ */ jsx("title", { children: "Digital Marketing Agency in Tracy, CA | GrowSmallBiz" }),
      /* @__PURE__ */ jsx("meta", { name: "description", content: "GrowSmallBiz helps Tracy local service businesses rank higher and generate more leads with local SEO, Google Ads, website design, and AI-powered marketing automation." }),
      /* @__PURE__ */ jsx(
        "meta",
        {
          name: "description",
      ...
      /* @__PURE__ */ jsx("link", { rel: "canonical", href: "https://growsmallbiz.io/locations/tracy-ca/" })
    ] }),
    /* @__PURE__ */ jsx(
      LocationJsonLd,
      {
    ...
    /* @__PURE__ */ jsxs("main", { id: "main-content", children: [
      /* @__PURE__ */ jsxs("section", { className: "hero-section", children: [
        /* @__PURE__ */ jsx("img", { src: tracyHero, alt: "GrowSmallBiz digital marketing agency serving Tracy CA San Joaquin Valley local service businesses", width: 1920, height: 768, className: "absolute inset-0 w-full h-full object-cover" }),
        ...
        /* @__PURE__ */ jsx("div", { className: "container mx-auto px-4 relative z-10", children: /* @__PURE__ */ jsxs("div", { className: "max-w-4xl mx-auto text-center", children: [
          /* @__PURE__ */ jsxs("div", { className: "service-badge mb-4 animate-fade-up", children: [
            ...
            /* @__PURE__ */ jsx("span", { children: "Tracy, CA — Local Service Business Marketing | San Joaquin Valley Gateway City" })
          ] }),
          ...
          /* @__PURE__ */ jsx("p", { className: "max-w-3xl mx-auto text-base md:text-lg text-muted-foreground leading-relaxed animate-fade-up mt-6", style: { animationDelay: "0.1s" }, children: "Tracy is not a Bay Area suburb. It is San Joaquin County's fastest-growing gateway city — the first major Central Valley community on the I-205/I-580 corridor heading east from the Bay Area. It carries a large professional commuter population that works in the Bay Area and comes home to Tracy each evening, a steady wave of Bay Area families relocating for affordable homeownership, and a growing residential base that creates consistent demand for every local service category. The businesses that establish digital authority here now become the default choice for the households still arriving." }),
          /* @__PURE__ */ jsx("p", { className: "max-w-3xl mx-auto text-base md:text-lg text-muted-foreground leading-relaxed animate-fade-up mt-4", style: { animationDelay: "0.15s" }, children: "GrowSmallBiz is a digital marketing agency based in Danville — approximately 40 miles from Tracy via I-205/I-580. We build integrated marketing systems for local service businesses across Tracy and San Joaquin County. Contractors, dentists, restaurants, real estate professionals — if you serve Tracy clients, we are built for you." }),
          /* @__PURE__ */ jsxs(
            "div",
            {
      ...
      /* @__PURE__ */ jsx("section", { className: "py-16 md:py-24 bg-background", children: /* @__PURE__ */ jsxs("div", { className: "container mx-auto px-4 max-w-5xl", children: [
        /* @__PURE__ */ jsxs("div", { className: "text-center mb-12", children: [
          ...
          /* @__PURE__ */ jsxs("h2", { className: "text-3xl md:text-4xl font-display font-bold text-foreground", children: [
            ...
            " ",
            /* @__PURE__ */ jsx("span", { className: "text-transparent bg-clip-text bg-gradient-primary italic", children: "Tracy Bottom Line" })
          ] }),
          /* @__PURE__ */ jsx("p", { className: "text-lg text-muted-foreground mt-4 max-w-3xl mx-auto", children: "Tracy's SERP landscape is occupied by thin local pages and out-of-state template agencies ranking on domain authority alone. No agency currently offers Tracy service businesses an integrated marketing system — local SEO, paid ads, AI automation, and retention — under one coordinated strategy." }),
          /* @__PURE__ */ jsx("p", { className: "text-base text-muted-foreground mt-3 max-w-3xl mx-auto", children: "Subrata Guha, GrowSmallBiz founder, brings 30+ years of Fortune 500 sales, marketing, and growth strategy experience to the specific challenges of Tracy's commuter city market." })
        ] }),
      ...
      /* @__PURE__ */ jsx("section", { className: "py-16 md:py-24 bg-background", children: /* @__PURE__ */ jsxs("div", { className: "container mx-auto px-4 max-w-4xl", children: [
        ...
        /* @__PURE__ */ jsx("div", { className: "prose prose-lg prose-invert max-w-none space-y-6", children: /* @__PURE__ */ jsxs("p", { className: "text-foreground/90 leading-relaxed", children: [
          "According to ",
          ...
          /* @__PURE__ */ jsx("a", { href: "https://www.brightlocal.com/research/local-consumer-review-survey-2024/", target: "_blank", rel: "noopener noreferrer", className: "text-primary hover:underline", children: "BrightLocal research" }),
          " shows 81% of consumers use Google to evaluate local businesses — and ",
          /* @__PURE__ */ jsx("a", { href: "https://www.brightlocal.com/resources/local-seo-statistics/", target: "_blank", rel: "noopener noreferrer", className: "text-primary hover:underline", children: "56% of businesses have still not fully optimized their Google Business Profile" }),
          ". In a market growing as fast as Tracy, that optimization gap means real monthly revenue going to whoever shows up first."
        ] }) }),
        /* @__PURE__ */ jsx("div", { className: "mt-10 bg-primary/5 border-l-4 border-primary rounded-r-xl px-6 py-5", children: /* @__PURE__ */ jsx("p", { className: "text-lg md:text-xl font-semibold italic text-foreground/90", children: '"Tracy is the first major city where Bay Area families land when they leave. Every household that arrives is choosing a new HVAC contractor, dentist, restaurant, and real estate agent. The business that appears first in local search becomes the default choice — often for years."' }) })
      ] }) }),
      /* @__PURE__ */ jsx("section", { className: "py-16 md:py-24", style: { background: "linear-gradient(180deg, hsl(210 50% 8%) 0%, hsl(210 45% 14%) 50%, hsl(210 50% 8%) 100%)" }, children: /* @__PURE__ */ jsxs("div", { className: "container mx-auto px-4 max-w-5xl", children: [
        /* @__PURE__ */ jsxs("div", { className: "text-center mb-12", children: [
          /* @__PURE__ */ jsxs("span", { className: "inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-primary/10 border border-primary/20 text-primary text-sm font-medium mb-6", children: [
          ...
          /* @__PURE__ */ jsx("p", { className: "text-lg text-muted-foreground mt-4 max-w-3xl mx-auto", children: "Tracy's market rewards businesses that are visible at the right moment, responsive at the right speed, and trusted before first contact. An integrated system delivers all three — not as separate channel investments, but as a coordinated engine that compounds over time as Tracy's population continues to grow." })
        ] }),
        /* @__PURE__ */ jsx("div", { className: "hidden md:block overflow-x-auto mb-16", children: /* @__PURE__ */ jsxs("table", { className: "w-full text-sm border-collapse", children: [
          /* @__PURE__ */ jsx("thead", { children: /* @__PURE__ */ jsxs("tr", { children: [
            ...
            /* @__PURE__ */ jsx("th", { className: "p-3 text-left font-bold text-foreground bg-card/80 border border-border/60", children: "Tracy Business Impact" })
          ] }) }),
        ...
        /* @__PURE__ */ jsxs("div", { className: "mt-16 pt-10 border-t border-border/30", children: [
          ...
          /* @__PURE__ */ jsx("a", { href: strategyCallUrl, target: "_blank", rel: "noopener noreferrer", className: "inline-flex items-center gap-2 bg-primary/10 border border-primary/30 rounded-lg px-5 py-3 text-primary font-semibold hover:bg-primary/20 transition-colors", children: "→ Launch Google Ads for Your Tracy Business — Start Generating Leads This Week" })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "mt-16 pt-10 border-t border-border/30", children: [
          /* @__PURE__ */ jsxs("h3", { className: "text-2xl md:text-3xl font-display font-bold text-foreground mb-4", children: [
            "Show Up Above Every Competitor With a Google Trust Badge —",
            " ",
            /* @__PURE__ */ jsx("span", { className: "text-transparent bg-clip-text bg-gradient-primary", children: "More Tracy Leads, Pre-Qualified Before They Call" })
          ] }),
          ...
          /* @__PURE__ */ jsx("a", { href: strategyCallUrl, target: "_blank", rel: "noopener noreferrer", className: "inline-flex items-center gap-2 bg-primary/10 border border-primary/30 rounded-lg px-5 py-3 text-primary font-semibold hover:bg-primary/20 transition-colors", children: "→ Set Up Google LSA for Your Tracy Business — Get Verified Leads" })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "mt-16 pt-10 border-t border-border/30", children: [
          /* @__PURE__ */ jsxs("h3", { className: "text-2xl md:text-3xl font-display font-bold text-foreground mb-4", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "mt-16 pt-10 border-t border-border/30", children: [
          ...
          /* @__PURE__ */ jsx("a", { href: strategyCallUrl, target: "_blank", rel: "noopener noreferrer", className: "inline-flex items-center gap-2 bg-primary/10 border border-primary/30 rounded-lg px-5 py-3 text-primary font-semibold hover:bg-primary/20 transition-colors", children: "→ Get a Conversion-Focused Website Built for Tracy — See Our Work" })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "mt-16 pt-10 border-t border-border/30", children: [
          /* @__PURE__ */ jsxs("h3", { className: "text-2xl md:text-3xl font-display font-bold text-foreground mb-4", children: [
            "Every Missed Call Is a Lost Tracy Job.",
            " ",
            /* @__PURE__ */ jsx("span", { className: "text-transparent bg-clip-text bg-gradient-primary", children: "Our AI Receptionist Follows Up in Seconds — So You Never Lose Another Lead to a Faster Competitor." })
          ] }),
          /* @__PURE__ */ jsxs("p", { className: "text-foreground/90 leading-relaxed mb-6", children: [
            "Research from ",
            /* @__PURE__ */ jsx("a", { href: "https://www.insidesales.com/response-time-matters/", target: "_blank", rel: "noopener noreferrer", className: "text-primary hover:underline", children: "MIT and InsideSales.com" }),
      ...
      /* @__PURE__ */ jsx("section", { className: "py-16 md:py-24 bg-background", children: /* @__PURE__ */ jsxs("div", { className: "container mx-auto px-4 max-w-5xl", children: [
        /* @__PURE__ */ jsxs("div", { className: "text-center mb-12", children: [
          ...
          /* @__PURE__ */ jsxs("h2", { className: "text-3xl md:text-4xl font-display font-bold text-foreground", children: [
            ...
            " ",
            /* @__PURE__ */ jsx("span", { className: "text-transparent bg-clip-text bg-gradient-primary italic", children: "See If We're the Right Fit for Tracy" })
          ] }),
          /* @__PURE__ */ jsx("p", { className: "text-lg text-muted-foreground mt-4 max-w-3xl mx-auto", children: "GrowSmallBiz works exclusively with local service businesses in Tracy and the surrounding San Joaquin Valley. We do not work with eCommerce stores, national retailers, or product-based businesses. Our systems are purpose-built for the verticals below — with genuine knowledge of Tracy's commuter timing pattern, affordability migration wave, and Central Valley seasonal demand." })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "grid md:grid-cols-2 gap-6", children: [
          /* @__PURE__ */ jsxs("div", { className: "feature-card-teal rounded-2xl p-6", children: [
            ...
            /* @__PURE__ */ jsx("h3", { className: "text-xl font-display font-bold text-foreground mb-3", children: "Home Service Contractors — HVAC, Roofing, Plumbing & Electrical: Fill Your Tracy Calendar Year-Round" }),
            /* @__PURE__ */ jsx("p", { className: "text-muted-foreground leading-relaxed", children: "Tracy's combination of rapid residential growth, extreme summer heat, and a large commuter household base creates consistent, year-round demand for home service contractors across every trade category. New construction throughout the I-205 corridor generates ongoing work for contractors who establish early relationships with developers and homeowners. Existing residential neighborhoods create steady replacement and maintenance demand. And Tracy's summer temperatures — regularly exceeding 100°F in July and August — create an emergency HVAC demand pattern that is more intense than any Bay Area city in GrowSmallBiz's service territory. We build the systems that make Tracy home service contractors visible when demand spikes, responsive when emergencies arrive, and trusted when new households are choosing their first local providers." })
          ] }),
          /* @__PURE__ */ jsxs("div", { className: "feature-card-teal rounded-2xl p-6", children: [
            ...
            /* @__PURE__ */ jsx("h3", { className: "text-xl font-display font-bold text-foreground mb-3", children: "Dentists, Med Spas & Wellness Professionals: Attract Tracy Patients Who Book and Stay" }),
            /* @__PURE__ */ jsx("p", { className: "text-muted-foreground leading-relaxed", children: "Tracy's growing population brings growing demand for dental care, chiropractic care, wellness services, and specialty health practices — and a population that is actively choosing new healthcare providers for the first time. Bay Area transplants are looking for a new family dentist, a new chiropractor, a new med spa or wellness practice in their new community. Chiropractic care is a high-consideration service: patients research before they commit, making Google Maps visibility and review depth the primary conversion levers. We build the complete digital presence — optimized Google Business Profile, review velocity campaigns, and AI booking follow-up — that positions Tracy practices to be the first and most trusted choice when a new household searches for care in their ZIP code." })
          ] }),
          /* @__PURE__ */ jsxs("div", { className: "feature-card-teal rounded-2xl p-6", children: [
            ...
            /* @__PURE__ */ jsx("h3", { className: "text-xl font-display font-bold text-foreground mb-3", children: "Restaurants & Hospitality: Fill More Tables, Build Loyal Regulars, Own Tracy's Dining Scene" }),
            /* @__PURE__ */ jsx("p", { className: "text-muted-foreground leading-relaxed", children: "Tracy's restaurant market is growing alongside its population, with a dining community that ranges from established local institutions to new concepts opening to serve the expanding residential base. Google Maps visibility and review recency are the primary discovery channels for Tracy's dining audience — particularly for households that are still exploring what the city has to offer. We build the full digital system — Local SEO, Google Maps optimization, social media, and VIP Club retention — that fills tables consistently, not just during peaks and weekends." })
          ] }),
          /* @__PURE__ */ jsxs("div", { className: "feature-card-teal rounded-2xl p-6", children: [
      ...
      /* @__PURE__ */ jsx("section", { className: "py-16 md:py-24", style: { background: "linear-gradient(180deg, hsl(210 50% 8%) 0%, hsl(210 45% 14%) 50%, hsl(210 50% 8%) 100%)" }, children: /* @__PURE__ */ jsxs("div", { className: "container mx-auto px-4 max-w-5xl", children: [
        ...
        /* @__PURE__ */ jsx(CampaignResultsCards, { cards: tracyCards }),
        /* @__PURE__ */ jsx("h3", { className: "text-xl md:text-2xl font-display font-bold text-foreground mb-4", children: "Single-Channel Marketing Doesn't Win in Tracy's Growing Market. Here's What Actually Moves the Needle." }),
        /* @__PURE__ */ jsx("p", { className: "text-foreground/80 leading-relaxed mb-6", children: "The agencies currently ranking for Tracy digital marketing keywords are running thin pages or domain-authority plays with no genuine Tracy market knowledge. Outperforming them requires not just better content — it requires an integrated system aligned with Tracy's specific commuter timing, first-mover opportunity, and seasonal demand patterns." })
      ] }) }),
      /* @__PURE__ */ jsx("section", { className: "py-16 md:py-24 bg-background", children: /* @__PURE__ */ jsxs("div", { className: "container mx-auto px-4 max-w-5xl", children: [
        /* @__PURE__ */ jsxs("div", { className: "text-center mb-12", children: [
          /* @__PURE__ */ jsxs("span", { className: "inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-primary/10 border border-primary/20 text-primary text-sm font-medium mb-6", children: [
          ...
          /* @__PURE__ */ jsxs("h2", { className: "text-3xl md:text-4xl font-display font-bold text-foreground", children: [
            ...
            " ",
            /* @__PURE__ */ jsx("span", { className: "text-transparent bg-clip-text bg-gradient-primary italic", children: "Tracy Business Before" })
          ] }),
          /* @__PURE__ */ jsx("p", { className: "text-lg text-muted-foreground mt-4 max-w-3xl mx-auto", children: "Tracy's SERPs are occupied by a thin local competitor and out-of-state agencies ranking on domain authority with no Central Valley market knowledge. Here is what makes the system GrowSmallBiz builds consistently outperform them in San Joaquin County's fastest-growing city:" })
        ] }),
      ...
      /* @__PURE__ */ jsx(
        FAQSection,
        {
          title: /* @__PURE__ */ jsxs(Fragment, { children: [
            ...
            /* @__PURE__ */ jsx("span", { className: "text-transparent bg-clip-text bg-gradient-primary italic", children: "Digital Marketing in Tracy" })
          ] }),
          faqs: [
      ...
      /* @__PURE__ */ jsx(ConsultationFormSection, { utmCampaign: "tracy-consultation", utmMedium: "tracy-ca" }),
