...
import { MapPin, ArrowRight, Phone, CheckCircle, Star, TrendingUp, Target, Users, Home, Heart, Building2, UtensilsCrossed, BarChart3, Shield } from "lucide-react";
import { L as LocationJsonLd, C as CampaignResultsCards, b as pleasantHillCards } from "./LocationJsonLd-Dlwu2N1P.js";
import "react";
...
const PleasantHillCA = () => {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "min-h-screen bg-background", children: [
    /* @__PURE__ */ jsxs(Head, { children: [
      /* @__PURE__ */ jsx("title", { children: "Digital Marketing Agency in Pleasant Hill, CA | GrowSmallBiz" }),
      /* @__PURE__ */ jsx("meta", { name: "description", content: "GrowSmallBiz helps Pleasant Hill local service businesses rank higher, generate more leads, and grow faster with AI-powered digital marketing. Schedule your free strategy call today." }),
      /* @__PURE__ */ jsx("link", { rel: "canonical", href: "https://growsmallbiz.io/locations/pleasant-hill-ca/" })
    ] }),
    /* @__PURE__ */ jsx(
      LocationJsonLd,
      {
    ...
    /* @__PURE__ */ jsxs("main", { id: "main-content", children: [
      /* @__PURE__ */ jsxs("section", { className: "hero-section", children: [
        /* @__PURE__ */ jsx("img", { src: pleasantHillHero, alt: "GrowSmallBiz digital marketing agency serving Pleasant Hill CA Contra Costa County local service businesses", width: 1920, height: 768, className: "absolute inset-0 w-full h-full object-cover" }),
        ...
        /* @__PURE__ */ jsx("div", { className: "container mx-auto px-4 relative z-10", children: /* @__PURE__ */ jsxs("div", { className: "max-w-4xl mx-auto text-center", children: [
          /* @__PURE__ */ jsxs("div", { className: "service-badge mb-4 animate-fade-up", children: [
            ...
            /* @__PURE__ */ jsx("span", { children: "Pleasant Hill, CA — Local Service Business Marketing | 680 Corridor | Contra Costa County" })
          ] }),
          /* @__PURE__ */ jsxs("h1", { className: "text-4xl md:text-5xl lg:text-6xl font-display font-bold text-foreground mb-3 animate-fade-up leading-tight", children: [
            ...
            " ",
            /* @__PURE__ */ jsx("span", { className: "text-transparent bg-clip-text bg-gradient-primary", children: "Full-Service Digital Marketing for Local Businesses" })
          ] }),
          /* @__PURE__ */ jsx("h2", { className: "max-w-3xl mx-auto text-xl md:text-2xl text-foreground/90 font-display font-semibold animate-fade-up mt-4", style: { animationDelay: "0.05s" }, children: "Sitting at the heart of the 680 corridor, Pleasant Hill's affluent homeowner base, BART-connected professionals, and Diablo Valley College population create high-intent demand for local service businesses — with the lowest keyword competition of any city we serve." }),
          /* @__PURE__ */ jsxs("div", { className: "flex flex-col sm:flex-row gap-4 justify-center pt-8 animate-fade-up", style: { animationDelay: "0.2s" }, children: [
          ...
          /* @__PURE__ */ jsx("p", { className: "text-primary text-sm font-medium mt-3 animate-fade-up", style: { animationDelay: "0.25s" }, children: "No commitment. No pressure. Just a clear path forward for your business." })
        ] }) })
      ] }),
      ...
      /* @__PURE__ */ jsx("section", { className: "py-16 md:py-24", style: { background: "linear-gradient(180deg, hsl(210 50% 8%) 0%, hsl(210 45% 14%) 50%, hsl(210 50% 8%) 100%)" }, children: /* @__PURE__ */ jsxs("div", { className: "container mx-auto px-4 max-w-5xl", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "prose prose-lg prose-invert max-w-4xl mx-auto space-y-5 mb-12", children: [
          ...
          /* @__PURE__ */ jsx("p", { className: "text-foreground/90 leading-relaxed", children: "Pleasant Hill's BART station connects residents to San Francisco, Oakland, and the broader Bay Area tech corridor. This means a significant portion of Pleasant Hill's population is digital-native, mobile-first, and accustomed to searching, reviewing, and booking services entirely on their phone. When they need a local service, they trust the businesses that rank, have strong reviews, and look credible online — and they hire those businesses instead of their competitors." }),
          /* @__PURE__ */ jsx("p", { className: "text-foreground/90 leading-relaxed", children: "GrowSmallBiz is based in Danville, CA — just 15 miles south of Pleasant Hill, within the same Contra Costa County. We know this market because we operate in it." })
        ] }),
        ...
        ].map((stat, i) => /* @__PURE__ */ jsxs("div", { className: "bg-card/50 border border-border/60 rounded-xl p-4 text-center", children: [
          /* @__PURE__ */ jsx("p", { className: "text-2xl font-display font-bold text-primary", children: stat.value }),
          /* @__PURE__ */ jsx("p", { className: "text-sm text-muted-foreground mt-1", children: stat.label })
        ] }, i)) }),
        /* @__PURE__ */ jsx("h3", { className: "text-2xl md:text-3xl font-display font-bold text-foreground mb-6 text-center", children: "Why Pleasant Hill Is a High-Priority Digital Marketing Market" }),
        /* @__PURE__ */ jsx("div", { className: "space-y-3 max-w-4xl mx-auto mb-12", children: [
        ...
        ].map((item, i) => /* @__PURE__ */ jsxs("div", { className: "flex gap-3", children: [
          /* @__PURE__ */ jsx("span", { className: "text-primary mt-1 flex-shrink-0", children: "●" }),
          /* @__PURE__ */ jsxs("p", { className: "text-foreground/90", children: [
            /* @__PURE__ */ jsx("span", { className: "font-bold text-foreground", children: item.label }),
            " ",
            item.body
          ] })
        ] }, i)) }),
        /* @__PURE__ */ jsx("div", { className: "max-w-4xl mx-auto bg-primary/5 border-l-4 border-l-primary rounded-r-xl p-6", children: /* @__PURE__ */ jsx("p", { className: "text-foreground/90 italic leading-relaxed", children: `"The Pleasant Hill SERP for 'digital marketing agency pleasant hill ca' is occupied by a Yelp listing at #1, a 509-word thin page at #2, and a Concord agency page ranking by accident at #8. The first purpose-built, locally-anchored Pleasant Hill page displaces all of them."` }) })
      ] }) }),
      /* @__PURE__ */ jsx("section", { className: "py-16 md:py-24 bg-background", children: /* @__PURE__ */ jsxs("div", { className: "container mx-auto px-4 max-w-5xl", children: [
        /* @__PURE__ */ jsxs("div", { className: "text-center mb-12", children: [
          /* @__PURE__ */ jsxs("span", { className: "inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-primary/10 border border-primary/20 text-primary text-sm font-medium mb-6", children: [
        ...
        /* @__PURE__ */ jsx("div", { className: "overflow-x-auto mb-14", children: /* @__PURE__ */ jsxs("table", { className: "w-full text-sm border-collapse", children: [
          /* @__PURE__ */ jsx("thead", { children: /* @__PURE__ */ jsxs("tr", { children: [
            ...
            /* @__PURE__ */ jsx("th", { className: "p-3 text-left font-bold text-foreground bg-card/80 border border-border/60", children: "What We Deliver" }),
            /* @__PURE__ */ jsx("th", { className: "p-3 text-left font-bold text-primary bg-card/80 border border-border/60", children: "Business Impact" })
          ] }) }),
          /* @__PURE__ */ jsx("tbody", { children: [
            ...
            /* @__PURE__ */ jsx("td", { className: "p-3 border border-border/60 font-semibold text-foreground bg-card/30", children: row.svc }),
            /* @__PURE__ */ jsx("td", { className: "p-3 border border-border/60 text-foreground/70", children: row.deliver }),
            /* @__PURE__ */ jsx("td", { className: "p-3 border border-border/60 text-primary font-bold", children: row.impact })
          ] }, i)) })
        ] }) }),
        [
          {
          ...
          },
          {
            ...
            body2: /* @__PURE__ */ jsxs(Fragment, { children: [
              ...
              " — and ",
              /* @__PURE__ */ jsx("a", { href: "https://www.brightlocal.com/resources/local-seo-statistics/", target: "_blank", rel: "noopener noreferrer", className: "text-primary hover:underline", children: "56% have not fully optimized their Google Business Profile" }),
          ...
          },
          {
            ...
            body2: /* @__PURE__ */ jsxs(Fragment, { children: [
              ...
              /* @__PURE__ */ jsx("a", { href: "https://www.insidesales.com/response-time-matters/", target: "_blank", rel: "noopener noreferrer", className: "text-primary hover:underline", children: "InsideSales research, leads contacted within 5 minutes are 21 times more likely to convert" }),
        ...
        ].map((svc, i) => /* @__PURE__ */ jsxs("div", { className: i === 0 ? "mt-0" : "mt-16 pt-10 border-t border-border/30", children: [
          /* @__PURE__ */ jsxs("h3", { className: "text-2xl md:text-3xl font-display font-bold text-foreground mb-4", children: [
            svc.num,
            ". ",
            /* @__PURE__ */ jsx("span", { className: "text-transparent bg-clip-text bg-gradient-primary", children: svc.title })
          ] }),
          /* @__PURE__ */ jsx("p", { className: "text-foreground/90 leading-relaxed mb-4", children: svc.body1 }),
          /* @__PURE__ */ jsx("p", { className: "text-foreground/90 leading-relaxed mb-6", children: svc.body2 }),
          svc.bullets.length > 0 && /* @__PURE__ */ jsx("ul", { className: "space-y-3 mb-6", children: svc.bullets.map((bullet, j) => /* @__PURE__ */ jsxs("li", { className: "flex gap-3", children: [
            /* @__PURE__ */ jsx("span", { className: "text-primary mt-1 flex-shrink-0", children: "●" }),
      ...
      /* @__PURE__ */ jsx("section", { className: "py-16 md:py-24", style: { background: "linear-gradient(180deg, hsl(210 50% 8%) 0%, hsl(210 45% 14%) 50%, hsl(210 50% 8%) 100%)" }, children: /* @__PURE__ */ jsxs("div", { className: "container mx-auto px-4 max-w-5xl", children: [
        /* @__PURE__ */ jsxs("div", { className: "text-center mb-12", children: [
          ...
          /* @__PURE__ */ jsxs("h2", { className: "text-3xl md:text-4xl font-display font-bold text-foreground", children: [
            ...
            " ",
            /* @__PURE__ */ jsx("span", { className: "text-transparent bg-clip-text bg-gradient-primary italic", children: "See If We're the Right Fit for Pleasant Hill" })
          ] }),
          /* @__PURE__ */ jsx("p", { className: "text-lg text-muted-foreground mt-4 max-w-3xl mx-auto", children: "GrowSmallBiz works exclusively with local service businesses in Pleasant Hill and surrounding Contra Costa County. We do not work with eCommerce stores, national retailers, or product-based businesses. Our systems are purpose-built for the verticals below — with genuine knowledge of Pleasant Hill's commercial corridors, competitive landscape, and the specific challenges of serving a BART-connected, high-income, review-driven market." })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "grid md:grid-cols-2 gap-6", children: [
          /* @__PURE__ */ jsxs("div", { className: "feature-card-teal rounded-2xl p-6", children: [
            ...
            /* @__PURE__ */ jsx("h3", { className: "text-xl font-display font-bold text-foreground mb-3", children: "HVAC & Home Service Contractors" }),
            /* @__PURE__ */ jsx("p", { className: "text-muted-foreground leading-relaxed", children: "Pleasant Hill's strong homeowner base and established residential neighborhoods create consistent, year-round demand for HVAC, plumbing, electrical, roofing, and home service contractors. The city's owner-occupied housing base means homeowners are actively maintaining and improving their properties — and they search Google first when they need help. Competitors from Walnut Creek and Concord are actively competing for the same customers online — visibility in local search and the Google Map Pack is the deciding factor in who captures the job." }),
          ...
          /* @__PURE__ */ jsxs("div", { className: "feature-card-teal rounded-2xl p-6", children: [
            ...
            /* @__PURE__ */ jsx("h3", { className: "text-xl font-display font-bold text-foreground mb-3", children: "Realtors & Real Estate Professionals" }),
            /* @__PURE__ */ jsx("p", { className: "text-muted-foreground leading-relaxed", children: "The Contra Costa County real estate market is competitive and active, with buyers relocating from San Francisco and Oakland and within the Diablo Valley itself. Pleasant Hill sits at the center of that movement — buyers looking for the 680 corridor lifestyle at a step below Walnut Creek price points. We help Pleasant Hill realtors build local SEO authority, digital advertising presence, and CRM automation needed to capture buyer and seller leads consistently — and stay top-of-mind through the longer decision cycles that real estate demands." }),
            /* @__PURE__ */ jsxs("ul", { className: "mt-3 space-y-2 text-sm text-muted-foreground", children: [
              /* @__PURE__ */ jsxs("li", { className: "flex gap-2", children: [
                /* @__PURE__ */ jsx("span", { className: "text-primary", children: "●" }),
      ...
      /* @__PURE__ */ jsx("section", { className: "py-16 md:py-24 bg-background", children: /* @__PURE__ */ jsxs("div", { className: "container mx-auto px-4 max-w-5xl", children: [
        ...
        /* @__PURE__ */ jsx(CampaignResultsCards, { cards: pleasantHillCards }),
        /* @__PURE__ */ jsx("h3", { className: "text-xl md:text-2xl font-display font-bold text-foreground mb-4", children: "Single-Channel Marketing Doesn't Win in Pleasant Hill's Competitive 680 Corridor. Here's What Actually Moves the Needle." }),
        /* @__PURE__ */ jsx("p", { className: "text-foreground/80 leading-relaxed mb-6", children: "With Walnut Creek and Concord businesses investing heavily in SEO and paid advertising, Pleasant Hill service businesses face real cross-city competition for every local search query. Outperforming that requires the compounding effect of SEO, paid ads, reputation, and AI automation all working together — not just one channel in isolation." }),
        /* @__PURE__ */ jsx("div", { className: "overflow-x-auto", children: /* @__PURE__ */ jsxs("table", { className: "w-full text-sm border-collapse", children: [
          /* @__PURE__ */ jsx("thead", { children: /* @__PURE__ */ jsxs("tr", { children: [
            /* @__PURE__ */ jsx("th", { className: "p-3 text-left font-bold text-foreground bg-card/80 border border-border/60", children: "Channel" }),
            /* @__PURE__ */ jsx("th", { className: "p-3 text-left font-bold text-foreground bg-card/80 border border-border/60", children: "Standalone Result" }),
            /* @__PURE__ */ jsx("th", { className: "p-3 text-left font-bold text-primary bg-card/80 border border-border/60", children: "GrowSmallBiz Integrated Result" })
          ] }) }),
          /* @__PURE__ */ jsx("tbody", { children: [
            ...
            /* @__PURE__ */ jsx("td", { className: "p-3 border border-border/60 font-semibold text-foreground bg-card/30", children: row.ch }),
            /* @__PURE__ */ jsx("td", { className: "p-3 border border-border/60 text-foreground/70", children: row.standalone }),
            /* @__PURE__ */ jsx("td", { className: "p-3 border border-border/60 text-primary font-bold", children: row.integrated })
          ] }, i)) })
        ] }) })
      ] }) }),
      /* @__PURE__ */ jsx("section", { className: "py-16 md:py-24", style: { background: "linear-gradient(180deg, hsl(210 50% 8%) 0%, hsl(210 45% 14%) 50%, hsl(210 50% 8%) 100%)" }, children: /* @__PURE__ */ jsxs("div", { className: "container mx-auto px-4 max-w-5xl", children: [
        /* @__PURE__ */ jsxs("div", { className: "text-center mb-12", children: [
          ...
          /* @__PURE__ */ jsxs("h2", { className: "text-3xl md:text-4xl font-display font-bold text-foreground", children: [
            ...
            " ",
            /* @__PURE__ */ jsx("span", { className: "text-transparent bg-clip-text bg-gradient-primary italic", children: "Pleasant Hill Business Before." })
          ] }),
          /* @__PURE__ */ jsx("p", { className: "text-lg text-muted-foreground mt-4 max-w-3xl mx-auto", children: "Pleasant Hill's SERP leaders are template agencies with no knowledge of Contra Costa Blvd, Diablo Valley College's daily population impact, or the BART-connected mobile search behavior that defines how Pleasant Hill residents find and hire service providers. Here is what makes the GrowSmallBiz system consistently outperform them in this market:" })
        ] }),
        /* @__PURE__ */ jsx("div", { className: "overflow-x-auto mb-10", children: /* @__PURE__ */ jsxs("table", { className: "w-full text-sm border-collapse", children: [
          /* @__PURE__ */ jsx("thead", { children: /* @__PURE__ */ jsxs("tr", { children: [
            /* @__PURE__ */ jsx("th", { className: "p-3 text-left font-bold text-foreground bg-card/80 border border-border/60", children: "Advantage" }),
            /* @__PURE__ */ jsx("th", { className: "p-3 text-left font-bold text-foreground bg-card/80 border border-border/60", children: "Template Agencies (Current SERP leaders)" }),
            /* @__PURE__ */ jsx("th", { className: "p-3 text-left font-bold text-primary bg-card/80 border border-border/60", children: "GrowSmallBiz" })
          ] }) }),
          /* @__PURE__ */ jsx("tbody", { children: [
            ...
            /* @__PURE__ */ jsx("td", { className: "p-3 border border-border/60 font-semibold text-foreground bg-card/30", children: row.adv }),
            /* @__PURE__ */ jsx("td", { className: "p-3 border border-border/60 text-foreground/70", children: row.them }),
            /* @__PURE__ */ jsx("td", { className: "p-3 border border-border/60 text-primary font-bold", children: row.us })
          ] }, i)) })
        ] }) }),
        /* @__PURE__ */ jsx("p", { className: "text-foreground/80 leading-relaxed max-w-4xl mx-auto", children: "The agencies currently ranking for Pleasant Hill digital marketing keywords built their pages from Bay Area templates applied identically across dozens of cities. Not one of them anchors their content to Contra Costa Blvd, Diablo Valley College, or the specific community dynamics of Pleasant Hill's position between Walnut Creek and Concord. GrowSmallBiz builds your Pleasant Hill strategy from the specific competitive landscape of this specific market — because that specificity is what converts this community's high-income, review-driven, mobile-first population into your clients." })
      ] }) }),
      /* @__PURE__ */ jsx(PersonCTA, { title: "Let's Build Your Growth Engine", description: "If you want AI-powered client acquisition systems, done-for-you execution, adaptive strategy, and a clear multi-channel dashboard without patching together disconnected tools, start with a free strategy call.", buttonText: "Schedule Strategy Call", buttonHref: strategyCallUrl, sectionClassName: "py-16" }),
      /* @__PURE__ */ jsx(
        FAQSection,
        {
          title: /* @__PURE__ */ jsxs(Fragment, { children: [
            "Frequently Asked Questions — ",
            /* @__PURE__ */ jsx("span", { className: "text-transparent bg-clip-text bg-gradient-primary italic", children: "Pleasant Hill Digital Marketing" })
          ] }),
          faqs: [
      ...
      /* @__PURE__ */ jsx("section", { className: "py-16 md:py-24", style: { background: "linear-gradient(180deg, hsl(210 50% 8%) 0%, hsl(210 45% 14%) 50%, hsl(210 50% 8%) 100%)" }, children: /* @__PURE__ */ jsx("div", { className: "container mx-auto px-4", children: /* @__PURE__ */ jsxs("div", { className: "max-w-4xl mx-auto text-center mb-10", children: [
        ...
        /* @__PURE__ */ jsx("p", { className: "text-primary text-sm font-medium mt-3", children: "No commitment. No pressure. Just a clear path forward for your business." })
      ] }) }) }),
      /* @__PURE__ */ jsx(ConsultationFormSection, { utmCampaign: "pleasant-hill-consultation", utmMedium: "pleasant-hill-ca" }),
      /* @__PURE__ */ jsx("section", { className: "py-12 bg-background", children: /* @__PURE__ */ jsxs("div", { className: "container mx-auto px-4", children: [
        ...
        ].map((city) => /* @__PURE__ */ jsxs(Link, { to: city.to, className: "inline-flex items-center gap-2 px-5 py-2.5 rounded-full border border-primary/30 bg-primary/5 text-primary hover:bg-primary/10 hover:border-primary/50 transition-all text-sm font-medium", children: [
