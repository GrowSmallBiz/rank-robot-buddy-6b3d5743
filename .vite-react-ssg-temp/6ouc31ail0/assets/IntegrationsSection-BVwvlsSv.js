...
const IntegrationsSection = () => {
  ...
  return /* @__PURE__ */ jsxs("section", { className: "py-2 !my-0 overflow-hidden bg-white", children: [
    /* @__PURE__ */ jsx("div", { className: "container mx-auto px-4 mb-6", children: /* @__PURE__ */ jsx("div", { className: "text-center mb-4", children: /* @__PURE__ */ jsxs("h2", { className: "text-3xl md:text-4xl lg:text-5xl font-bold text-gray-900", children: [
