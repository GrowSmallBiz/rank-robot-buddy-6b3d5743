...
import { MapPin, ArrowRight, Phone, CheckCircle, Target, Star, Brain, Search, Shield, Users, Eye, MessageSquare, Home, Heart, UtensilsCrossed, Building2, TrendingUp } from "lucide-react";
import { L as LocationJsonLd, C as CampaignResultsCards, p as pleasantonCards } from "./LocationJsonLd-Dlwu2N1P.js";
import "react";
...
const PleasantonCA = () => {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "min-h-screen bg-background", children: [
    /* @__PURE__ */ jsxs(Head, { children: [
      /* @__PURE__ */ jsx("title", { children: "Digital Marketing Agency in Pleasanton, CA | GrowSmallBiz" }),
      /* @__PURE__ */ jsx("meta", { name: "description", content: "GrowSmallBiz serves Pleasanton's two ZIP codes with integrated digital marketing for local service businesses. Local SEO, Google Ads, AI automation, reputation management. Get your free strategy session." }),
      /* @__PURE__ */ jsx("link", { rel: "canonical", href: "https://growsmallbiz.io/locations/pleasanton-ca/" })
    ] }),
    /* @__PURE__ */ jsx(
      LocationJsonLd,
      {
    ...
    /* @__PURE__ */ jsxs("main", { id: "main-content", children: [
      /* @__PURE__ */ jsxs("section", { className: "hero-section", children: [
        /* @__PURE__ */ jsx("img", { src: pleasantonHero, alt: "GrowSmallBiz digital marketing agency serving Pleasanton CA dual-ZIP local service businesses", width: 1920, height: 768, className: "absolute inset-0 w-full h-full object-cover" }),
        ...
        /* @__PURE__ */ jsx("div", { className: "container mx-auto px-4 relative z-10", children: /* @__PURE__ */ jsxs("div", { className: "max-w-4xl mx-auto text-center", children: [
          /* @__PURE__ */ jsxs("div", { className: "service-badge mb-4 animate-fade-up", children: [
            ...
            /* @__PURE__ */ jsx("span", { children: "Pleasanton, CA — Local Service Business Marketing | Dual-ZIP Tri-Valley Market" })
          ] }),
          ...
          /* @__PURE__ */ jsxs("div", { className: "flex flex-wrap justify-center gap-x-4 gap-y-2 mt-6 animate-fade-up text-sm text-foreground/60", style: { animationDelay: "0.3s" }, children: [
      ...
      /* @__PURE__ */ jsx("section", { className: "py-16 md:py-24", style: { background: "linear-gradient(180deg, hsl(210 50% 8%) 0%, hsl(210 45% 14%) 50%, hsl(210 50% 8%) 100%)" }, children: /* @__PURE__ */ jsxs("div", { className: "container mx-auto px-4 max-w-5xl", children: [
        ...
        /* @__PURE__ */ jsx("p", { className: "text-muted-foreground mt-6 max-w-4xl mx-auto animate-fade-up", children: "No long-term contracts: Month-to-month agreements keep us accountable. We earn your business every single month." })
      ] }) }),
      /* @__PURE__ */ jsx("section", { className: "py-16 md:py-24", style: { background: "linear-gradient(180deg, hsl(210 45% 14%) 0%, hsl(210 50% 8%) 50%, hsl(210 45% 14%) 100%)" }, children: /* @__PURE__ */ jsxs("div", { className: "container mx-auto px-4 max-w-5xl", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "prose prose-lg prose-invert max-w-none space-y-6 animate-fade-up", children: [
          /* @__PURE__ */ jsx("p", { className: "text-muted-foreground leading-relaxed", children: "Pleasanton presents a market opportunity unlike any other city in the Tri-Valley — and one that most digital marketing agencies, including its current SERP leaders, consistently misread. The reason is structural: Pleasanton is not one market. It is two meaningfully different markets sharing a city boundary." }),
          /* @__PURE__ */ jsx("h3", { className: "text-2xl font-display font-bold text-foreground mt-10", children: "Why Pleasanton Is the Tri-Valley's Most Structurally Complex — and Most Rewarding — Market" }),
      ...
      /* @__PURE__ */ jsx("section", { className: "py-16 md:py-24", style: { background: "linear-gradient(180deg, hsl(210 50% 8%) 0%, hsl(210 45% 14%) 50%, hsl(210 50% 8%) 100%)" }, children: /* @__PURE__ */ jsxs("div", { className: "container mx-auto px-4 max-w-5xl", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "prose prose-lg prose-invert max-w-none space-y-6 animate-fade-up", children: [
          /* @__PURE__ */ jsxs("p", { className: "text-muted-foreground leading-relaxed", children: [
            "According to ",
            /* @__PURE__ */ jsx("a", { href: "https://www.brightlocal.com/research/local-consumer-review-survey/", target: "_blank", rel: "noopener noreferrer", className: "text-primary hover:underline", children: "BrightLocal's 2023 Local Consumer Review Survey" }),
          ...
          /* @__PURE__ */ jsx("p", { className: "text-muted-foreground leading-relaxed", children: "Pleasanton's competitive pattern is distinctive: established businesses hold top 3 map positions with 150+ reviews accumulated over years, while newer or relocated businesses rank 4–10 with strong services but thin digital presence. The critical insight from Pleasanton market audits is that review recency matters as much as volume. A business with 200 reviews and 20 recent ones outperforms one with 300 but stalled activity. Review velocity is the hidden ranking lever — and it is the one most agencies do not actively manage." }),
          /* @__PURE__ */ jsx("div", { className: "feature-card-teal p-6 rounded-2xl mt-6", children: /* @__PURE__ */ jsx("p", { className: "text-foreground/90 italic text-lg leading-relaxed", children: `"Review velocity — the consistent rate of new reviews — is as important as total review count. A business with 200 reviews and 20 recent ones outperforms one with 300 but stalled activity. This is Pleasanton's hidden ranking lever."` }) })
        ] })
      ] }) }),
      /* @__PURE__ */ jsx("section", { className: "py-16 md:py-24", style: { background: "linear-gradient(180deg, hsl(210 45% 14%) 0%, hsl(210 50% 8%) 50%, hsl(210 45% 14%) 100%)" }, children: /* @__PURE__ */ jsxs("div", { className: "container mx-auto px-4 max-w-5xl", children: [
        /* @__PURE__ */ jsxs("div", { className: "text-center mb-12 animate-fade-up", children: [
        ...
        /* @__PURE__ */ jsx("div", { className: "hidden md:block overflow-x-auto mb-16 animate-fade-up", children: /* @__PURE__ */ jsxs("table", { className: "w-full text-left border-collapse", children: [
          /* @__PURE__ */ jsx("thead", { children: /* @__PURE__ */ jsxs("tr", { style: { backgroundColor: "hsla(174, 100%, 24%, 0.2)" }, children: [
            ...
            /* @__PURE__ */ jsx("th", { className: "p-4 text-foreground font-display font-bold border-b border-primary/20", children: "Pleasanton Business Impact" })
          ] }) }),
        ...
        /* @__PURE__ */ jsx("div", { className: "md:hidden space-y-4 mb-16", children: [
          ...
          /* @__PURE__ */ jsxs("p", { className: "text-muted-foreground text-sm", children: [
            /* @__PURE__ */ jsx("strong", { className: "text-foreground/80", children: "Pleasanton Impact:" }),
            " ",
            row.impact
          ] })
        ] }, i)) }),
        /* @__PURE__ */ jsxs("div", { className: "animate-fade-up mb-16", children: [
          /* @__PURE__ */ jsx("h3", { className: "text-2xl font-display font-bold text-foreground mb-6 text-center", children: "The Two-ZIP Strategy — Why Pleasanton Requires a Different Approach for 94566 and 94588" }),
          /* @__PURE__ */ jsx("p", { className: "text-muted-foreground text-center mb-8 max-w-4xl mx-auto", children: "Most agencies and most local service businesses treat Pleasanton as one market with one strategy. This is the single most consistent gap in Pleasanton's current SERP leaders — and it is directly exploitable with a properly structured dual-ZIP approach." }),
          /* @__PURE__ */ jsx("div", { className: "overflow-x-auto", children: /* @__PURE__ */ jsxs("table", { className: "w-full text-left border-collapse", children: [
            /* @__PURE__ */ jsx("thead", { children: /* @__PURE__ */ jsxs("tr", { style: { backgroundColor: "hsla(174, 100%, 24%, 0.2)" }, children: [
              /* @__PURE__ */ jsx("th", { className: "p-4 text-foreground font-display font-bold border-b border-primary/20" }),
              /* @__PURE__ */ jsx("th", { className: "p-4 text-foreground font-display font-bold border-b border-primary/20", children: "ZIP 94566 — Downtown & Established" }),
              /* @__PURE__ */ jsx("th", { className: "p-4 text-foreground font-display font-bold border-b border-primary/20", children: "ZIP 94588 — Hacienda & I-580" })
            ] }) }),
            /* @__PURE__ */ jsx("tbody", { children: [
              ...
              /* @__PURE__ */ jsx("td", { className: "p-4 text-foreground font-semibold align-top", children: row.label }),
              /* @__PURE__ */ jsx("td", { className: "p-4 text-muted-foreground align-top", children: row.zip1 }),
              /* @__PURE__ */ jsx("td", { className: "p-4 text-muted-foreground align-top", children: row.zip2 })
            ] }, i)) })
          ] }) }),
          /* @__PURE__ */ jsx("p", { className: "text-muted-foreground mt-6 max-w-4xl mx-auto", children: "A roofing contractor serving both 94566 and 94588 needs separate GBP service area configurations, separate landing pages targeting neighborhood-level keywords, and separate paid campaign ad schedules — evening and weekend for residential 94566 homeowners, business-hour targeting for 94588 Hacienda commercial properties. This is not complexity for its own sake. It is the structural reason GrowSmallBiz pages consistently outperform the single-strategy approaches of agencies currently ranking in Pleasanton's local search results." })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "space-y-16", children: [
          /* @__PURE__ */ jsxs("div", { className: "animate-fade-up", children: [
            /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3 mb-4", children: [
              ...
              /* @__PURE__ */ jsx("h3", { className: "text-2xl font-display font-bold text-foreground", children: "Get Found First When Pleasanton Customers Search for Your Services — Local SEO & Google Maps Domination" })
            ] }),
          ...
          /* @__PURE__ */ jsxs("div", { className: "animate-fade-up", children: [
            /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3 mb-4", children: [
              ...
              /* @__PURE__ */ jsx("h3", { className: "text-2xl font-display font-bold text-foreground", children: "Need Leads This Week, Not This Quarter? Google Ads That Deliver Pleasanton Customers on Day One." })
            ] }),
          ...
          /* @__PURE__ */ jsxs("div", { className: "animate-fade-up", children: [
            ...
            /* @__PURE__ */ jsx("p", { className: "text-muted-foreground mb-6", children: "BrightLocal's 2024 survey found that 88% of consumers say they would use a business that responds to all reviews, compared to just 47% for businesses that do not respond at all." }),
            /* @__PURE__ */ jsx(Button, { variant: "hero", size: "lg", asChild: true, children: /* @__PURE__ */ jsxs("a", { href: strategyCallUrl, target: "_blank", rel: "noopener noreferrer", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "animate-fade-up", children: [
            /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3 mb-4", children: [
              /* @__PURE__ */ jsx("div", { className: "w-10 h-10 rounded-lg bg-primary/10 flex items-center justify-center", children: /* @__PURE__ */ jsx(Eye, { className: "w-5 h-5 text-primary" }) }),
              /* @__PURE__ */ jsx("h3", { className: "text-2xl font-display font-bold text-foreground", children: "Your Website Should Be Your Best Salesperson. If It's Not Generating Pleasanton Leads Daily, It's Costing You Money." })
            ] }),
            /* @__PURE__ */ jsx("p", { className: "text-muted-foreground leading-relaxed mb-4", children: "A website that looks good but does not convert is an expensive brochure. In Pleasanton's high-expectation market, your website also sets the quality expectation before a client ever makes contact — a slow, generic, or outdated site signals the wrong things to a clientele that is accustomed to choosing premium providers. Desktop-first website design is a conversion disadvantage for Pleasanton's BART-commuter and Hacienda mobile-search audience." }),
            /* @__PURE__ */ jsxs("ul", { className: "space-y-2 text-muted-foreground mb-6", children: [
              /* @__PURE__ */ jsxs("li", { className: "flex items-start gap-2", children: [
                /* @__PURE__ */ jsx("span", { className: "text-primary mt-1", children: "•" }),
          ...
          /* @__PURE__ */ jsxs("div", { className: "animate-fade-up", children: [
            /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3 mb-4", children: [
              /* @__PURE__ */ jsx("div", { className: "w-10 h-10 rounded-lg bg-primary/10 flex items-center justify-center", children: /* @__PURE__ */ jsx(MessageSquare, { className: "w-5 h-5 text-primary" }) }),
              /* @__PURE__ */ jsx("h3", { className: "text-2xl font-display font-bold text-foreground", children: "Every Missed Call Is a Lost Job. Our AI Receptionist Follows Up in Seconds — So You Never Lose Another Pleasanton Lead to a Faster Competitor." })
            ] }),
            /* @__PURE__ */ jsx("p", { className: "text-muted-foreground leading-relaxed mb-4", children: "Research from MIT and InsideSales.com, published in the Harvard Business Review, found that responding within 5 minutes makes contact 100 times more likely than waiting 30 minutes. Invoca research shows businesses miss up to 35% of inbound calls during peak hours. In Pleasanton, where a single HVAC replacement averages $3,000 to $12,500 and a single new dental patient relationship can represent years of revenue, each missed call is a missed paycheck — and a relationship that goes to whoever answers next." }),
      ...
      /* @__PURE__ */ jsx("section", { className: "py-16 md:py-24", style: { background: "linear-gradient(180deg, hsl(210 50% 8%) 0%, hsl(210 45% 14%) 50%, hsl(210 50% 8%) 100%)" }, children: /* @__PURE__ */ jsxs("div", { className: "container mx-auto px-4 max-w-5xl", children: [
        /* @__PURE__ */ jsxs("div", { className: "text-center mb-12 animate-fade-up", children: [
          ...
          /* @__PURE__ */ jsxs("h2", { className: "text-3xl md:text-4xl font-display font-bold text-foreground", children: [
            ...
            " ",
            /* @__PURE__ */ jsx("span", { className: "text-transparent bg-clip-text bg-gradient-primary italic", children: "See If We're the Right Fit for Pleasanton" })
          ] })
        ] }),
        /* @__PURE__ */ jsx("p", { className: "text-muted-foreground text-lg mb-8 max-w-4xl mx-auto animate-fade-up", children: "GrowSmallBiz works exclusively with local service businesses in Pleasanton and the Tri-Valley. We do not work with eCommerce stores, national retailers, or product-based businesses. Our systems are purpose-built for the verticals below — with separate strategic tracks for 94566 and 94588 audiences where the market demands it." }),
        /* @__PURE__ */ jsx("div", { className: "grid md:grid-cols-2 gap-6", children: [
      ...
      /* @__PURE__ */ jsx("section", { className: "py-16 md:py-24", style: { background: "linear-gradient(180deg, hsl(210 45% 14%) 0%, hsl(210 50% 8%) 50%, hsl(210 45% 14%) 100%)" }, children: /* @__PURE__ */ jsxs("div", { className: "container mx-auto px-4 max-w-5xl", children: [
        ...
        /* @__PURE__ */ jsx(CampaignResultsCards, { cards: pleasantonCards }),
        /* @__PURE__ */ jsxs("div", { className: "animate-fade-up mt-12", children: [
          /* @__PURE__ */ jsx("h3", { className: "text-2xl font-display font-bold text-foreground mb-4 text-center", children: "Single-Channel Marketing Doesn't Win in Pleasanton Anymore. Here's What Actually Moves the Needle." }),
          /* @__PURE__ */ jsx("p", { className: "text-muted-foreground text-center mb-6 max-w-3xl mx-auto", children: "The current SERP leaders for Pleasanton keywords built durable rankings through single-channel SEO investments made years ago. Outperforming those rankings requires not just better content — it requires a fully integrated system that compounds across every channel simultaneously." }),
          /* @__PURE__ */ jsx("div", { className: "overflow-x-auto", children: /* @__PURE__ */ jsxs("table", { className: "w-full text-left border-collapse", children: [
            /* @__PURE__ */ jsx("thead", { children: /* @__PURE__ */ jsxs("tr", { style: { backgroundColor: "hsla(174, 100%, 24%, 0.2)" }, children: [
      ...
      /* @__PURE__ */ jsx("section", { className: "py-16 md:py-24", style: { background: "linear-gradient(180deg, hsl(210 50% 8%) 0%, hsl(210 45% 14%) 50%, hsl(210 50% 8%) 100%)" }, children: /* @__PURE__ */ jsxs("div", { className: "container mx-auto px-4 max-w-5xl", children: [
        /* @__PURE__ */ jsxs("div", { className: "text-center mb-12 animate-fade-up", children: [
          ...
          /* @__PURE__ */ jsxs("h2", { className: "text-3xl md:text-4xl font-display font-bold text-foreground", children: [
            ...
            " ",
            /* @__PURE__ */ jsx("span", { className: "text-transparent bg-clip-text bg-gradient-primary italic", children: "Why GrowSmallBiz Outperforms Every Agency That's Failed Your Pleasanton Business Before." })
          ] })
        ] }),
        /* @__PURE__ */ jsx("p", { className: "text-muted-foreground text-center mb-8 max-w-4xl mx-auto animate-fade-up", children: "Pleasanton's SERPs are led by well-resourced agencies and national players. None of them build separate strategies for 94566 and 94588. None address review velocity as a distinct ranking lever. None are based in the Tri-Valley with the market-specific knowledge that comes from proximity." }),
        ...
        /* @__PURE__ */ jsx("p", { className: "text-muted-foreground mt-8 max-w-4xl mx-auto animate-fade-up", children: "The agencies currently ranking for Pleasanton keywords were built from Bay Area templates that treat both ZIP codes identically. GrowSmallBiz builds your Pleasanton strategy from the actual competitive landscape of your specific ZIP code, your specific vertical, and your specific competitive position — because that specificity is what wins in Pleasanton's high-scrutiny local search environment." })
      ] }) }),
      /* @__PURE__ */ jsx("section", { className: "py-16 md:py-24", style: { background: "linear-gradient(180deg, hsl(210 45% 14%) 0%, hsl(210 50% 8%) 50%, hsl(210 45% 14%) 100%)" }, children: /* @__PURE__ */ jsxs("div", { className: "container mx-auto px-4 max-w-5xl", children: [
        /* @__PURE__ */ jsxs("div", { className: "text-center mb-12 animate-fade-up", children: [
          /* @__PURE__ */ jsx("p", { className: "text-primary font-medium mb-3 text-sm", children: "OUR PROCESS" }),
          /* @__PURE__ */ jsxs("h2", { className: "text-3xl md:text-4xl font-display font-bold text-foreground", children: [
            "What Working With GrowSmallBiz Actually Looks Like —",
            " ",
            /* @__PURE__ */ jsx("span", { className: "text-transparent bg-clip-text bg-gradient-primary italic", children: "Three Steps from Assessment to Growth" })
          ] })
        ] }),
        ...
        ].map((item, i) => /* @__PURE__ */ jsxs("div", { className: "feature-card-teal p-6 rounded-2xl animate-fade-up", style: { animationDelay: `${i * 0.05}s` }, children: [
          /* @__PURE__ */ jsx("p", { className: "text-primary font-semibold text-sm mb-2", children: item.step }),
          /* @__PURE__ */ jsx("h3", { className: "text-lg font-display font-bold text-foreground mb-3", children: item.title }),
          /* @__PURE__ */ jsx("p", { className: "text-muted-foreground text-sm leading-relaxed", children: item.text })
        ] }, i)) })
      ] }) }),
      ...
      /* @__PURE__ */ jsx(
        FAQSection,
        {
          title: /* @__PURE__ */ jsxs(Fragment, { children: [
            ...
            /* @__PURE__ */ jsx("span", { className: "text-transparent bg-clip-text bg-gradient-primary italic", children: "No Jargon, No Sales Pitch, Just Straight Answers About Digital Marketing in Pleasanton" })
          ] }),
