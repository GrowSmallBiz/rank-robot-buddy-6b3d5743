...
import { b as buildCtaUrl } from "./use-utm-CiJKCMCk.js";
...
const ConsultationFormSection = ({
  ...
  return /* @__PURE__ */ jsx("section", { ref: sectionRef, className: "py-16 md:py-24 relative overflow-hidden", style: { backgroundColor: "#2d465c" }, children: /* @__PURE__ */ jsx("div", { className: "container mx-auto px-4 relative z-10", children: /* @__PURE__ */ jsx(
    "div",
    {
      ...
      children: /* @__PURE__ */ jsxs("div", { className: "relative rounded-2xl p-8", style: { backgroundColor: "#191321" }, children: [
        ...
        ) : /* @__PURE__ */ jsx("div", { style: { width: "100%", height: iframeHeight } })
      ] })
    }
  ) }) });
};
