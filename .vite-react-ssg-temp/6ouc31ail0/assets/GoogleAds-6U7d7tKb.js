...
const heroGoogleAdsRoofing = "/assets/hero-google-ads-roofing-D9X2ivou.jpg";
const faqs = [
  {
...
const GoogleAds = () => {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "min-h-screen bg-background", children: [
    /* @__PURE__ */ jsxs(Head, { children: [
      /* @__PURE__ */ jsx("title", { children: "Google Ads Management for Small Businesses | GrowSmallBiz" }),
      /* @__PURE__ */ jsx(
        "meta",
        {
          name: "description",
      ...
      /* @__PURE__ */ jsx("link", { rel: "canonical", href: "https://growsmallbiz.io/services/paid-advertising/google-ads/" }),
      /* @__PURE__ */ jsx("meta", { property: "og:title", content: "Google Ads Management for Small Businesses — GrowSmallBiz" }),
      /* @__PURE__ */ jsx(
        "meta",
        {
      ...
      /* @__PURE__ */ jsx("meta", { property: "og:url", content: "https://growsmallbiz.io/services/paid-advertising/google-ads/" }),
      /* @__PURE__ */ jsx("meta", { name: "twitter:card", content: "summary_large_image" }),
      /* @__PURE__ */ jsx("meta", { name: "twitter:title", content: "Google Ads Management for Small Businesses — GrowSmallBiz" }),
      /* @__PURE__ */ jsx(
        "meta",
        {
    ...
    /* @__PURE__ */ jsxs("main", { id: "main-content", children: [
      /* @__PURE__ */ jsx("nav", { "aria-label": "Breadcrumb", className: "container mx-auto px-4 pt-6", children: /* @__PURE__ */ jsx(Breadcrumb, { children: /* @__PURE__ */ jsxs(BreadcrumbList, { children: [
        ...
        /* @__PURE__ */ jsx(BreadcrumbSeparator, {}),
        /* @__PURE__ */ jsx(BreadcrumbItem, { children: /* @__PURE__ */ jsx(BreadcrumbPage, { children: "Google Ads" }) })
      ] }) }) }),
      /* @__PURE__ */ jsxs("section", { className: "relative pt-12 pb-24 overflow-hidden", children: [
        /* @__PURE__ */ jsxs("div", { className: "absolute inset-0", children: [
          ...
          /* @__PURE__ */ jsx("div", { className: "absolute inset-0 bg-background/60" })
        ] }),
        ...
        /* @__PURE__ */ jsx("div", { className: "container mx-auto px-4 relative z-10", children: /* @__PURE__ */ jsxs("div", { className: "max-w-4xl mx-auto text-center space-y-8", children: [
          /* @__PURE__ */ jsx("div", { className: "animate-fade-up flex justify-center", children: /* @__PURE__ */ jsxs("span", { className: "inline-flex items-center gap-2 px-4 py-2 rounded-full bg-primary/10 border border-primary/20 text-primary text-sm font-medium", children: [
          ...
          /* @__PURE__ */ jsxs("h1", { className: "text-4xl md:text-5xl lg:text-6xl font-display font-bold text-foreground leading-tight animate-fade-up", children: [
            ...
            " ",
            /* @__PURE__ */ jsx("span", { className: "text-transparent bg-clip-text bg-gradient-primary", children: "Actually" }),
            " ",
            "Generate Leads"
          ] }),
          /* @__PURE__ */ jsx("p", { className: "text-lg md:text-xl text-muted-foreground leading-relaxed max-w-3xl mx-auto animate-fade-up", style: { animationDelay: "0.1s" }, children: "Stop paying for clicks that go nowhere. GrowSmallBiz builds and manages Google Ads campaigns exclusively for local service businesses — every dollar targeted, every lead tracked, every campaign tuned to grow your revenue." }),
          /* @__PURE__ */ jsxs("div", { className: "flex flex-col sm:flex-row gap-4 justify-center animate-fade-up", style: { animationDelay: "0.25s" }, children: [
      ...
      /* @__PURE__ */ jsx("section", { className: "py-16", style: { backgroundColor: "#1B2A4E" }, children: /* @__PURE__ */ jsxs("div", { className: "container mx-auto px-4", children: [
        ...
        /* @__PURE__ */ jsx("p", { className: "text-sm md:text-base text-white/70 text-center max-w-2xl mx-auto mb-12", children: "Verified benchmarks from WordStream's analysis of 16,000+ U.S. Google Ads campaigns." }),
        /* @__PURE__ */ jsx("div", { className: "grid grid-cols-2 lg:grid-cols-4 gap-8 max-w-5xl mx-auto", children: marketStats.map((stat, i) => /* @__PURE__ */ jsxs("div", { className: "text-center animate-fade-up", style: { animationDelay: `${i * 0.05}s` }, children: [
          ...
          /* @__PURE__ */ jsx("p", { className: "text-xs italic text-white/50", children: "Source: WordStream by LocaliQ 2025 Benchmarks" })
        ] }, i)) })
      ] }) }),
        ...
        "div",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxs("div", { className: "space-y-4 text-base md:text-lg text-muted-foreground leading-relaxed max-w-2xl mx-auto", children: [
              /* @__PURE__ */ jsx("p", { children: "GrowSmallBiz manages Google Ads for local service businesses in a market where paid visibility matters more than ever. AI Overviews now appear in 25% of Google searches, and organic click-through rates drop 58% on queries affected by them (Conductor 2026; Ahrefs 2026)." }),
      ...
      /* @__PURE__ */ jsx("section", { className: "py-24", children: /* @__PURE__ */ jsx("div", { className: "container mx-auto px-4", children: /* @__PURE__ */ jsxs("div", { className: "max-w-4xl mx-auto", children: [
        ...
        /* @__PURE__ */ jsx("div", { className: "space-y-4 mt-8", children: [
        ...
        ].map((item, i) => /* @__PURE__ */ jsxs("div", { className: "flex items-start gap-3 bg-card border border-border rounded-xl p-4 animate-fade-up", style: { animationDelay: `${i * 0.05}s` }, children: [
          /* @__PURE__ */ jsx(Zap, { className: "w-5 h-5 text-primary mt-0.5 shrink-0" }),
          /* @__PURE__ */ jsx("p", { className: "text-foreground text-sm", children: item })
        ] }, i)) }),
        /* @__PURE__ */ jsx("p", { className: "text-muted-foreground text-center mt-8 animate-fade-up", children: "The good news: every one of these problems is fixable with the right local PPC strategy." })
      ] }) }) }),
      ...
      /* @__PURE__ */ jsx("section", { className: "py-24", children: /* @__PURE__ */ jsx("div", { className: "container mx-auto px-4", children: /* @__PURE__ */ jsxs("div", { className: "max-w-5xl mx-auto", children: [
        ...
        /* @__PURE__ */ jsx("div", { className: "grid sm:grid-cols-2 gap-8 mt-12", children: [
          {
            icon: Search,
        ...
        ].map((svc, i) => /* @__PURE__ */ jsxs("div", { className: "feature-card-teal rounded-xl p-6 space-y-4 animate-fade-up", style: { animationDelay: `${i * 0.05}s` }, children: [
          ...
          /* @__PURE__ */ jsx("ul", { className: "space-y-2", children: svc.bullets.map((b, j) => /* @__PURE__ */ jsxs("li", { className: "flex items-start gap-2 text-sm text-muted-foreground", children: [
      ...
      /* @__PURE__ */ jsx("section", { id: "how-it-works", className: "py-24 bg-card", children: /* @__PURE__ */ jsx("div", { className: "container mx-auto px-4", children: /* @__PURE__ */ jsxs("div", { className: "max-w-5xl mx-auto", children: [
        ...
        /* @__PURE__ */ jsx("div", { className: "grid md:grid-cols-2 lg:grid-cols-3 gap-6 mt-12", children: [
          ...
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsx("div", { className: "w-10 h-10 rounded-full bg-primary/10 border border-primary/30 flex items-center justify-center mb-4", children: /* @__PURE__ */ jsx("span", { className: "text-sm font-bold text-primary", children: i + 1 }) }),
      ...
      /* @__PURE__ */ jsx("section", { className: "py-24", children: /* @__PURE__ */ jsx("div", { className: "container mx-auto px-4", children: /* @__PURE__ */ jsxs("div", { className: "max-w-5xl mx-auto", children: [
        ...
        /* @__PURE__ */ jsx("div", { className: "grid sm:grid-cols-2 lg:grid-cols-4 gap-6 mt-12", children: industryTiles.map((ind, i) => /* @__PURE__ */ jsxs(
          Link,
          {
            to: ind.href,
            ...
            style: { animationDelay: `${i * 0.05}s` },
            children: [
              /* @__PURE__ */ jsx("div", { className: "w-10 h-10 rounded-lg bg-primary/10 flex items-center justify-center", children: /* @__PURE__ */ jsx(ind.icon, { className: "w-5 h-5 text-primary" }) }),
              /* @__PURE__ */ jsx("p", { className: "text-sm font-display font-semibold text-foreground", children: ind.title }),
              /* @__PURE__ */ jsx("p", { className: "text-xs text-muted-foreground leading-relaxed", children: ind.description })
            ]
          },
          i
        )) })
      ...
      /* @__PURE__ */ jsx("section", { className: "py-24", children: /* @__PURE__ */ jsx("div", { className: "container mx-auto px-4", children: /* @__PURE__ */ jsxs("div", { className: "max-w-6xl mx-auto", children: [
        ...
        /* @__PURE__ */ jsx("div", { className: "grid md:grid-cols-2 gap-6 mt-12", children: caseStudyCards.map((card, i) => /* @__PURE__ */ jsxs(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxs("div", { className: "bg-gradient-primary px-6 py-4", children: [
                ...
                /* @__PURE__ */ jsx("p", { className: "text-xs italic text-primary-foreground/80 mt-1", children: card.timeframe })
              ] }),
              /* @__PURE__ */ jsxs("div", { className: "p-6 flex-1 flex flex-col gap-4", children: [
                /* @__PURE__ */ jsxs("div", { children: [
                  /* @__PURE__ */ jsx("p", { className: "text-xs font-semibold uppercase tracking-wider mb-2", style: { color: "hsl(180 60% 50%)" }, children: "Challenge" }),
                  /* @__PURE__ */ jsx("p", { className: "text-sm text-foreground leading-relaxed", children: card.challenge })
                ] }),
                /* @__PURE__ */ jsxs("div", { children: [
                  /* @__PURE__ */ jsx("p", { className: "text-xs font-semibold uppercase tracking-wider mb-2", style: { color: "hsl(180 60% 50%)" }, children: "Strategy" }),
                  /* @__PURE__ */ jsx("p", { className: "text-sm text-foreground leading-relaxed", children: card.strategy })
                ] }),
                /* @__PURE__ */ jsx("div", { className: "grid grid-cols-2 gap-3 pt-2", children: card.metrics.map((m, mi) => /* @__PURE__ */ jsxs("div", { className: "bg-background rounded-lg p-3 text-center", children: [
                  /* @__PURE__ */ jsx("p", { className: "text-lg font-display font-bold text-primary", children: m.value }),
                  /* @__PURE__ */ jsx("p", { className: "text-xs text-muted-foreground mt-1", children: m.label })
                ] }, mi)) }),
                /* @__PURE__ */ jsxs(
                  Link,
                  {
      ...
      /* @__PURE__ */ jsx("section", { className: "py-24 bg-background-alt", children: /* @__PURE__ */ jsx("div", { className: "container mx-auto px-4", children: /* @__PURE__ */ jsxs("div", { className: "max-w-6xl mx-auto", children: [
        /* @__PURE__ */ jsx(
          SectionHeader,
          {
        ...
        /* @__PURE__ */ jsxs("div", { className: "grid md:grid-cols-3 gap-6 mt-12", children: [
          /* @__PURE__ */ jsxs(
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ jsx("div", { className: "w-12 h-12 rounded-xl bg-primary/15 border border-primary/30 flex items-center justify-center", children: /* @__PURE__ */ jsx(Repeat, { className: "w-6 h-6 text-primary" }) }),
                /* @__PURE__ */ jsx("h3", { className: "text-xl font-display font-bold text-foreground", children: "Retargeting That Closes the Loop" }),
                /* @__PURE__ */ jsx("p", { className: "text-muted-foreground leading-relaxed", children: "Most clicks do not convert on the first visit. Retargeting keeps your business in front of the people who already showed intent — across Google's display network, YouTube, and social — so the lead you paid for the first time has a second, third, and fourth chance to come back and book." })
              ]
            }
          ),
          /* @__PURE__ */ jsxs(
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
                  /* @__PURE__ */ jsx("div", { className: "w-12 h-12 rounded-xl bg-primary/15 border border-primary/30 flex items-center justify-center", children: /* @__PURE__ */ jsx(Mail, { className: "w-6 h-6 text-primary" }) }),
                  /* @__PURE__ */ jsx("div", { className: "w-12 h-12 rounded-xl bg-primary/15 border border-primary/30 flex items-center justify-center", children: /* @__PURE__ */ jsx(MessageSquare, { className: "w-6 h-6 text-primary" }) })
                ] }),
                /* @__PURE__ */ jsx("h3", { className: "text-xl font-display font-bold text-foreground", children: "Lead Nurture That Converts Inquiries Into Bookings" }),
                /* @__PURE__ */ jsx("p", { className: "text-muted-foreground leading-relaxed", children: "A lead is not a customer until they book. Automated email and SMS sequences move new prospects from inquiry to appointment with the right message at the right moment. For past customers who went quiet, reactivation campaigns pull them back without new ad spend." })
              ]
            }
          ),
          /* @__PURE__ */ jsxs(
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ jsx("div", { className: "w-12 h-12 rounded-xl bg-primary/15 border border-primary/30 flex items-center justify-center", children: /* @__PURE__ */ jsx(Zap, { className: "w-6 h-6 text-primary" }) }),
                /* @__PURE__ */ jsx("h3", { className: "text-xl font-display font-bold text-foreground", children: "Instant Lead Response, 24/7" }),
                /* @__PURE__ */ jsx("p", { className: "text-muted-foreground leading-relaxed", children: "Most local service leads are lost in the first five minutes because no one picks up the phone. AI-powered call handling and conversational AI respond to every inquiry within seconds — day or night, weekends, holidays — so your Google Ads budget produces booked appointments instead of missed calls." })
              ]
            }
          )
        ] })
      ...
      /* @__PURE__ */ jsx("section", { className: "py-24 bg-card", children: /* @__PURE__ */ jsx("div", { className: "container mx-auto px-4", children: /* @__PURE__ */ jsxs("div", { className: "max-w-3xl mx-auto text-center space-y-6", children: [
        ...
        /* @__PURE__ */ jsx("p", { className: "text-muted-foreground leading-relaxed", children: "Do not let them win the top spot on every search in your market. GrowSmallBiz builds and manages Google Ads campaigns that put local service businesses front and center — exactly when customers are ready to hire." }),
        /* @__PURE__ */ jsx("p", { className: "text-sm text-muted-foreground", children: "No contracts. No fluff. Just leads." }),
